...
namespace Microsoft.OData.UriParser
{
	...
	{
		// Token: 0x06000BE5 RID: 3045 RVA: 0x0001F308 File Offset: 0x0001D508
		...
		// Token: 0x06000BE6 RID: 3046 RVA: 0x0001F37C File Offset: 0x0001D57C
		...
		// Token: 0x06000BE7 RID: 3047 RVA: 0x0001F414 File Offset: 0x0001D614
		internal static bool TryBindAsOperation(PathSegmentToken pathToken, IEdmModel model, IEdmStructuredType entityType, out ODataPathSegment segment)
		{
			...
			{
				list = Enumerable.ToList<IEdmOperation>(list.FindBestOverloadBasedOnParameters(list2, false));
			}
			if (list.Count <= 0)
			{
				segment = null;
		...
		// Token: 0x06000BE8 RID: 3048 RVA: 0x0001F588 File Offset: 0x0001D788
