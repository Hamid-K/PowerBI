		...
		{
			{
				...
				new string[] { "http://schemas.microsoft.com/ado/2006/04/edm" }
			},
			{
				EdmConstants.EdmVersion1_1,
				new string[] { "http://schemas.microsoft.com/ado/2007/05/edm" }
			},
			{
				EdmConstants.EdmVersion1_2,
				new string[] { "http://schemas.microsoft.com/ado/2008/01/edm" }
			},
			{
				EdmConstants.EdmVersion2,
				new string[] { "http://schemas.microsoft.com/ado/2008/09/edm", "http://schemas.microsoft.com/ado/2009/08/edm" }
			},
			{
				EdmConstants.EdmVersion3,
				new string[] { "http://schemas.microsoft.com/ado/2009/11/edm" }
			}
		};
