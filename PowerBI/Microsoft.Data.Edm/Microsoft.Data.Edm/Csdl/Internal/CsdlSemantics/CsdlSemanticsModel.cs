...
namespace Microsoft.Data.Edm.Csdl.Internal.CsdlSemantics
{
	...
	internal class CsdlSemanticsModel : EdmModelBase, IEdmCheckable
	{
		...
		public IEdmAssociation FindAssociation(string qualifiedName)
		{
			...
			this.associationDictionary.TryGetValue(qualifiedName, out edmAssociation);
		...
		public override IEnumerable<IEdmStructuredType> FindDirectlyDerivedTypes(IEdmStructuredType baseType)
		{
			...
			{
				return list.Where((IEdmStructuredType t) => t.BaseType == baseType);
			}
		...
		// Token: 0x0600082D RID: 2093 RVA: 0x00017008 File Offset: 0x00015208
		...
		// Token: 0x0600082E RID: 2094 RVA: 0x00017060 File Offset: 0x00015260
