...
namespace Microsoft.Data.Edm.Validation
{
	...
	{
		// Token: 0x06000D16 RID: 3350 RVA: 0x00029681 File Offset: 0x00027881
		...
		// Token: 0x06000D17 RID: 3351 RVA: 0x000296A4 File Offset: 0x000278A4
		...
		// Token: 0x06000D18 RID: 3352 RVA: 0x0002970C File Offset: 0x0002790C
		...
		// Token: 0x06000D19 RID: 3353 RVA: 0x0002993C File Offset: 0x00027B3C
		...
		// Token: 0x06000D1A RID: 3354 RVA: 0x00029958 File Offset: 0x00027B58
		IEnumerator IEnumerable.GetEnumerator()
		{
			return this.GetEnumerator();
		}

		// Token: 0x06000D1B RID: 3355 RVA: 0x00029960 File Offset: 0x00027B60
		...
		// Token: 0x06000D1C RID: 3356 RVA: 0x00029984 File Offset: 0x00027B84
		...
		private static readonly ValidationRuleSet V1_1RuleSet = new ValidationRuleSet(ValidationRuleSet.BaseRuleSet.Where((ValidationRule r) => r != ValidationRules.ComplexTypeInvalidAbstractComplexType && r != ValidationRules.ComplexTypeInvalidPolymorphicComplexType), new ValidationRule[]
		{
			ValidationRules.NavigationPropertyInvalidToPropertyInRelationshipConstraintBeforeV2,
			ValidationRules.FunctionsNotSupportedBeforeV2,
		...
		private static readonly ValidationRuleSet V1_2RuleSet = new ValidationRuleSet(ValidationRuleSet.BaseRuleSet.Where((ValidationRule r) => r != ValidationRules.ComplexTypeInvalidAbstractComplexType && r != ValidationRules.ComplexTypeInvalidPolymorphicComplexType), new ValidationRule[]
		{
			ValidationRules.NavigationPropertyInvalidToPropertyInRelationshipConstraintBeforeV2,
			ValidationRules.FunctionsNotSupportedBeforeV2,
			ValidationRules.FunctionImportUnsupportedReturnTypeAfterV1,
