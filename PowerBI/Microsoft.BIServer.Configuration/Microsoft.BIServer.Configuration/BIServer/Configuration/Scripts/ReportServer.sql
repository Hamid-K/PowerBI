IF NOT EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'ReportServer') CREATE DATABASE [ReportServer] COLLATE Latin1_General_100_CI_AS_KS_WS
GO

IF NOT EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'ReportServerTempDB') CREATE DATABASE [ReportServerTempDB] COLLATE Latin1_General_100_CI_AS_KS_WS
GO
