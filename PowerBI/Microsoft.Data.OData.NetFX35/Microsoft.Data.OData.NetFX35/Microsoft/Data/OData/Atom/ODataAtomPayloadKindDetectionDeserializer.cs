...
namespace Microsoft.Data.OData.Atom
{
	...
	{
		// Token: 0x060005F1 RID: 1521 RVA: 0x00014D6F File Offset: 0x00012F6F
		internal ODataAtomPayloadKindDetectionDeserializer(ODataAtomInputContext atomInputContext)
			: base(atomInputContext)
		{
		}

		// Token: 0x060005F2 RID: 1522 RVA: 0x00014D84 File Offset: 0x00012F84
				...
				if (base.XmlReader.TryReadToNextElement())
				{
					...
					else
					{
						if (string.CompareOrdinal("http://schemas.microsoft.com/ado/2007/08/dataservices", base.XmlReader.NamespaceURI) == 0)
						{
							...
							IEnumerable<ODataPayloadKind> enumerable = (Enumerable.Any<ODataPayloadKind>(possiblePayloadKinds, (ODataPayloadKind k) => k == ODataPayloadKind.Property || k == ODataPayloadKind.Collection) ? this.DetectPropertyOrCollectionPayloadKind() : Enumerable.Empty<ODataPayloadKind>());
							if (string.CompareOrdinal("uri", base.XmlReader.LocalName) == 0)
							{
								enumerable = Enumerable.Concat<ODataPayloadKind>(enumerable, new ODataPayloadKind[] { ODataPayloadKind.EntityReferenceLink });
							}
							if (base.ReadingResponse && string.CompareOrdinal("links", base.XmlReader.LocalName) == 0)
							{
								enumerable = Enumerable.Concat<ODataPayloadKind>(enumerable, new ODataPayloadKind[] { ODataPayloadKind.EntityReferenceLinks });
							}
							return enumerable;
						}
		...
		// Token: 0x060005F3 RID: 1523 RVA: 0x00014FEC File Offset: 0x000131EC
