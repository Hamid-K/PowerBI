...
namespace Microsoft.Data.OData.Query
{
	...
	{
		// Token: 0x0600005E RID: 94 RVA: 0x00003004 File Offset: 0x00001204
		...
		// Token: 0x0600005F RID: 95 RVA: 0x0000301D File Offset: 0x0000121D
		...
		// Token: 0x06000060 RID: 96 RVA: 0x00003048 File Offset: 0x00001248
		...
		// Token: 0x06000061 RID: 97 RVA: 0x00003085 File Offset: 0x00001285
		...
		// Token: 0x06000062 RID: 98 RVA: 0x000030B0 File Offset: 0x000012B0
		...
		// Token: 0x06000063 RID: 99 RVA: 0x000031E4 File Offset: 0x000013E4
		private static bool TryParseFunctionParameters<TParam>(ICollection<FunctionParameterToken> splitParameters, ODataUriParserConfiguration configuration, IEdmFunctionImport functionImport, Func<string, object, TParam> createParameter, out ICollection<TParam> parsedParameters)
		{
			...
			using (IEnumerator<FunctionParameterToken> enumerator = splitParameters.GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					...
					TParam tparam;
					if (!FunctionParameterParser.TryCreateParameter<TParam>(splitParameter, configuration, type, (object o) => createParameter.Invoke(splitParameter.ParameterName, o), out tparam))
					{
						return false;
					}
		...
		private static bool TryCreateParameter<TParam>(FunctionParameterToken parameterToken, ODataUriParserConfiguration configuration, IEdmTypeReference expectedType, Func<object, TParam> createParameter, out TParam parameter)
		{
			...
			else
			{
				...
				{
					text = configuration.FunctionParameterAliasCallback.Invoke(((FunctionParameterAliasToken)valueToken).Alias);
				}
				else
				{
			...
			parameter = createParameter.Invoke(obj);
			return true;
		}
	}
}
