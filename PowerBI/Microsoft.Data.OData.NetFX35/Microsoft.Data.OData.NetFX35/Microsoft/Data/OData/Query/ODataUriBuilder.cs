...
namespace Microsoft.Data.OData.Query
{
	...
	{
		// Token: 0x06000415 RID: 1045 RVA: 0x0000D4F2 File Offset: 0x0000B6F2
		private ODataUriBuilder(SyntacticTree query)
		{
			this.query = query;
		}

		// Token: 0x06000416 RID: 1046 RVA: 0x0000D50C File Offset: 0x0000B70C
		...
		// Token: 0x06000417 RID: 1047 RVA: 0x0000D570 File Offset: 0x0000B770
		...
		// Token: 0x06000418 RID: 1048 RVA: 0x0000D590 File Offset: 0x0000B790
		public void WriteQueryDescriptor(SyntacticTree queryDescriptor)
		{
			...
			if (queryDescriptor.Select != null && Enumerable.Count<PathSegmentToken>(queryDescriptor.Select.Properties) > 0)
			{
				this.WriteQueryPrefixOrSeparator(flag);
				flag = false;
				this.WriteSelect(queryDescriptor.Select);
			}
			if (queryDescriptor.Expand != null && Enumerable.Count<ExpandTermToken>(queryDescriptor.Expand.ExpandTerms) > 0)
			{
				this.WriteQueryPrefixOrSeparator(flag);
				flag = false;
				this.WriteExpand(queryDescriptor.Expand);
			}
			if (Enumerable.Count<OrderByToken>(queryDescriptor.OrderByTokens) > 0)
			{
				this.WriteQueryPrefixOrSeparator(flag);
				flag = false;
		...
		// Token: 0x06000419 RID: 1049 RVA: 0x0000D82C File Offset: 0x0000BA2C
		internal void Append(string text)
		{
			this.builder.Append(text);
		}

		// Token: 0x0600041A RID: 1050 RVA: 0x0000D83C File Offset: 0x0000BA3C
		...
		// Token: 0x0600041B RID: 1051 RVA: 0x0000D930 File Offset: 0x0000BB30
		...
		// Token: 0x0600041C RID: 1052 RVA: 0x0000DD1F File Offset: 0x0000BF1F
		...
		// Token: 0x0600041D RID: 1053 RVA: 0x0000DD38 File Offset: 0x0000BF38
		...
		// Token: 0x0600041E RID: 1054 RVA: 0x0000DD60 File Offset: 0x0000BF60
		...
		// Token: 0x0600041F RID: 1055 RVA: 0x0000DE08 File Offset: 0x0000C008
		...
		// Token: 0x06000420 RID: 1056 RVA: 0x0000DE70 File Offset: 0x0000C070
		...
		// Token: 0x06000421 RID: 1057 RVA: 0x0000DE90 File Offset: 0x0000C090
		...
		// Token: 0x06000422 RID: 1058 RVA: 0x0000DEFC File Offset: 0x0000C0FC
		...
		// Token: 0x06000423 RID: 1059 RVA: 0x0000DF4C File Offset: 0x0000C14C
		...
		// Token: 0x06000424 RID: 1060 RVA: 0x0000E058 File Offset: 0x0000C258
		...
		// Token: 0x06000425 RID: 1061 RVA: 0x0000E0A8 File Offset: 0x0000C2A8
		...
		// Token: 0x06000426 RID: 1062 RVA: 0x0000E0F8 File Offset: 0x0000C2F8
		...
		// Token: 0x06000427 RID: 1063 RVA: 0x0000E145 File Offset: 0x0000C345
		...
		// Token: 0x06000428 RID: 1064 RVA: 0x0000E170 File Offset: 0x0000C370
		...
		// Token: 0x06000429 RID: 1065 RVA: 0x0000E204 File Offset: 0x0000C404
		...
		// Token: 0x0600042A RID: 1066 RVA: 0x0000E29C File Offset: 0x0000C49C
		...
		// Token: 0x0600042B RID: 1067 RVA: 0x0000E2EC File Offset: 0x0000C4EC
