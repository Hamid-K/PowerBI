...
namespace Microsoft.Data.OData.Query
{
	...
	{
		// Token: 0x06000150 RID: 336 RVA: 0x00006194 File Offset: 0x00004394
		...
		// (get) Token: 0x06000152 RID: 338 RVA: 0x000061B9 File Offset: 0x000043B9
		...
		// (get) Token: 0x06000153 RID: 339 RVA: 0x000061C7 File Offset: 0x000043C7
		...
		// (get) Token: 0x06000154 RID: 340 RVA: 0x000061D1 File Offset: 0x000043D1
		...
		// (get) Token: 0x06000155 RID: 341 RVA: 0x000061D9 File Offset: 0x000043D9
		...
		// (get) Token: 0x06000156 RID: 342 RVA: 0x000061E1 File Offset: 0x000043E1
		...
		// Token: 0x06000157 RID: 343 RVA: 0x0000620C File Offset: 0x0000440C
		...
		// Token: 0x06000158 RID: 344 RVA: 0x00006218 File Offset: 0x00004418
		internal static SegmentArgumentParser FromSegment(string segmentText)
		{
			Dictionary<string, string> dictionary = null;
			List<string> list = new List<string>();
			list.Add(segmentText);
			return new SegmentArgumentParser(dictionary, list, true);
		}

		// Token: 0x06000159 RID: 345 RVA: 0x0000623A File Offset: 0x0000443A
		...
		// Token: 0x0600015A RID: 346 RVA: 0x00006248 File Offset: 0x00004448
			...
			if (this.NamedValues != null)
			{
				...
				using (IEnumerator<IEdmStructuralProperty> enumerator = keyProperties.GetEnumerator())
				{
					while (enumerator.MoveNext())
					{
						...
						string text;
						if (!this.NamedValues.TryGetValue(edmStructuralProperty.Name, ref text))
						{
							return false;
						}
						object obj;
		...
		// Token: 0x0600015B RID: 347 RVA: 0x00006374 File Offset: 0x00004574
		...
		// Token: 0x0600015C RID: 348 RVA: 0x000063B0 File Offset: 0x000045B0
		...
		// Token: 0x0600015D RID: 349 RVA: 0x000064EC File Offset: 0x000046EC
