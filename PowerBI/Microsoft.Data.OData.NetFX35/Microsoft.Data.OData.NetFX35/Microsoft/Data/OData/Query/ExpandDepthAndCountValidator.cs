...
namespace Microsoft.Data.OData.Query
{
	...
	{
		// Token: 0x0600005B RID: 91 RVA: 0x00002F1F File Offset: 0x0000111F
		...
		// Token: 0x0600005C RID: 92 RVA: 0x00002F35 File Offset: 0x00001135
		...
		private void EnsureMaximumCountAndDepthAreNotExceeded(SelectExpandClause expandTree, int currentDepth)
		{
			...
			foreach (ExpandedNavigationSelectItem expandedNavigationSelectItem in Enumerable.OfType<ExpandedNavigationSelectItem>(expandTree.SelectedItems))
			{
				this.currentCount++;
