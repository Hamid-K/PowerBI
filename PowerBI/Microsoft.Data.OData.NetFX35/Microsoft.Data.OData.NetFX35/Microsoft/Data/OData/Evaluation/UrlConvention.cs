...
namespace Microsoft.Data.OData.Evaluation
{
	...
	internal sealed class UrlConvention
	{
		...
		{
			return UrlConvention.CreateWithExplicitValue(Enumerable.Any<IEdmValueAnnotation>(Enumerable.OfType<IEdmValueAnnotation>(model.FindVocabularyAnnotations(container)), new Func<IEdmValueAnnotation, bool>(UrlConvention.IsKeyAsSegmentUrlConventionAnnotation)));
		}
