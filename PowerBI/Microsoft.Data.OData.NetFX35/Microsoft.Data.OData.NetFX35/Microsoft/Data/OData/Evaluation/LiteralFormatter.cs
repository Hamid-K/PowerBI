...
namespace Microsoft.Data.OData.Evaluation
{
	...
	internal abstract class LiteralFormatter
	{
		...
		private static string ConvertByteArrayToKeyString(byte[] byteArray)
		{
			...
			{
				stringBuilder.Append("0123456789ABCDEF".get_Chars(b >> 4));
				stringBuilder.Append("0123456789ABCDEF".get_Chars((int)(b & 15)));
			}
		...
		private static string FormatRawLiteral(object value)
		{
			...
			{
				return XmlConvert.ToString((DateTime)value, 3);
			}
			if (value is decimal)
			{
