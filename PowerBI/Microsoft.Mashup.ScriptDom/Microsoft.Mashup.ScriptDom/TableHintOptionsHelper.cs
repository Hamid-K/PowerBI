...
namespace Microsoft.Mashup.ScriptDom
{
	...
	{
		// Token: 0x06001483 RID: 5251 RVA: 0x00090078 File Offset: 0x0008E278
		...
		// Token: 0x06001484 RID: 5252 RVA: 0x000901D8 File Offset: 0x0008E3D8
		protected override TSqlParseErrorException GetMatchingException(IToken token)
		{
			return new TSqlParseErrorException(TSql80ParserBaseInternal.CreateParseError("SQL46022", token, TSqlParserResource.SQL46022Message, new string[] { token.getText() }));
		}
