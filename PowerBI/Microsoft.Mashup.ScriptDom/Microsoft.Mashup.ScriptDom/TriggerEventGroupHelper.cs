...
namespace Microsoft.Mashup.ScriptDom
{
	...
	{
		// Token: 0x060002E0 RID: 736 RVA: 0x0000CAB0 File Offset: 0x0000ACB0
		private TriggerEventGroupHelper()
		{
			...
			base.AddOptionMapping(EventNotificationEventGroup.DdlSearchPropertyListEvents, "DDL_SEARCH_PROPERTY_LIST_EVENTS", SqlVersionFlags.TSql110);
			base.AddOptionMapping(EventNotificationEventGroup.DdlSequenceEvents, "DDL_SEQUENCE_EVENTS", SqlVersionFlags.TSql110);
			base.AddOptionMapping(EventNotificationEventGroup.DdlAvailabilityGroupEvents, "DDL_AVAILABILITY_GROUP_EVENTS", SqlVersionFlags.TSql110);
		}
