...
namespace Microsoft.Mashup.ScriptDom
{
	...
	{
		// Token: 0x060002E2 RID: 738 RVA: 0x0000CFB8 File Offset: 0x0000B1B8
		private TriggerEventTypeHelper()
		{
			...
			base.AddOptionMapping(EventNotificationEventType.CreateSearchPropertyList, "CREATE_SEARCH_PROPERTY_LIST", SqlVersionFlags.TSql110);
			base.AddOptionMapping(EventNotificationEventType.AlterSearchPropertyList, "ALTER_SEARCH_PROPERTY_LIST", SqlVersionFlags.TSql110);
			base.AddOptionMapping(EventNotificationEventType.DropSearchPropertyList, "DROP_SEARCH_PROPERTY_LIST", SqlVersionFlags.TSql110);
			base.AddOptionMapping(EventNotificationEventType.CreateServerRole, "CREATE_SERVER_ROLE", SqlVersionFlags.TSql110);
			base.AddOptionMapping(EventNotificationEventType.AlterServerRole, "ALTER_SERVER_ROLE", SqlVersionFlags.TSql110);
			base.AddOptionMapping(EventNotificationEventType.DropServerRole, "DROP_SERVER_ROLE", SqlVersionFlags.TSql110);
			base.AddOptionMapping(EventNotificationEventType.CreateSequence, "CREATE_SEQUENCE", SqlVersionFlags.TSql110);
			base.AddOptionMapping(EventNotificationEventType.AlterSequence, "ALTER_SEQUENCE", SqlVersionFlags.TSql110);
			base.AddOptionMapping(EventNotificationEventType.DropSequence, "DROP_SEQUENCE", SqlVersionFlags.TSql110);
			base.AddOptionMapping(EventNotificationEventType.CreateAvailabilityGroup, "CREATE_AVAILABILITY_GROUP", SqlVersionFlags.TSql110);
			base.AddOptionMapping(EventNotificationEventType.AlterAvailabilityGroup, "ALTER_AVAILABILITY_GROUP", SqlVersionFlags.TSql110);
			base.AddOptionMapping(EventNotificationEventType.DropAvailabilityGroup, "DROP_AVAILABILITY_GROUP", SqlVersionFlags.TSql110);
		}
