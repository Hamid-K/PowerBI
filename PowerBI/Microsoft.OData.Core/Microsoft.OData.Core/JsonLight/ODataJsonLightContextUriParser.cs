...
namespace Microsoft.OData.JsonLight
{
	...
	{
		// Token: 0x060018C9 RID: 6345 RVA: 0x00046E8E File Offset: 0x0004508E
		...
		// Token: 0x060018CA RID: 6346 RVA: 0x00046EBC File Offset: 0x000450BC
		internal static ODataJsonLightContextUriParseResult Parse(IEdmModel model, string contextUriFromPayload, ODataPayloadKind payloadKind, Func<IEdmType, string, IEdmType> clientCustomTypeResolver, bool needParseFragment, bool throwIfMetadataConflict = true)
		{
			...
			Uri uri;
			if (!Uri.TryCreate(contextUriFromPayload, UriKind.Absolute, out uri))
			{
		...
		// Token: 0x060018CB RID: 6347 RVA: 0x0001D267 File Offset: 0x0001B467
		private static string ExtractSelectQueryOption(string fragment)
		{
			return fragment;
		}

		// Token: 0x060018CC RID: 6348 RVA: 0x00046F10 File Offset: 0x00045110
		...
		// Token: 0x060018CD RID: 6349 RVA: 0x00046F5C File Offset: 0x0004515C
		...
		// Token: 0x060018CE RID: 6350 RVA: 0x000471B8 File Offset: 0x000453B8
		...
		// Token: 0x060018CF RID: 6351 RVA: 0x00047684 File Offset: 0x00045884
