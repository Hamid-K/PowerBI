...
namespace AngleSharp.Network
{
	...
	{
		// Token: 0x06000487 RID: 1159 RVA: 0x0001C780 File Offset: 0x0001A980
		public static string FromExtension(string extension)
		{
			string empty = string.Empty;
			if (MimeTypeNames.Extensions.TryGetValue(extension, out empty))
			{
				return empty;
			}
		...
		// Token: 0x06000488 RID: 1160 RVA: 0x0001C7AC File Offset: 0x0001A9AC
		public static bool IsJavaScript(string type)
		{
			foreach (string text in MimeTypeNames.commonJsTypes)
			{
				if (type.Isi(text))
				{
					return true;
		...
		// Token: 0x06000489 RID: 1161 RVA: 0x0001C7E0 File Offset: 0x0001A9E0
		public static bool Represents(this MimeType type, string content)
		{
			MimeType mimeType = new MimeType(content);
		...
		private static readonly string[] commonJsTypes = new string[]
		{
			"application/ecmascript", "application/javascript", "application/x-ecmascript", "application/x-javascript", "text/ecmascript", "text/javascript", "text/javascript1.0", "text/javascript1.1", "text/javascript1.2", "text/javascript1.3",
