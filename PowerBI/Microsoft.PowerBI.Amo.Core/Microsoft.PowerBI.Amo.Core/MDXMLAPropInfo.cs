...
namespace Microsoft.AnalysisServices
{
	...
	{
		// Token: 0x06000355 RID: 853 RVA: 0x0001029C File Offset: 0x0000E49C
		internal MDXMLAPropInfo()
		{
			this.hashedProperties = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase);
			foreach (MDXMLAProp mdxmlaprop in MDXMLAPropInfo.props)
			{
		...
		// (get) Token: 0x06000356 RID: 854 RVA: 0x000102F2 File Offset: 0x0000E4F2
		...
		internal static MDXMLAProp[] props = new MDXMLAProp[]
		{
			...
			new MDXMLAProp("DbpropMsmdExecutionMetrics", "DbpropMsmdExecutionMetrics"),
			...
			new MDXMLAProp("DefaultCompatibilityLevel", "DefaultCompatibilityLevel"),
			new MDXMLAProp("SupportedCompatibilityLevels", "SupportedCompatibilityLevels"),
			new MDXMLAProp("SessionOwningCoreServiceName", "SessionOwningCoreServiceName"),
			...
			new MDXMLAProp("Command Timeout", "Timeout"),
			...
			new MDXMLAProp("RequestPriority", "RequestPriority"),
			new MDXMLAProp("ContextualIdentity", ""),
			new MDXMLAProp("ConnectionActivityId", ""),
			new MDXMLAProp("ExecutionMetrics", "DbpropMsmdExecutionMetrics"),
			new MDXMLAProp("ApplicationContext", "ApplicationContext"),
			new MDXMLAProp("DynamicFeatureSwitch", "DynamicFeatureSwitch"),
			new MDXMLAProp("RequestLabel", "RequestLabel"),
			new MDXMLAProp("NestingLevel", "NestingLevel"),
			...
			new MDXMLAProp("Gateway", ""),
			new MDXMLAProp("Catalog Rebound", "")
		};
	}
}
