...
namespace Microsoft.Data.Edm.Csdl.Internal.CsdlSemantics
{
	...
	{
		// Token: 0x060007E7 RID: 2023 RVA: 0x00015A35 File Offset: 0x00013C35
		...
		// (get) Token: 0x060007E8 RID: 2024 RVA: 0x00015A5C File Offset: 0x00013C5C
		...
		// (get) Token: 0x060007E9 RID: 2025 RVA: 0x00015A74 File Offset: 0x00013C74
		...
		// (get) Token: 0x060007EA RID: 2026 RVA: 0x00015A77 File Offset: 0x00013C77
		public string Name
		{
			get
			{
		...
		// (get) Token: 0x060007EB RID: 2027 RVA: 0x00015A84 File Offset: 0x00013C84
		...
		// (get) Token: 0x060007EC RID: 2028 RVA: 0x00015A91 File Offset: 0x00013C91
		...
		// (get) Token: 0x060007ED RID: 2029 RVA: 0x00015A9E File Offset: 0x00013C9E
		...
		// (get) Token: 0x060007EE RID: 2030 RVA: 0x00015AB2 File Offset: 0x00013CB2
		...
		// (get) Token: 0x060007EF RID: 2031 RVA: 0x00015AB5 File Offset: 0x00013CB5
		...
		// Token: 0x060007F0 RID: 2032 RVA: 0x00015AC0 File Offset: 0x00013CC0
		...
		// Token: 0x060007F1 RID: 2033 RVA: 0x00015B20 File Offset: 0x00013D20
		...
		// Token: 0x060007F2 RID: 2034 RVA: 0x00015BA8 File Offset: 0x00013DA8
			...
			if (this.entity.Key != null)
			{
				...
				using (IEnumerator<CsdlPropertyReference> enumerator = this.entity.Key.Properties.GetEnumerator())
				{
					while (enumerator.MoveNext())
					{
						...
						{
							edmStructuralProperty = Enumerable.SingleOrDefault<IEdmProperty>(base.DeclaredProperties, (IEdmProperty p) => p.Name == keyProperty.PropertyName) as IEdmStructuralProperty;
							if (edmStructuralProperty != null)
							{
								list.Add(edmStructuralProperty);
							}
