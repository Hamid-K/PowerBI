...
namespace Microsoft.Data.Edm.Csdl.Internal.CsdlSemantics
{
	...
	{
		// Token: 0x06000331 RID: 817 RVA: 0x000087B7 File Offset: 0x000069B7
		...
		// (get) Token: 0x06000332 RID: 818 RVA: 0x000087E4 File Offset: 0x000069E4
		public string Name
		{
			get
			{
		...
		// (get) Token: 0x06000333 RID: 819 RVA: 0x000087F1 File Offset: 0x000069F1
		...
		// (get) Token: 0x06000334 RID: 820 RVA: 0x00008805 File Offset: 0x00006A05
		...
		// (get) Token: 0x06000335 RID: 821 RVA: 0x00008819 File Offset: 0x00006A19
		...
		// (get) Token: 0x06000336 RID: 822 RVA: 0x00008821 File Offset: 0x00006A21
		...
		// (get) Token: 0x06000337 RID: 823 RVA: 0x0000882E File Offset: 0x00006A2E
		...
		// (get) Token: 0x06000338 RID: 824 RVA: 0x00008836 File Offset: 0x00006A36
		...
		// Token: 0x06000339 RID: 825 RVA: 0x00008854 File Offset: 0x00006A54
		public IEdmFunctionParameter FindParameter(string name)
		{
			return Enumerable.SingleOrDefault<IEdmFunctionParameter>(this.Parameters, (IEdmFunctionParameter p) => p.Name == name);
		}

		// Token: 0x0600033A RID: 826 RVA: 0x00008885 File Offset: 0x00006A85
		protected override IEnumerable<IEdmVocabularyAnnotation> ComputeInlineVocabularyAnnotations()
		{
			return this.Model.WrapInlineVocabularyAnnotations(this, this.Context);
		}

		// Token: 0x0600033B RID: 827 RVA: 0x00008899 File Offset: 0x00006A99
		...
		// Token: 0x0600033C RID: 828 RVA: 0x000088B4 File Offset: 0x00006AB4
		private IEnumerable<IEdmFunctionParameter> ComputeParameters()
		{
			...
			foreach (CsdlFunctionParameter csdlFunctionParameter in this.functionBase.Parameters)
			{
				list.Add(new CsdlSemanticsFunctionParameter(this, csdlFunctionParameter));
			}
			return list;
		}
