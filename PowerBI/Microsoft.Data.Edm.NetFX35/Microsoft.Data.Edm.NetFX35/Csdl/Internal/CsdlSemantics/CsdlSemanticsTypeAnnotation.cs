...
namespace Microsoft.Data.Edm.Csdl.Internal.CsdlSemantics
{
	...
	{
		// Token: 0x0600029C RID: 668 RVA: 0x00006B75 File Offset: 0x00004D75
		...
		// (get) Token: 0x0600029D RID: 669 RVA: 0x00006B8F File Offset: 0x00004D8F
		...
		// Token: 0x0600029E RID: 670 RVA: 0x00006BA4 File Offset: 0x00004DA4
		...
		// Token: 0x0600029F RID: 671 RVA: 0x00006BF0 File Offset: 0x00004DF0
		private IEnumerable<IEdmPropertyValueBinding> ComputeProperties()
		{
			...
			foreach (CsdlPropertyValue csdlPropertyValue in ((CsdlTypeAnnotation)this.Annotation).Properties)
			{
				list.Add(new CsdlSemanticsPropertyValueBinding(this, csdlPropertyValue));
			}
			return list;
		}
