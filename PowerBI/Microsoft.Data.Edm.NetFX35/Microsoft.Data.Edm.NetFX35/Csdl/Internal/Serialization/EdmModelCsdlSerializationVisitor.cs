...
namespace Microsoft.Data.Edm.Csdl.Internal.Serialization
{
	...
	{
		// Token: 0x060009DE RID: 2526 RVA: 0x0001B8C0 File Offset: 0x00019AC0
		...
		// Token: 0x060009DF RID: 2527 RVA: 0x0001B940 File Offset: 0x00019B40
		internal void VisitEdmSchema(EdmSchema element, IEnumerable<KeyValuePair<string, string>> mappings)
		{
			...
			using (List<IEdmNavigationProperty>.Enumerator enumerator2 = element.AssociationNavigationProperties.GetEnumerator())
			{
				while (enumerator2.MoveNext())
				{
					...
					if (!this.associations.TryGetValue(associationFullName, ref list))
					{
						list = new List<IEdmNavigationProperty>();
						this.associations.Add(associationFullName, list);
					}
					if (!Enumerable.Any<IEdmNavigationProperty>(list, (IEdmNavigationProperty np) => this.SharesAssociation(np, navigationProperty)))
					{
		...
		// Token: 0x060009E0 RID: 2528 RVA: 0x0001BB98 File Offset: 0x00019D98
				...
				while (enumerator.MoveNext())
				{
					...
					using (IEnumerator<IEdmNavigationTargetMapping> enumerator2 = entitySet.NavigationTargets.GetEnumerator())
					{
						while (enumerator2.MoveNext())
						{
							...
							if (!this.associationSets.TryGetValue(associationFullName, ref list))
							{
								list = new List<TupleInternal<IEdmEntitySet, IEdmNavigationProperty>>();
								this.associationSets[associationFullName] = list;
							}
							if (!Enumerable.Any<TupleInternal<IEdmEntitySet, IEdmNavigationProperty>>(list, (TupleInternal<IEdmEntitySet, IEdmNavigationProperty> set) => this.SharesAssociationSet(set.Item1, set.Item2, entitySet, mapping.NavigationProperty)))
							{
		...
		// Token: 0x060009E1 RID: 2529 RVA: 0x0001BD58 File Offset: 0x00019F58
		...
		// Token: 0x060009E2 RID: 2530 RVA: 0x0001BD88 File Offset: 0x00019F88
		protected override void ProcessEntityType(IEdmEntityType element)
		{
			...
			if (element.DeclaredKey != null && Enumerable.Count<IEdmStructuralProperty>(element.DeclaredKey) > 0 && element.BaseType == null)
			{
		...
		// Token: 0x060009E3 RID: 2531 RVA: 0x0001BE40 File Offset: 0x0001A040
		...
		// Token: 0x060009E4 RID: 2532 RVA: 0x0001BEB0 File Offset: 0x0001A0B0
		...
		// Token: 0x060009E5 RID: 2533 RVA: 0x0001BEBE File Offset: 0x0001A0BE
		...
		// Token: 0x060009E6 RID: 2534 RVA: 0x0001BECC File Offset: 0x0001A0CC
		...
		// Token: 0x060009E7 RID: 2535 RVA: 0x0001BEDA File Offset: 0x0001A0DA
		...
		// Token: 0x060009E8 RID: 2536 RVA: 0x0001BEE8 File Offset: 0x0001A0E8
		...
		// Token: 0x060009E9 RID: 2537 RVA: 0x0001BEF6 File Offset: 0x0001A0F6
		...
		// Token: 0x060009EA RID: 2538 RVA: 0x0001BF29 File Offset: 0x0001A129
		...
		// Token: 0x060009EB RID: 2539 RVA: 0x0001BF57 File Offset: 0x0001A157
		...
		// Token: 0x060009EC RID: 2540 RVA: 0x0001BF85 File Offset: 0x0001A185
		...
		// Token: 0x060009ED RID: 2541 RVA: 0x0001BFE8 File Offset: 0x0001A1E8
		...
		// Token: 0x060009EE RID: 2542 RVA: 0x0001C0B4 File Offset: 0x0001A2B4
		...
		// Token: 0x060009EF RID: 2543 RVA: 0x0001C1C4 File Offset: 0x0001A3C4
		...
		// Token: 0x060009F0 RID: 2544 RVA: 0x0001C270 File Offset: 0x0001A470
		...
		// Token: 0x060009F1 RID: 2545 RVA: 0x0001C2E0 File Offset: 0x0001A4E0
		...
		// Token: 0x060009F2 RID: 2546 RVA: 0x0001C300 File Offset: 0x0001A500
		...
		// Token: 0x060009F3 RID: 2547 RVA: 0x0001C39C File Offset: 0x0001A59C
		...
		// Token: 0x060009F4 RID: 2548 RVA: 0x0001C3F6 File Offset: 0x0001A5F6
		...
		// Token: 0x060009F5 RID: 2549 RVA: 0x0001C448 File Offset: 0x0001A648
		...
		// Token: 0x060009F6 RID: 2550 RVA: 0x0001C4A2 File Offset: 0x0001A6A2
		...
		// Token: 0x060009F7 RID: 2551 RVA: 0x0001C4B0 File Offset: 0x0001A6B0
		...
		// Token: 0x060009F8 RID: 2552 RVA: 0x0001C4BE File Offset: 0x0001A6BE
		...
		// Token: 0x060009F9 RID: 2553 RVA: 0x0001C4F1 File Offset: 0x0001A6F1
		...
		// Token: 0x060009FA RID: 2554 RVA: 0x0001C550 File Offset: 0x0001A750
		...
		// Token: 0x060009FB RID: 2555 RVA: 0x0001C5AA File Offset: 0x0001A7AA
		...
		// Token: 0x060009FC RID: 2556 RVA: 0x0001C5E5 File Offset: 0x0001A7E5
		...
		// Token: 0x060009FD RID: 2557 RVA: 0x0001C5F3 File Offset: 0x0001A7F3
		...
		// Token: 0x060009FE RID: 2558 RVA: 0x0001C601 File Offset: 0x0001A801
		...
		// Token: 0x060009FF RID: 2559 RVA: 0x0001C670 File Offset: 0x0001A870
		...
		// Token: 0x06000A00 RID: 2560 RVA: 0x0001C6EC File Offset: 0x0001A8EC
		...
		// Token: 0x06000A01 RID: 2561 RVA: 0x0001C6FA File Offset: 0x0001A8FA
		...
		// Token: 0x06000A02 RID: 2562 RVA: 0x0001C728 File Offset: 0x0001A928
		...
		// Token: 0x06000A03 RID: 2563 RVA: 0x0001C758 File Offset: 0x0001A958
		...
		// Token: 0x06000A04 RID: 2564 RVA: 0x0001C7C7 File Offset: 0x0001A9C7
		...
		// Token: 0x06000A05 RID: 2565 RVA: 0x0001C7D5 File Offset: 0x0001A9D5
		...
		// Token: 0x06000A06 RID: 2566 RVA: 0x0001C7E3 File Offset: 0x0001A9E3
		...
		// Token: 0x06000A07 RID: 2567 RVA: 0x0001C7F1 File Offset: 0x0001A9F1
		...
		// Token: 0x06000A08 RID: 2568 RVA: 0x0001C7FF File Offset: 0x0001A9FF
		...
		// Token: 0x06000A09 RID: 2569 RVA: 0x0001C80D File Offset: 0x0001AA0D
		...
		// Token: 0x06000A0A RID: 2570 RVA: 0x0001C81B File Offset: 0x0001AA1B
		...
		// Token: 0x06000A0B RID: 2571 RVA: 0x0001C829 File Offset: 0x0001AA29
		...
		// Token: 0x06000A0C RID: 2572 RVA: 0x0001C837 File Offset: 0x0001AA37
		...
		// Token: 0x06000A0D RID: 2573 RVA: 0x0001C880 File Offset: 0x0001AA80
		...
		// Token: 0x06000A0E RID: 2574 RVA: 0x0001C8FC File Offset: 0x0001AAFC
		...
		// Token: 0x06000A0F RID: 2575 RVA: 0x0001C93C File Offset: 0x0001AB3C
		...
		// Token: 0x06000A10 RID: 2576 RVA: 0x0001C998 File Offset: 0x0001AB98
		...
		// Token: 0x06000A11 RID: 2577 RVA: 0x0001CA18 File Offset: 0x0001AC18
		...
		// Token: 0x06000A12 RID: 2578 RVA: 0x0001CA98 File Offset: 0x0001AC98
		...
		// Token: 0x06000A13 RID: 2579 RVA: 0x0001CAE8 File Offset: 0x0001ACE8
		...
		// Token: 0x06000A14 RID: 2580 RVA: 0x0001CB98 File Offset: 0x0001AD98
		...
		// Token: 0x06000A15 RID: 2581 RVA: 0x0001CC00 File Offset: 0x0001AE00
		...
		// Token: 0x06000A16 RID: 2582 RVA: 0x0001CC28 File Offset: 0x0001AE28
		...
		// Token: 0x06000A17 RID: 2583 RVA: 0x0001CC8F File Offset: 0x0001AE8F
		...
		// Token: 0x06000A18 RID: 2584 RVA: 0x0001CCB0 File Offset: 0x0001AEB0
		...
		// Token: 0x06000A19 RID: 2585 RVA: 0x0001CD00 File Offset: 0x0001AF00
		...
		// Token: 0x06000A1A RID: 2586 RVA: 0x0001CD88 File Offset: 0x0001AF88
		...
		// Token: 0x06000A1B RID: 2587 RVA: 0x0001CE10 File Offset: 0x0001B010
		...
		// Token: 0x06000A1C RID: 2588 RVA: 0x0001CE1E File Offset: 0x0001B01E
		...
		// Token: 0x06000A1D RID: 2589 RVA: 0x0001CE2C File Offset: 0x0001B02C
		...
		// Token: 0x06000A1E RID: 2590 RVA: 0x0001CED0 File Offset: 0x0001B0D0
		...
		// Token: 0x06000A1F RID: 2591 RVA: 0x0001CF44 File Offset: 0x0001B144
		...
		// Token: 0x06000A20 RID: 2592 RVA: 0x0001CFA2 File Offset: 0x0001B1A2
		private void ProcessEdmDocumentation(IEdmDocumentation element)
		{
			this.schemaWriter.WriteDocumentationElement(element);
		}

		// Token: 0x06000A21 RID: 2593 RVA: 0x0001CFB0 File Offset: 0x0001B1B0
		...
		// Token: 0x06000A22 RID: 2594 RVA: 0x0001D0B4 File Offset: 0x0001B2B4
		...
		// Token: 0x06000A23 RID: 2595 RVA: 0x0001D128 File Offset: 0x0001B328
		...
		{
			if (Enumerable.Count<IEdmStructuralProperty>(theseProperties) != Enumerable.Count<IEdmStructuralProperty>(thoseProperties))
			{
				return false;
			}
		...
		// Token: 0x06000A24 RID: 2596 RVA: 0x0001D1A8 File Offset: 0x0001B3A8
