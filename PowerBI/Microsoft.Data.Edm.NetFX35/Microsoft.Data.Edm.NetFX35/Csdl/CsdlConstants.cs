...
namespace Microsoft.Data.Edm.Csdl
{
	...
	{
		// Token: 0x060005C8 RID: 1480 RVA: 0x0000F140 File Offset: 0x0000D340
		// Note: this type is marked as 'beforefieldinit'.
		static CsdlConstants()
		{
			Dictionary<Version, string[]> dictionary = new Dictionary<Version, string[]>();
			dictionary.Add(EdmConstants.EdmVersion1, new string[] { "http://schemas.microsoft.com/ado/2006/04/edm" });
			dictionary.Add(EdmConstants.EdmVersion1_1, new string[] { "http://schemas.microsoft.com/ado/2007/05/edm" });
			dictionary.Add(EdmConstants.EdmVersion1_2, new string[] { "http://schemas.microsoft.com/ado/2008/01/edm" });
			dictionary.Add(EdmConstants.EdmVersion2, new string[] { "http://schemas.microsoft.com/ado/2008/09/edm", "http://schemas.microsoft.com/ado/2009/08/edm" });
			dictionary.Add(EdmConstants.EdmVersion3, new string[] { "http://schemas.microsoft.com/ado/2009/11/edm" });
			CsdlConstants.SupportedVersions = dictionary;
			Dictionary<Version, string> dictionary2 = new Dictionary<Version, string>();
			dictionary2.Add(CsdlConstants.EdmxVersion1, "http://schemas.microsoft.com/ado/2007/06/edmx");
			dictionary2.Add(CsdlConstants.EdmxVersion2, "http://schemas.microsoft.com/ado/2008/10/edmx");
			dictionary2.Add(CsdlConstants.EdmxVersion3, "http://schemas.microsoft.com/ado/2009/11/edmx");
			...
			dictionary3.Add(EdmConstants.EdmVersion1, CsdlConstants.EdmxVersion1);
			dictionary3.Add(EdmConstants.EdmVersion1_1, CsdlConstants.EdmxVersion1);
			dictionary3.Add(EdmConstants.EdmVersion1_2, CsdlConstants.EdmxVersion1);
			dictionary3.Add(EdmConstants.EdmVersion2, CsdlConstants.EdmxVersion2);
			dictionary3.Add(EdmConstants.EdmVersion3, CsdlConstants.EdmxVersion3);
