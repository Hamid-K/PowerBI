...
namespace Microsoft.Data.Edm.Library
{
	...
	{
		// Token: 0x06000815 RID: 2069 RVA: 0x00015E50 File Offset: 0x00014050
		...
		// (get) Token: 0x06000817 RID: 2071 RVA: 0x00015ECA File Offset: 0x000140CA
		...
		// (get) Token: 0x06000818 RID: 2072 RVA: 0x00015ED1 File Offset: 0x000140D1
		...
		// (get) Token: 0x06000819 RID: 2073 RVA: 0x00015ED9 File Offset: 0x000140D9
		...
		// Token: 0x0600081A RID: 2074 RVA: 0x00015EE4 File Offset: 0x000140E4
		public IEdmEntityContainer FindDeclaredEntityContainer(string name)
		{
			IEdmEntityContainer edmEntityContainer;
			if (!this.containersDictionary.TryGetValue(name, ref edmEntityContainer))
			{
				return null;
			}
		...
		// Token: 0x0600081B RID: 2075 RVA: 0x00015F04 File Offset: 0x00014104
		...
		// Token: 0x0600081C RID: 2076 RVA: 0x00015F24 File Offset: 0x00014124
		...
		// Token: 0x0600081D RID: 2077 RVA: 0x00015F44 File Offset: 0x00014144
		public IEnumerable<IEdmFunction> FindDeclaredFunctions(string qualifiedName)
		{
			object obj;
			if (!this.functionDictionary.TryGetValue(qualifiedName, ref obj))
			{
			...
			return new IEdmFunction[] { (IEdmFunction)obj };
		}

		// Token: 0x0600081E RID: 2078 RVA: 0x00015F84 File Offset: 0x00014184
		...
		// Token: 0x06000820 RID: 2080 RVA: 0x00015F8B File Offset: 0x0001418B
		...
		// Token: 0x06000821 RID: 2081 RVA: 0x00015FB7 File Offset: 0x000141B7
