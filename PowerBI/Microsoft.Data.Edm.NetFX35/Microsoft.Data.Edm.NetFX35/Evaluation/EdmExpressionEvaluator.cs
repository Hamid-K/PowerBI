...
namespace Microsoft.Data.Edm.Evaluation
{
	...
	{
		// Token: 0x060003F8 RID: 1016 RVA: 0x0000A7CF File Offset: 0x000089CF
		public EdmExpressionEvaluator(IDictionary<IEdmFunction, Func<IEdmValue[], IEdmValue>> builtInFunctions)
		{
			this.builtInFunctions = builtInFunctions;
		}

		// Token: 0x060003F9 RID: 1017 RVA: 0x0000A7E9 File Offset: 0x000089E9
		...
		// Token: 0x060003FA RID: 1018 RVA: 0x0000A7F9 File Offset: 0x000089F9
		...
		// Token: 0x060003FB RID: 1019 RVA: 0x0000A80F File Offset: 0x00008A0F
		...
		// Token: 0x060003FC RID: 1020 RVA: 0x0000A825 File Offset: 0x00008A25
		...
		// Token: 0x060003FD RID: 1021 RVA: 0x0000A84D File Offset: 0x00008A4D
		private static bool InRange(long value, long min, long max)
		{
			return value >= min && value <= max;
		}

		// Token: 0x060003FE RID: 1022 RVA: 0x0000A85C File Offset: 0x00008A5C
		private static bool FitsInSingle(double value)
		{
			return value >= -3.4028234663852886E+38 && value <= 3.4028234663852886E+38;
		}

		// Token: 0x060003FF RID: 1023 RVA: 0x0000A87B File Offset: 0x00008A7B
		...
		// Token: 0x06000400 RID: 1024 RVA: 0x0000A888 File Offset: 0x00008A88
		...
		// Token: 0x06000401 RID: 1025 RVA: 0x0000AB6C File Offset: 0x00008D6C
		...
		// Token: 0x06000402 RID: 1026 RVA: 0x0000AC30 File Offset: 0x00008E30
		...
		// Token: 0x06000403 RID: 1027 RVA: 0x0000AE00 File Offset: 0x00009000
		private IEdmValue Eval(IEdmExpression expression, IEdmStructuredValue context)
		{
			...
			case EdmExpressionKind.AssertType:
			{
				...
				IEdmValue edmValue2 = this.Eval(edmAssertTypeExpression.Operand, context);
				IEdmTypeReference type = edmAssertTypeExpression.Type;
				return EdmExpressionEvaluator.AssertType(type, edmValue2);
			}
			...
			case EdmExpressionKind.FunctionApplication:
			{
				...
				if (edmFunctionReferenceExpression != null)
				{
					...
					if (this.builtInFunctions.TryGetValue(referencedFunction, ref func))
					{
						return func.Invoke(array);
					}
					if (this.lastChanceFunctionApplier != null)
					{
						return this.lastChanceFunctionApplier.Invoke(referencedFunction.FullName(), array);
					}
				}
		...
		// Token: 0x06000404 RID: 1028 RVA: 0x0000B248 File Offset: 0x00009448
		...
		// Token: 0x06000405 RID: 1029 RVA: 0x0000B2A0 File Offset: 0x000094A0
		...
		{
			// Token: 0x06000406 RID: 1030 RVA: 0x0000B2CC File Offset: 0x000094CC
			...
			// Token: 0x06000407 RID: 1031 RVA: 0x0000B2E2 File Offset: 0x000094E2
		...
		{
			// Token: 0x06000409 RID: 1033 RVA: 0x0000B2F6 File Offset: 0x000094F6
			...
			// (get) Token: 0x0600040B RID: 1035 RVA: 0x0000B305 File Offset: 0x00009505
		...
		{
			// Token: 0x0600040D RID: 1037 RVA: 0x0000B32C File Offset: 0x0000952C
			...
			// (get) Token: 0x0600040E RID: 1038 RVA: 0x0000B33C File Offset: 0x0000953C
			public string Name
			{
				get
				{
			...
			// (get) Token: 0x0600040F RID: 1039 RVA: 0x0000B349 File Offset: 0x00009549
		...
		{
			// Token: 0x06000410 RID: 1040 RVA: 0x0000B356 File Offset: 0x00009556
			...
			// (get) Token: 0x06000411 RID: 1041 RVA: 0x0000B366 File Offset: 0x00009566
			public override IEdmExpression Expression
			{
				get
				{
		...
		{
			// Token: 0x06000413 RID: 1043 RVA: 0x0000B36E File Offset: 0x0000956E
			...
			// (get) Token: 0x06000414 RID: 1044 RVA: 0x0000B384 File Offset: 0x00009584
			...
			// (get) Token: 0x06000415 RID: 1045 RVA: 0x0000B387 File Offset: 0x00009587
			...
			// (get) Token: 0x06000416 RID: 1046 RVA: 0x0000B38F File Offset: 0x0000958F
			...
			// Token: 0x06000417 RID: 1047 RVA: 0x0000B392 File Offset: 0x00009592
			...
			// Token: 0x06000418 RID: 1048 RVA: 0x0000B39A File Offset: 0x0000959A
			...
			{
				// Token: 0x06000419 RID: 1049 RVA: 0x0000B3A2 File Offset: 0x000095A2
				...
				// (get) Token: 0x0600041A RID: 1050 RVA: 0x0000B3C7 File Offset: 0x000095C7
				...
				// (get) Token: 0x0600041B RID: 1051 RVA: 0x0000B3E9 File Offset: 0x000095E9
				...
				// Token: 0x0600041C RID: 1052 RVA: 0x0000B3F1 File Offset: 0x000095F1
				bool IEnumerator.MoveNext()
				{
					return this.enumerator.MoveNext();
				}

				// Token: 0x0600041D RID: 1053 RVA: 0x0000B3FE File Offset: 0x000095FE
				void IEnumerator.Reset()
				{
					this.enumerator.Reset();
				}

				// Token: 0x0600041E RID: 1054 RVA: 0x0000B40B File Offset: 0x0000960B
				...
				{
					// Token: 0x0600041F RID: 1055 RVA: 0x0000B418 File Offset: 0x00009618
					...
					// (get) Token: 0x06000420 RID: 1056 RVA: 0x0000B42E File Offset: 0x0000962E
					public IEdmValue Value
					{
						get
						{
