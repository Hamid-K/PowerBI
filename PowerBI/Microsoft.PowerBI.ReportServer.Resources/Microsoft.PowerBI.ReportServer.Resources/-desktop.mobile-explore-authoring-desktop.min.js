...
(self.webpackChunkdesktop = self.webpackChunkdesktop || []).push([ [ "mobile-explore-authoring-desktop", "mobile-explore-authoring" ], {
    ...
    12412: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, {
            MobileExploreAuthoringDesktopModule: function() {
                return MobileExploreAuthoringDesktopModule;
            }
        });
        var tslib_es6 = __webpack_require__(81337), exploration_navigation_service = __webpack_require__(39503), lazy_scoped_provider = __webpack_require__(28894), JsonExtensions = __webpack_require__(26112), mobile_state_cache_service = __webpack_require__(80532), mobile_state_serializer_service = __webpack_require__(9149), mobile_state_utils = __webpack_require__(71901), events = __webpack_require__(84376), Telemetry = __webpack_require__(21617), core = __webpack_require__(50423), MobileStateDesktopServiceLazyProvider = {
            provide: "mobileStateAuthoringService",
            useFactory: function(telemetryService, explorationNavigation, mobileStateCacheService, mobileStateSerializerService, lazyScopedProvider) {
                return new Promise(function(resolve) {
                    resolve(new MobileStateDesktopService(telemetryService, explorationNavigation, mobileStateCacheService, mobileStateSerializerService, lazyScopedProvider));
                });
            },
            deps: [ Telemetry.y0, exploration_navigation_service.z, mobile_state_cache_service.j, mobile_state_serializer_service.c, lazy_scoped_provider.H ]
        }, MobileStateDesktopService = function() {
            function MobileStateDesktopService(telemetryService, explorationNavigation, mobileStateCacheService, mobileStateSerializerService, lazyScopedProvider) {
                this.telemetryService = telemetryService, this.explorationNavigation = explorationNavigation, 
                this.mobileStateCacheService = mobileStateCacheService, this.mobileStateSerializerService = mobileStateSerializerService, 
                this.lazyScopedProvider = lazyScopedProvider;
            }
            return MobileStateDesktopService.prototype.apply = function(exploration) {
                return (0, tslib_es6.__awaiter)(this, void 0, void 0, function() {
                    var mobileVcObjectsProxy;
                    return (0, tslib_es6.__generator)(this, function(_a) {
                        switch (_a.label) {
                          case 0:
                            return [ 4, this.lazyScopedProvider.get("mobileVcObjectsProxy") ];

                          case 1:
                            return (mobileVcObjectsProxy = _a.sent()).isSupported() ? (this.mobileStateHasBeenCalled = !1, 
                            [ 4, this.load(exploration) ]) : [ 2, exploration ];

                          case 2:
                            return _a.sent(), [ 2, mobileVcObjectsProxy.wrap(exploration) ];
                        }
                    });
                });
            }, MobileStateDesktopService.prototype.load = function(exploration) {
                return (0, tslib_es6.__awaiter)(this, void 0, void 0, function() {
                    var cachedMobileState, wireContract, mobileState;
                    return (0, tslib_es6.__generator)(this, function(_a) {
                        return this.mobileStateCacheService.hasChanges = !0, cachedMobileState = this.mobileStateCacheService.getSerialized(), 
                        this.mobileStateHasBeenCalled || !cachedMobileState || (this.mobileStateHasBeenCalled = !0, 
                        wireContract = (0, JsonExtensions.K)(cachedMobileState), mobileState = this.mobileStateSerializerService.deserialize(wireContract), 
                        this.hasMobileState = !!mobileState, (0, mobile_state_utils.zi)(exploration, mobileState.explorationState, void 0, this.telemetryService.startEvent(events.Y8)), 
                        this.telemetryService.logEvent(events.oe)), [ 2 ];
                    });
                });
            }, MobileStateDesktopService.prototype.getSerializedCurrentState = function() {
                var exploration = this.explorationNavigation.getCurrentExploration(), explorationState = (0, 
                mobile_state_utils.$g)(exploration, this.telemetryService.startEvent(events.Nv)), mobileState = this.mobileStateSerializerService.serialize(explorationState);
                return this.logTelemetry(mobileState), JSON.stringify(mobileState);
            }, MobileStateDesktopService.prototype.logTelemetry = function(mobileState) {
                var prevHasMobileState = this.hasMobileState;
                mobileState ? this.telemetryService.logEvent(prevHasMobileState ? events.IG : events.gC) : prevHasMobileState && this.telemetryService.logEvent(events.dX);
            }, MobileStateDesktopService.\u0275fac = function(t) {
                return new (t || MobileStateDesktopService)(core["\u0275\u0275inject"](Telemetry.y0), core["\u0275\u0275inject"](exploration_navigation_service.z), core["\u0275\u0275inject"](mobile_state_cache_service.j), core["\u0275\u0275inject"](mobile_state_serializer_service.c), core["\u0275\u0275inject"](lazy_scoped_provider.H));
            }, MobileStateDesktopService.\u0275prov = core["\u0275\u0275defineInjectable"]({
                token: MobileStateDesktopService,
                factory: MobileStateDesktopService.\u0275fac
            }), MobileStateDesktopService;
        }(), user_settings_service = __webpack_require__(4369), MobileVisualFormattingSettingsService = function() {
            function MobileVisualFormattingSettingsService(userSettingsService) {
                this.userSettingsService = userSettingsService;
            }
            return MobileVisualFormattingSettingsService.prototype.isFormattingChangeDialogShown = function() {
                return this.userSettingsService.getFirstMobileFormattingChangeDialogShown();
            }, MobileVisualFormattingSettingsService.prototype.markFormattingChangeDialogShown = function() {
                return this.userSettingsService.setFirstMobileFormattingChangeDialogShown(!0);
            }, MobileVisualFormattingSettingsService.\u0275fac = function(t) {
                return new (t || MobileVisualFormattingSettingsService)(core["\u0275\u0275inject"](user_settings_service.s));
            }, MobileVisualFormattingSettingsService.\u0275prov = core["\u0275\u0275defineInjectable"]({
                token: MobileVisualFormattingSettingsService,
                factory: MobileVisualFormattingSettingsService.\u0275fac
            }), MobileVisualFormattingSettingsService;
        }(), mobile_explore_authoring_module = __webpack_require__(43104), mobileVisualFormattingSettings = __webpack_require__(55525), MobileExploreAuthoringDesktopModule = function() {
            function MobileExploreAuthoringDesktopModule() {}
            return MobileExploreAuthoringDesktopModule.\u0275fac = function(t) {
                return new (t || MobileExploreAuthoringDesktopModule);
            }, MobileExploreAuthoringDesktopModule.\u0275mod = core["\u0275\u0275defineNgModule"]({
                type: MobileExploreAuthoringDesktopModule
            }), MobileExploreAuthoringDesktopModule.\u0275inj = core["\u0275\u0275defineInjector"]({
                providers: [ MobileStateDesktopServiceLazyProvider, {
                    provide: mobileVisualFormattingSettings.P,
                    useClass: MobileVisualFormattingSettingsService
                } ],
                imports: [ mobile_explore_authoring_module.MobileExploreAuthoringModule ]
            }), MobileExploreAuthoringDesktopModule;
        }();
    },
