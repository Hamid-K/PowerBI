...
(self.webpackChunkdesktop = self.webpackChunkdesktop || []).push([ [ "tableEx" ], {
    ...
    97654: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, {
            TableEx: function() {
                return TableEx;
            }
        });
        var tslib_es6 = __webpack_require__(81337), seriesLevelToggleBehavior = __webpack_require__(3665), dataViewObjectChangeHelper = __webpack_require__(51650), addDataViewObjectChange = __webpack_require__(57622), objectEnumerationBuilder = __webpack_require__(28579), onObjectUtil = __webpack_require__(80065), htmlSubSelectionHelper = __webpack_require__(52287), subSelectionOutlineRenderer = __webpack_require__(86900), tableExOptions = __webpack_require__(35249), tablixProperties = __webpack_require__(55007), tooltipService = __webpack_require__(40739), outline = __webpack_require__(40550), debug = __webpack_require__(62458), asyncSerializer = __webpack_require__(57419), browserUtils = __webpack_require__(59107), enums = __webpack_require__(46135), contracts_selector = __webpack_require__(32379), valueFormatter = __webpack_require__(72489), pivotTableControlTypes = __webpack_require__(79465), tablixControl = __webpack_require__(24133), tablixUtils1 = __webpack_require__(93340), tablixConstants = __webpack_require__(71090), ITablixFormatting = __webpack_require__(73889), tablixPropertyManager = __webpack_require__(74304), tableEx_capabilities = __webpack_require__(60014), converterHelper = __webpack_require__(54522), textUtil = __webpack_require__(44977), units = __webpack_require__(32105), textAlignment = __webpack_require__(19650), color = __webpack_require__(64067), CssConstants = __webpack_require__(79154), Prototype = __webpack_require__(39681), urlUtils = __webpack_require__(48066), Utility = __webpack_require__(38078), structuralType = __webpack_require__(58702), pivotTablePage = __webpack_require__(7911), pivotTableControlConstants = __webpack_require__(87914), pivotTableSortingManager = __webpack_require__(59784), PivotTableBinderUtils = __webpack_require__(91468), pivotTableDataBarsUtils = __webpack_require__(32771), pivotTableSparklineUtils = __webpack_require__(29043), tableBinder = __webpack_require__(44245), TableExSortingManager = function() {
            function TableExSortingManager(hostServices, isA11yTable) {
                this.isA11yTable = isA11yTable, this.hostServices = hostServices;
            }
            return TableExSortingManager.prototype.sort = function(header, columns, append) {
                void 0 === append && (append = !1);
                var resultSortDescriptors, currentSortDirection = TableExSortingManager.getSortDirection(header), newSortDirection = pivotTableSortingManager.S.getNextSortDirection(currentSortDirection, header.metadata), queryName = header.metadata.queryName, newColumnSortDescriptor = {
                    queryName,
                ...
                this.hostServices.onCustomSort({
                    ...
                    suppressAnnouncements: this.isA11yTable
                });
            ...
            function TableExBinder(options, selectionManager, container, host, a11yMatrixFS) {
                this.a11yMatrixFS = a11yMatrixFS, this.options = options, this.selectionManager = selectionManager, 
                this.measureElement = (0, PivotTableBinderUtils.qk)(container), this.legacyTooltipsEnabled = !0, 
                this.hostServices = host;
            }
            return TableExBinder.prototype.setFormatMode = function(formatMode) {
                this.formatMode = formatMode;
            }, TableExBinder.prototype.getRowLabelAndRole = function(cellWithReferenceText) {
                var rowLabel = this.hostServices.getLocalizedString(tablixConstants.Mh), rowRole = "gridcell";
                return null != (null == cellWithReferenceText ? void 0 : cellWithReferenceText.dataPoint) && (rowLabel = this.hostServices.getLocalizedString("Visual_Tablix_ReferenceRowWithText", cellWithReferenceText.dataPoint.toString()), 
                rowRole = "rowheader"), {
                    rowLabel: (0, Utility.HZ)(rowLabel),
                    rowRole
                };
            }, TableExBinder.prototype.getRowHeaderBinding = function(rowHeader, forMeasurement, onObject, isFooter, cellWithReferenceText) {
                this.options.onBindRowHeader && !forMeasurement && this.options.onBindRowHeader(rowHeader);
                var _a = this.getRowLabelAndRole(cellWithReferenceText), rowLabel = _a.rowLabel, rowHeaderBinding = {
                    attributes: {
                        role: _a.rowRole
                    },
                    classNames: [],
                ...
                return isFooter || (rowHeaderBinding.children = [ {
                    tagName: "label",
                    attributes: {},
                    classNames: [ "visually-hidden" ],
                    styleProperties: {},
                    children: [ {
                        ...
                        attributes: {
                            type: "checkbox",
                            "checkbox-rowindex": rowHeader.index.toString()
                        },
                        classNames: [],
                        styleProperties: {}
                    }, {
                ...
                } ], this.selectionManager.isItemSelected(rowHeader) && (rowHeaderBinding.children[0].children[0].attributes.checked = "")), 
                rowHeaderBinding;
            }, TableExBinder.prototype.getColumnHeaderBinding = function(columnHeader, forMeasure, isA11yTable, onObject, nextColumnHeader, columnWidth) {
                var _a, columnHeadersFormatting = this.formattingProperties.columnHeaders, columnFormatting = this.formattingProperties.columnFormatting[columnHeader.metadata.queryName], content = (0, 
                Utility.HZ)(this.getColumnHeaderLabel(columnHeader)), attributes = {}, sortDirection = TableExSortingManager.getSortDirection(columnHeader);
                isA11yTable && (attributes.role = "columnheader", attributes["aria-colindex"] = (0, 
                tablixUtils1.jT)(columnHeader.position.column.index).toString(), 1 === sortDirection ? attributes["aria-sort"] = "ascending" : 2 === sortDirection && (attributes["aria-sort"] = "descending")), 
                _.isEmpty(content) && (content = tablixConstants.jv), columnHeadersFormatting.wordWrap && (content = (0, 
                PivotTableBinderUtils.rP)(content));
                var hasContent = !_.isEmpty(content.trim()), cellStyle = this.getColumnHeaderStyle(columnHeader, forMeasure, hasContent), originalBottom = cellStyle.getExtraBottom();
                cellStyle.paddings.bottom += (0, PivotTableBinderUtils.tO)(this.glyphFontInfo.measuredFontHeight);
                var sortIconBinding = (0, PivotTableBinderUtils.Km)(sortDirection, this.options.sortIconEnabled, this.options.sortingEnabled, pivotTableSortingManager.S.getDefaultSortDirection(columnHeader.metadata), originalBottom, this.glyphFontInfo.textProperties.fontSize, this.hostServices);
                content += pivotTablePage.bG.build(sortIconBinding, {});
                var classes = (0, Prototype.ED)(this.columnHeaderClasses);
                return onObject && (classes.push(htmlSubSelectionHelper.cy), attributes[htmlSubSelectionHelper.Ez] = "".concat("columnHeaders"), 
                attributes[htmlSubSelectionHelper.QZ] = "".concat(1), attributes[htmlSubSelectionHelper.CK] = "Visual_Tablix_ColumnHeaders"), 
                (0, PivotTableBinderUtils.aY)(columnFormatting && columnFormatting.styleHeader && columnFormatting.alignment || columnHeadersFormatting.alignment, classes), 
                (null === (_a = this.isHeaderAutoWidth) || void 0 === _a ? void 0 : _a.call(this, columnHeader)) && (cellStyle.maxWidth = this.getMeasureElementMaxWidth(forMeasure)), 
                {
                    content,
                    classNames: classes,
                    styleProperties: cellStyle.getAttributes(isA11yTable, void 0, this.a11yMatrixFS, columnWidth),
                    attributes
                };
            ...
            }, TableExBinder.prototype.blankRowsEnabled = function() {
                return !1;
            }, TableExBinder.prototype.getRowBinding = function(row, isFooter, cellWithReferenceText, borderInfo) {
                this.options.onBindRowHeader && this.options.onBindRowHeader(row);
                var _a = this.getRowLabelAndRole(cellWithReferenceText), rowBinding = {
                    classNames: [],
                    attributes: {},
                    styleProperties: {},
                    children: [ this.getCheckboxCellBinding(row, isFooter, _a.rowLabel, borderInfo, _a.rowRole) ]
                };
                return this.selectionManager.isRowHighlighted(row) ? this.selectionManager.isItemSelected(row) && rowBinding.classNames.push("row-selected") : rowBinding.classNames.push("row-unselected"), 
                this.formatMode && rowBinding.classNames.push("format-mode"), rowBinding;
            }, TableExBinder.prototype.getCheckboxCellBinding = function(row, isFooter, selectRowLabel, borderInfo, role) {
                var checkboxCellBinding = {
                    ...
                    classNames: [ "cell-interactive" ],
                    styleProperties: {
                        position: "absolute",
                        "box-sizing": "border-box",
                        width: "100%",
                        height: "100%",
                        "--outline-top": borderInfo.weightTop + 1 + "px",
                        "--outline-right": borderInfo.weightRight + 1 + "px",
                        "--outline-bottom": borderInfo.weightBottom + 1 + "px",
                        "--outline-left": borderInfo.weightLeft + 1 + "px"
                    }
                };
                return isFooter || (checkboxCellBinding.children = [ {
                    tagName: "label",
                    attributes: {},
                    classNames: [ "visually-hidden" ],
                    styleProperties: {},
                ...
                checkboxCellBinding;
            }, TableExBinder.prototype.getBodyCellBinding = function(bodyCell, forMeasure, rowHeight, columnWidth, isA11yTable, onObject, nextBodyCell, showTotalPlaceHolders) {
                var _a, urlIconName, content = (0, Utility.HZ)(this.getBodyCellContent(bodyCell)), attributes = {}, hasContent = !_.isEmpty(content.trim()), cellStyle = this.getBodyCellStyle(bodyCell, forMeasure, hasContent), columnMetadata = bodyCell.columnMetadata;
                debug.fF.assertValue(columnMetadata, "Body cell with no column metadata");
                var contentBinding, dataBarsSettings = this.columnsDataBarsSettings[bodyCell.columnMetadata.queryName], applyNumericDataBars = this.shouldApplyDataBars(dataBarsSettings, bodyCell), columnFormatting = this.formattingProperties.columnFormatting[columnMetadata.queryName], iconSettings = (0, 
                ...
                bodyCell.isKpi) content = this.getKpiContentString(bodyCell), attributes = {}; else if (applyNumericDataBars && dataBarsSettings.hideText) content = forMeasure ? tablixConstants.jv : ""; else {
                    ...
                    contentBinding = (0, PivotTableBinderUtils.RD)(content, (0, Utility.HZ)(bodyCell.textContent), urlIconName, this.options.onHyperlinkClicked), 
                    hyperlink = void 0; else if (this.isImage(bodyCell)) {
                        ...
                        contentBinding = (0, PivotTableBinderUtils.D2)((0, Utility.HZ)(imgSrc), gridFormatting.imageHeight, gridFormatting.imageWidth, (0, 
                        Utility.HZ)(bodyCell.altText));
                    } else this.isSparkline(bodyCell) && (content = forMeasure ? tablixConstants.jv : "");
                }
                this.options.hyperlinksEnabled && (contentBinding || "" !== content && content !== tablixConstants.jv) && hyperlink && (0, 
                urlUtils.MN)(hyperlink) !== urlUtils.av.NONE && (contentBinding = (0, PivotTableBinderUtils.RD)(contentBinding || content, (0, 
                Utility.HZ)(hyperlink), null, this.options.onHyperlinkClicked, !0, !0));
                var indicatorBinding, styleProperties = {};
                if (null === (_a = this.isBodyCellAutoWidth) || void 0 === _a ? void 0 : _a.call(this, bodyCell)) {
                    var maxWidth = this.getMeasureElementMaxWidth(forMeasure);
                    void 0 !== maxWidth && (styleProperties["max-width"] = maxWidth);
                }
                if (this.a11yMatrixFS && !forMeasure && bodyCell.position.column.isFirst) {
                    var row = this.selectionManager.getRowFromCell(bodyCell);
                    if (this.selectionManager.isItemSelected(row)) {
                        var borderInfo = this.getBorderInfo(bodyCell.position.row.isFirst, bodyCell.position.row.isLast, !0, !1, !0, pivotTableControlTypes.p0.Body), nextRow = nextBodyCell && this.selectionManager.getRowFromCell(nextBodyCell), isNextBodyCellIndicatorOn = nextRow && this.selectionManager.isItemSelected(nextRow);
                        indicatorBinding = {
                            attributes: {
                                "aria-hidden": "true"
                            },
                ...
                if (iconSettings && (iconSize = this.getBodyCellFontInfo(bodyCell).measuredFontHeight, 
                ...
                isA11yTable && (bodyCell.fontColor || bodyCell.backColor)) {
                ...
                if (this.a11yMatrixFS && indicatorBinding && (_.isEmpty(containerBinding.children) ? containerBinding = {
                    attributes: {},
                    classNames: [],
                    styleProperties: {},
                    children: [ containerBinding, indicatorBinding ]
                } : containerBinding.children.push(indicatorBinding)), onObject) {
                    (attributes = null != attributes ? attributes : {})[htmlSubSelectionHelper.QZ] = "".concat(1);
                    var isMeasure = bodyCell.columnMetadata.isMeasure;
                    bodyCell.isRowGrandTotal || bodyCell.isTotal ? isMeasure || "" === bodyCell.textContent ? (containerBinding.classNames.push(htmlSubSelectionHelper.cy), 
                    attributes[htmlSubSelectionHelper.Ez] = "".concat("totals"), attributes[htmlSubSelectionHelper.CK] = "Visual_Tablix_TotalsSection") : "" !== bodyCell.textContent && (containerBinding.classNames.push(htmlSubSelectionHelper.cy), 
                    attributes[htmlSubSelectionHelper.Ez] = "".concat("total-labels"), attributes[htmlSubSelectionHelper.CK] = "Visual_Tablix_TotalsSection_Label", 
                    attributes[htmlSubSelectionHelper.kv] = JSON.stringify({
                        reference: tableEx_capabilities.Z.total.label,
                        style: 0
                    }).replace(/\"/g, "&quot;")) : (containerBinding.classNames.push(htmlSubSelectionHelper.cy), 
                    attributes[htmlSubSelectionHelper.Ez] = "".concat(isMeasure ? "measure-values" : "values"), 
                    attributes[htmlSubSelectionHelper.CK] = "Visual_Tablix_Values");
                }
                return this.a11yMatrixFS && (row = this.selectionManager.getRowFromCell(bodyCell), 
                this.selectionManager.isBodyCellHighlighted(bodyCell) ? this.selectionManager.isItemSelected(row) && containerBinding.classNames.push("cell-selected") : containerBinding.classNames.push("cell-unselected")), 
                this.addBodyCellClasses(bodyCell, !!urlIconName, contentBinding.classNames, containerBinding.classNames), 
                this.addBodyCellStyleAttributes(bodyCell, cellStyle, containerBinding.styleProperties, isA11yTable, columnWidth), 
                ...
                return this.formattingProperties.values.wordWrap && forMeasure && this.getViewport ? "".concat(this.getViewport().width - pivotTableControlConstants.zf - 3, "px") : void 0;
            }, TableExBinder.prototype.getCornerCellBinding = function(cornerCell, forMeasure, a11yMatrixFS) {
                return a11yMatrixFS ? {
                    content: this.hostServices.getLocalizedString(tablixConstants.uX),
                    classNames: [ "visually-hidden" ],
                    attributes: {
                        role: "columnheader",
                        "aria-colindex": "1",
                ...
                var _a, _b, _c, _d, cellStyle = this.getColumnHeaderStyle(columnHeader, !0, !0);
                return (this.formattingProperties.columnHeaders.wordWrap ? (0, PivotTableBinderUtils.JT)(this.getColumnHeaderLabel(columnHeader), this.getColumnHeaderFontInfo(columnHeader).textProperties) : (0, 
                PivotTableBinderUtils.X1)(this.getColumnHeaderLabel(columnHeader), this.getColumnHeaderFontInfo(columnHeader).textProperties)) + (null !== (_b = null === (_a = cellStyle.borders.left) || void 0 === _a ? void 0 : _a.weight) && void 0 !== _b ? _b : 0) + (null !== (_d = null === (_c = cellStyle.borders.right) || void 0 === _c ? void 0 : _c.weight) && void 0 !== _d ? _d : 0);
                ...
                if (dataBarsSettings && dataBarsSettings.hideText && !bodyCell.isTotal && _.isNumber(bodyCell.dataPoint)) return iconSize;
                var content = this.getBodyCellContent(bodyCell), urlType = (0, tablixUtils1.MN)(bodyCell.columnMetadata, content);
                if (urlType !== urlUtils.av.NONE && (0, PivotTableBinderUtils.RP)(this.formattingProperties.values.urlIcon, urlType)) return iconSize + this.valueFontInfo.fontProperties.size.px;
                ...
                var bodyCellFontInfo = this.getBodyCellFontInfo(bodyCell), cellStyle = this.getBodyCellStyle(bodyCell, !0, !0);
                ...
                var _a, _b, _c, _d, lineCount, columnHeaderInfo = this.getColumnHeaderFontInfo(columnHeader), cellStyle = this.getColumnHeaderStyle(columnHeader, !0, !0);
                lineCount = this.formattingProperties.columnHeaders.wordWrap && null != width ? (0, 
                PivotTableBinderUtils.do)(this.getColumnHeaderLabel(columnHeader), (0, PivotTableBinderUtils.x9)(width, cellStyle), columnHeaderInfo.textProperties).length : 1;
                ...
                var _a, _b, _c, _d, fontInfo = this.getBodyCellFontInfo(bodyCell);
                ...
                var lineCount, content = this.getBodyCellContent(bodyCell), urlType = (0, tablixUtils1.MN)(bodyCell.columnMetadata, content);
                if (urlType !== urlUtils.av.NONE && (0, PivotTableBinderUtils.RP)(this.formattingProperties.values.urlIcon, urlType)) return this.valueFontInfo.fontProperties.size.px;
                ...
                var cellStyle = this.getBodyCellStyle(bodyCell, !0, !0);
                this.formattingProperties.values.wordWrap && null != width ? (bodyCell.icon && (width -= fontInfo.measuredFontHeight + PivotTableBinderUtils.MO), 
                lineCount = (0, PivotTableBinderUtils.do)(content, (0, PivotTableBinderUtils.x9)(width, cellStyle), fontInfo.textProperties).length) : lineCount = 1;
                var topBorder = null !== (_b = null === (_a = cellStyle.borders.top) || void 0 === _a ? void 0 : _a.weight) && void 0 !== _b ? _b : 0, bottomBorder = null !== (_d = null === (_c = cellStyle.borders.bottom) || void 0 === _c ? void 0 : _c.weight) && void 0 !== _d ? _d : 0;
                ...
                return 0;
            }, TableExBinder.prototype.updateFormattingProperties = function(dataView, formattingProperties, style, legacyTooltipsEnabled) {
                this.formattingProperties = formattingProperties, this.legacyTooltipsEnabled = legacyTooltipsEnabled;
                var generalFontSize = formattingProperties.general.textSize, measurer = new PivotTableBinderUtils.Kq, columnFormattingProperties = {}, valuesFormattingProperties = {}, totalFormattingProperties = {};
                ...
                valuesFormattingProperties.family = formattingProperties.values.fontFamily || tablixConstants.dG, 
                ...
                totalFontFamily || this.valueFontInfo.fontProperties.family !== tablixConstants.dG ? totalFontWeight = !0 : this.valueFontInfo.fontProperties.family === tablixConstants.dG && (totalFontFamily = tablixConstants.Zk), 
                totalFormattingProperties.family = totalFontFamily, totalFormattingProperties.size = formattingProperties.total.fontSize, 
                formattingProperties.total.bold && totalFontWeight && (totalFormattingProperties.weight = CssConstants.en), 
                formattingProperties.total.italic && (totalFormattingProperties.style = CssConstants.BF), 
                formattingProperties.total.underline && (totalFormattingProperties.textDecoration = CssConstants.f0), 
                this.totalFontInfo = (0, PivotTableBinderUtils.TQ)(this.valueFontInfo, totalFormattingProperties, measurer), 
                ...
                this.columnHeaderClasses.push(this.formattingProperties.columnHeaders.wordWrap ? PivotTableBinderUtils.n2 : PivotTableBinderUtils.wV), 
                this.options.interactivityIndicatorEnabled && this.options.sortingEnabled && this.columnHeaderClasses.push(PivotTableBinderUtils.VM), 
                this.columnsDataBarsSettings = {};
                var columnFormatting = formattingProperties.columnFormatting;
                if (columnFormatting && dataView && dataView.table && !_.isEmpty(dataView.table.columns)) for (var _i = 0, _a = dataView.table.columns; _i < _a.length; _i++) (queryName = (column = _a[_i]).queryName) && columnFormatting[queryName] && (this.columnsDataBarsSettings[queryName] = (0, 
                ...
                if (sparklineFormatting && dataView && dataView.table && !_.isEmpty(dataView.table.columns)) for (var _b = 0, _c = dataView.table.columns; _b < _c.length; _b++) {
                    ...
                    (queryName = (column = _c[_b]).queryName) && sparklineFormatting[queryName] && (this.sparklineSettings[queryName] = (0, 
                ...
                return this.ensureMeasuringSafeText(header.metadata.displayName, this.formattingProperties.columnHeaders.wordWrap);
            }, TableExBinder.prototype.getBodyCellContent = function(bodyCell) {
                return this.ensureMeasuringSafeText(bodyCell.textContent, this.formattingProperties.values.wordWrap);
            }, TableExBinder.prototype.ensureMeasuringSafeText = function(text, wordWrap) {
                var _a;
                return text ? wordWrap ? _.isEmpty(null === (_a = text.trim) || void 0 === _a ? void 0 : _a.call(text)) ? "" : text : (0, 
                textUtil.zI)(text) : "";
            }, TableExBinder.prototype.addBodyCellStyleAttributes = function(bodyCell, cellStyle, containerStyleAttributes, isA11yTable, columnWidth) {
                cellStyle.setAttributes(containerStyleAttributes, isA11yTable, void 0, this.a11yMatrixFS, columnWidth), 
                containerStyleAttributes.position = "relative", this.a11yMatrixFS || this.selectionManager.isBodyCellHighlighted(bodyCell) || isA11yTable || (0, 
                ...
                return (0, tableBinder.aV)(columnHeader.position, cellStyle, this.formattingProperties, this.getColumnFormatting(columnHeader.metadata), this.options.tablixProperties), 
                cellStyle.fontFamily = void 0, this.formattingProperties.columnHeaders.underline && hasContent && (cellStyle.textDecoration = CssConstants.f0), 
                (0, PivotTableBinderUtils.Nk)(this.columnHeaderFontInfo, cellStyle, hasContent), 
                cellStyle;
            }, TableExBinder.prototype.getBodyCellStyle = function(bodyCell, forMeasure, hasContent) {
                var cellStyle = new tablixUtils1.qZ(PivotTableBinderUtils.K2, PivotTableBinderUtils.K2);
                return bodyCell.isRowGrandTotal ? ((0, tableBinder.ji)(bodyCell.position, bodyCell, cellStyle, this.formattingProperties, this.getColumnFormatting(bodyCell.columnMetadata), this.options.tablixProperties), 
                this.formattingProperties.total.underline && hasContent && (cellStyle.textDecoration = CssConstants.f0), 
                (0, PivotTableBinderUtils.Nk)(this.totalFontInfo, cellStyle, hasContent)) : ((0, 
                tableBinder.cP)(bodyCell.position, bodyCell, cellStyle, this.formattingProperties, this.getColumnFormatting(bodyCell.columnMetadata), this.options.tablixProperties), 
                this.formattingProperties.values.underline && hasContent && (cellStyle.textDecoration = CssConstants.f0), 
                (0, PivotTableBinderUtils.Nk)(this.valueFontInfo, cellStyle, hasContent)), cellStyle;
            }, TableExBinder.prototype.getBorderInfo = function(isFirstRow, isLastRow, isFirstColumn, isLastColumn, isHighlighted, section) {
                var _a, _b, _c, _d, typeTop, typeRight, typeBottom, typeLeft, colorTop, colorRight, colorBottom, colorLeft, sectionProperties, weightTop = 0, weightRight = 0, weightBottom = 0, weightLeft = 0;
                switch (section) {
                  case pivotTableControlTypes.p0.Header:
                ...
                urlIcon && contentClasses.push(tablixConstants.LU), this.options.interactivityIndicatorEnabled && this.options.selectionEnabled && !bodyCell.isRowGrandTotal && !this.formatMode && containerClasses.push(PivotTableBinderUtils.VM), 
                ...
                urlIcon ? defaultAlignment = textAlignment.H.center : bodyCell.isNumeric && (defaultAlignment = textAlignment.H.right), 
                (0, PivotTableBinderUtils.aY)(alignment, contentClasses, defaultAlignment);
            }, TableExBinder.prototype.getKpiContentString = function(bodyCell) {
                return (0, PivotTableBinderUtils.kJ)(bodyCell.columnMetadata.kpi, bodyCell.textContent);
            ...
            }, TableExBinder.prototype.shouldApplyDataBars = function(dataBarsSettings, bodyCell) {
                ...
                switch (dataBarsSettings.totalMatching) {
                  ...
                  default:
                    return debug.fF.assertNever(dataBarsSettings.totalMatching), !bodyCell.isTotal;
                }
            }, TableExBinder.prototype.isImage = function(bodyCell) {
                return !(bodyCell.isRowGrandTotal && !_.isEmpty(bodyCell.columnMetadata.identityExprs)) && (0, 
                converterHelper.pt)(bodyCell.columnMetadata);
            }, TableExBinder.prototype.isSparkline = function(bodyCell) {
        ...
        }(), TableExColumnHierarchyNavigator = function() {
            function TableExColumnHierarchyNavigator() {}
            return TableExColumnHierarchyNavigator.prototype.getNodeLeafCount = function() {
                return 1;
            }, TableExColumnHierarchyNavigator.prototype.isBlank = function() {
                return !1;
            }, TableExColumnHierarchyNavigator.prototype.isBlankRow = function(_index) {
                return !1;
            }, TableExColumnHierarchyNavigator.prototype.numberOfBlankRowsBefore = function(_index) {
                return 0;
            }, TableExColumnHierarchyNavigator.prototype.getIndexOfFirstLeaf = function(columnHeader) {
                return columnHeader.position.column.index;
            }, TableExColumnHierarchyNavigator.prototype.hasHierarchy = function() {
                return !0;
            ...
            }, TableExColumnHierarchyNavigator.prototype.getAncestor = function(item) {
                return null;
                ...
                return debug.fF.assert(function() {
                    return 0 === levelIndex;
                }, "Table columns hierarchy has 1 level"), (0, tslib_es6.__spreadArray)([], this.columns || [], !0);
                ...
                var position = new tablixUtils1.ri;
            ...
            return TableExRowHierarchyNavigator.prototype.update = function(rows, identities, total, isDataComplete, columns, formattingProperties) {
            ...
            }, TableExRowHierarchyNavigator.prototype.getNodeLeafCount = function() {
                return 1;
            }, TableExRowHierarchyNavigator.prototype.getIndexOfFirstLeaf = function(row) {
                return row.index;
            }, TableExRowHierarchyNavigator.prototype.hasHierarchy = function() {
                return !1;
            }, TableExRowHierarchyNavigator.prototype.getRows = function() {
                return this.rows;
            }, TableExRowHierarchyNavigator.prototype.isBlank = function() {
                return !1;
            }, TableExRowHierarchyNavigator.prototype.isBlankRow = function(_index) {
                return !1;
            }, TableExRowHierarchyNavigator.prototype.numberOfBlankRowsBefore = function(_index) {
                return 0;
            ...
            }, TableExRowHierarchyNavigator.prototype.getAncestor = function(item) {
                return null;
                ...
                return debug.fF.assert(function() {
                    return 0 === levelIndex;
                }, "Table rows hierarchy has 1 level"), [ this.rows[0] ];
                ...
                var _a, _b, columnIndex = columnItem.position.column.index, value = rowItem.values[columnIndex], objects = rowItem.values.objects && rowItem.values.objects[columnIndex], queryName = columnItem.metadata.queryName, columnMetadata = columnItem.metadata, isRowGrandTotal = rowItem === this.floatingRow;
                _.isString(value) && (null === (_b = null === (_a = null == columnMetadata ? void 0 : columnMetadata.type) || void 0 === _a ? void 0 : _a.misc) || void 0 === _b ? void 0 : _b.sparkline) && (value = (0, 
                pivotTableSparklineUtils.th)(value, this.hostServices));
                var cellPosition = new tablixUtils1.ri, columnPosition = columnItem.position;
                ...
                var isTotalLabel = isRowGrandTotal && !columnMetadata.isMeasure && 0 === columnPosition.column.index;
                if (isTotalLabel) textContent = tooltipContent = this.formattingProperties.total.totalLabel; else {
                    var formatter = this.formatters[queryName], tooltipFormatter = this.tooltipFormatters[queryName];
                    textContent = formatter ? formatter.format(value, objects) : null != value ? "".concat(value) : "", 
                ...
                var cellItem = {
                    ...
                    isDefaultTotalLabel: isTotalLabel && this.formattingProperties.total.isDefaultTotalLabel,
                    textContent,
                    tooltipContent,
                    isKpi: columnMetadata && (0, tablixUtils1.Y1)(columnMetadata.kpi, textContent),
                    isNumeric: columnMetadata && columnMetadata.type.numeric && !columnMetadata.kpi
                };
                return objects && (cellItem.backColor = (0, Utility.HZ)(this.tablixProperties.PropValuesBackColor.getValue(objects)), 
                cellItem.fontColor = (0, Utility.HZ)(this.tablixProperties.PropValuesFontColor.getValue(objects)), 
                cellItem.icon = tablixProperties.FX.PropValuesIcon.getValue(objects), cellItem.hyperlink = tablixProperties.FX.PropValuesWebURL.getValue(objects), 
                cellItem.altText = tablixProperties.FX.PropAltTextValue.getValue(objects)), cellItem;
            ...
            TableExRowHierarchyNavigator.prototype.updateRows = function(rows, identities) {
                ...
                this.floatingRow = _.isEmpty(total) ? null : {
                    index: 0,
                    values: total,
                    identity: void 0
                };
            }, TableExRowHierarchyNavigator;
        }(), selectionId = __webpack_require__(26543), TableExInteractionManager = function() {
            ...
            return TableExInteractionManager.prototype.getBodyHandler = function() {
                ...
                return {
                    ...
                    setTooltipDelegate: function(getItemFn, element, getRegionFn, showByDefaultOverride, shouldHideDefaultTooltipFn) {
                        return _this.setTooltipDelegate(getItemFn, element, showByDefaultOverride, shouldHideDefaultTooltipFn);
                    },
                ...
                var _this = this;
                return {
                    addTooltip: function(headerCell, headerElement, isA11yTable) {
                        return _this.addHeaderTooltip(headerCell, headerElement, isA11yTable);
                    },
                    ...
                    setTooltipDelegate: function(getItemFn, element, getRegionFn, showByDefaultOverride, shouldHideDefaultTooltipFn) {
                        return _this.setTooltipDelegateHeader(getItemFn, element, showByDefaultOverride, shouldHideDefaultTooltipFn);
                    },
                    isTooltipEnabledGeneric: function() {
                        return _this.tooltipsEnabled;
                    }
            ...
            }, TableExInteractionManager.prototype.addBodyTooltip = function(item, itemElement) {
                ...
                this.tooltipService.addTooltip(selection, function(args) {
                    ...
                    var itemSelectionId = _this.getItemSelectionId(item, args);
                    return itemSelectionId && [ itemSelectionId ];
                });
            }, TableExInteractionManager.prototype.setTooltipDelegate = function(getItemFn, element, showByDefaultOverride, shouldHideDefaultTooltipFn) {
                var _this = this, selection = d3.select(element);
                this.tooltipService.addTooltip(selection, function(tooltipEventArgs) {
                    return !_this.tooltipsEnabled && shouldHideDefaultTooltipFn(tooltipEventArgs) ? null : _this.getBodyTooltipInfo(getItemFn(tooltipEventArgs), tooltipEventArgs, !_this.tooltipsEnabled);
                }, function(tooltipEventArgs) {
                    if (!_this.tooltipsEnabled) return null;
                    var itemSelectionId = _this.getItemSelectionId(getItemFn(tooltipEventArgs), tooltipEventArgs);
                    return itemSelectionId && [ itemSelectionId ];
                }, !0, !0, showByDefaultOverride);
            }, TableExInteractionManager.prototype.addHeaderTooltip = function(item, itemElement, isA11yTable) {
                var _a, _b, _this = this, selection = d3.select(itemElement), isTouchScreenOptimizedEnabled = null === (_b = (_a = this.tooltipService).isTouchScreenOptimizedEnabled) || void 0 === _b ? void 0 : _b.call(_a);
                this.tooltipService.addTooltip(selection, function(args) {
                ...
                } : function(args) {}, void 0, isA11yTable);
            }, TableExInteractionManager.prototype.setTooltipDelegateHeader = function(getItemFn, itemElement, showByDefaultOverride, shouldHideDefaultTooltipFn) {
                var _a, _b, _this = this, selection = d3.select(itemElement), isTouchScreenOptimizedEnabled = null === (_b = (_a = this.tooltipService).isTouchScreenOptimizedEnabled) || void 0 === _b ? void 0 : _b.call(_a);
                this.tooltipService.addTooltip(selection, function(args) {
                    return !_this.tooltipsEnabled && shouldHideDefaultTooltipFn(args) ? null : _this.getHeaderTooltipInfo(getItemFn(args), args, !_this.tooltipsEnabled);
                }, function(args) {
                    return _this.tooltipsEnabled && isTouchScreenOptimizedEnabled ? [ _this.getItemSelectionId(getItemFn(args), args) ] : null;
                }, !0, !0, showByDefaultOverride);
            }, TableExInteractionManager.prototype.removeTooltip = function(itemElement) {
            ...
            }, TableExInteractionManager.prototype.getHeaderTooltipInfo = function(item, args, contentOnly) {
                if (item) return contentOnly ? [ {
                    displayName: "",
                    value: item.metadata.displayName
                } ] : [ {
                    displayName: item.metadata.displayName
                } ];
            }, TableExInteractionManager.prototype.getBodyTooltipInfo = function(item, args, contentOnly) {
                var _a;
                if (this.rowHierarchyNavigator && item) {
                    if (contentOnly) {
                        if ("IconOnly" === (null === (_a = item.icon) || void 0 === _a ? void 0 : _a.layout)) return;
                        return [ {
                            displayName: "",
                            value: item.tooltipContent
                        } ];
                    }
                    var tooltipItems = [], rowItem = this.rowHierarchyNavigator.getHierarchyLeafAt(item.position.row.index);
                    if (!item.isRowGrandTotal) {
                        var groupingInfo = this.getGroupingTooltipInfo(rowItem);
                        groupingInfo && tooltipItems.push.apply(tooltipItems, groupingInfo || []);
                    }
                    if (item.columnMetadata.isMeasure) {
                        var displayName = item.columnMetadata.displayName;
                        item.isKpi ? tooltipItems.push({
                            displayName,
                            kpiValue: {
                                metadata: item.columnMetadata.kpi,
                                value: item.tooltipContent
                    ...
                    } else item.isRowGrandTotal && !_.isEmpty(item.tooltipContent) && tooltipItems.push({
                        displayName: item.tooltipContent
                    });
                    return _.isEmpty(tooltipItems) ? void 0 : tooltipItems;
                }
                ...
                if (this.columnHierarchyNavigator && this.rowHierarchyNavigator) {
                    for (var tooltipItems = [], _i = 0, columns_1 = this.columnHierarchyNavigator.getColumns(); _i < columns_1.length; _i++) {
                        var groupingColumnItem = columns_1[_i];
                        if (!groupingColumnItem.metadata.isMeasure) {
                            var intersection = this.rowHierarchyNavigator.getIntersection(rowItem, groupingColumnItem);
                            tooltipItems.push({
            ...
            }, TableExInteractionManager.prototype.getItemSelectionId = function(item, args) {
                if (this.rowHierarchyNavigator && item && !item.isRowGrandTotal) {
                    var rowItem = this.rowHierarchyNavigator.getHierarchyLeafAt(item.position.row.index);
                    return selectionId.l0.fromSelectorsByColumn(this.selectionManager.createSelectorsByColumn(rowItem));
                }
            }, TableExInteractionManager;
        }(), eventBubblingUtil = __webpack_require__(66232), dataViewScopeIdentity = __webpack_require__(78843), TableExSelectionManager = function() {
            function TableExSelectionManager(hostServices) {
                this.hostServices = hostServices, this.totalLabel = this.hostServices.getLocalizedString(tablixConstants.qT), 
                this.clearLocal();
            }
            return TableExSelectionManager.prototype.onBodyCellContextMenu = function(bodyCell, mouseEvent) {
                if ((0, eventBubblingUtil.n)(mouseEvent), this.isTableEmpty()) debug.fF.assertFail("onBodyCellContextMenu should not be triggered on empty table."); else {
                    var contextMenuItems, row = this.getRowFromCell(bodyCell);
                    contextMenuItems = !this.isSelectionEmpty() && this.isItemSelected(row) ? this.selectedItems : [ row ];
                    var args = this.createContextMenuArgs(bodyCell, contextMenuItems, mouseEvent);
                    args && this.hostServices.onContextMenu(args);
                }
            }, TableExSelectionManager.prototype.onBodyCellClick = function(bodyCell, selectionMode, rowIndex) {
                debug.fF.assert(function() {
                    return null != bodyCell || null != rowIndex;
                }, "cell or row should be defined"), this.isTableEmpty() ? debug.fF.assertFail("onBodyCellClick should not be triggered on empty table.") : bodyCell ? bodyCell.isRowGrandTotal ? this.clearHost() : this.select(this.getRowFromCell(bodyCell), selectionMode) : this.select(this.rows[rowIndex], selectionMode);
                ...
                debug.fF.assertFail("isDrillingEnabled should not be triggered on empty table.");
                ...
                for (var foundMatch = !1, unmatchedSelectorsByColumn = _.clone(selection), _i = 0, _a = this.rows; _i < _a.length; _i++) {
                    for (var row = _a[_i], matchingSelectorByColumn = void 0, _loop_1 = function(dataPoint) {
                        var id = dataPoint.dataMap[queryName][0];
                        if (debug.fF.assert(function() {
                            return 1 === dataPoint.dataMap[queryName].length;
                        }, "TableExSelectionManager.restoreSelection received an identity with multiple scope identities"), 
                        debug.fF.assert(function() {
                            return (0, contracts_selector.yN)(id);
                        }, "TableExSelectionManager.restoreSelection received an identity that was not a scope identity"), 
                        (0, dataViewScopeIdentity.fS)(id, row.identity)) return matchingSelectorByColumn = dataPoint, 
                        "break";
                    }, _b = 0, unmatchedSelectorsByColumn_1 = unmatchedSelectorsByColumn; _b < unmatchedSelectorsByColumn_1.length && "break" !== _loop_1(unmatchedSelectorsByColumn_1[_b]); _b++) ;
                ...
                var _this = this;
                return debug.fF.assert(function() {
                    return !bodyCell.isRowGrandTotal || bodyCell.isRowGrandTotal && !!_this.totalRow;
                }, "expected a floating row to be present for a rowGrandTotal cell"), bodyCell.isRowGrandTotal ? this.totalRow : this.rows[bodyCell.position.row.index];
            }, TableExSelectionManager.prototype.getRowAtIndex = function(rowIndex) {
                return this.rows[rowIndex];
            }, TableExSelectionManager.prototype.createContextMenuArgs = function(bodyCell, items, mouseEvent) {
                for (var _this = this, data = [], _i = 0, items_1 = items; _i < items_1.length; _i++) {
                    var selector = this.createSelectorsByColumn(items_1[_i]);
                    selector && data.push(selector);
                }
                debug.fF.assert(function() {
                    return !(_.isEmpty(data) && 1 !== _this.rows.length);
                }, "multi-row tables should have identities");
                var args = {
                    data,
                    position: TableExSelectionManager.getMouseEventPosition(mouseEvent)
                };
                return args.copyArgs = {
                    singleValue: function() {
                        var _a, _b;
                        return (null === (_b = null === (_a = bodyCell.columnMetadata.type) || void 0 === _a ? void 0 : _a.misc) || void 0 === _b ? void 0 : _b.sparkline) ? bodyCell.textContent : (0, 
                        tablixUtils1.pW)(bodyCell.dataPoint);
                    },
                    grid: function() {
                        var columnsCount = _this.columns.length, grid = new Array(items.length + 1);
                ...
                for (var visualObjects = [], _i = 0, items_2 = items; _i < items_2.length; _i++) {
                    var selector = this.createSelectorsByColumn(items_2[_i]);
                    selector && visualObjects.push({
                        objectName: "",
                        selectorsByColumn: selector
                    });
                ...
                var _a, dataMap, firstGroup = _.find(this.columns, function(column) {
                    return !column.metadata.isMeasure;
                });
                firstGroup && ((_a = {})[firstGroup.metadata.queryName] = [ item.identity ], dataMap = _a);
                ...
                for (var _i = 0, rows_1 = rows; _i < rows_1.length; _i++) {
                    ...
                    if ((0, dataViewScopeIdentity.fS)(current.identity, row.identity)) return current;
                }
                return null;
                ...
                for (var _i = 0, columnHeaders_1 = columnHeaders; _i < columnHeaders_1.length; _i++) {
                    var current = columnHeaders_1[_i];
        ...
        }(), PivotTableSizeManagerUtils = __webpack_require__(59151), TableExSizeManager = function() {
            ...
            return TableExSizeManager.prototype.onDataViewChanged = function() {
                ...
                return _.find(this.pendingChanges, function(change) {
                    return TableExSelectionManager.areHeadersEqual(change.header, header);
                });
                ...
                return objects ? tablixProperties.FX.PropColumnWidthValue.getValue(objects) : void 0;
            }, TableExSizeManager.prototype.setColumnWidth = function(header, width) {
                this.queuePendingChange(header, width), (0, PivotTableSizeManagerUtils.P)([ {
            ...
            TableExSizeManager.prototype.getRowLevelWidth = function(cornerCell) {}, TableExSizeManager.prototype.setRowLevelWidth = function(cornerCell, width) {
                debug.fF.assertFail("tableExSizeManager:setRowLevelWidth should not be called");
            }, TableExSizeManager.prototype.getColumnLevelHeight = function(cornerCell) {}, 
            TableExSizeManager.prototype.setColumnLevelHeight = function(cornerCell, height) {}, 
            TableExSizeManager.prototype.setMissingWidths = function(headersWidth) {
                for (var widthsToPersist = [], _i = 0, headersWidth_1 = headersWidth; _i < headersWidth_1.length; _i++) {
                    var headerWidth = headersWidth_1[_i], header = headerWidth.header, width = headerWidth.width;
        ...
        }(), pivotTable_capabilities = __webpack_require__(67016), subSelectionCellOutlineRenderer = __webpack_require__(48645), TableEx = function() {
            function TableEx(options, featureSwitches) {
                void 0 === options && (options = (0, tableExOptions.DH)()), this.options = options, 
                this.featureSwitches = featureSwitches || {}, this.options.tooltipsEnabled = this.options.tooltipsEnabled, 
                this.tooltipType = 0, this.asyncSerializer = new asyncSerializer.W, this.supportsOnObject = this.featureSwitches.onObject && this.featureSwitches.a11yMatrix, 
                this.numFontDelays = 0;
            }
            return TableEx.prototype.init = function(options) {
                var _a, _this = this;
                if (this.currentViewport = options.viewport, this.element = options.element, this.hostServices = options.host, 
                this.waitingForData = !1, this.style = options.style, this.tablixPropertyManager = new tablixPropertyManager.U(this.style), 
                this.selectionManager = new TableExSelectionManager(this.hostServices), this.sortingManager = new TableExSortingManager(this.hostServices, this.featureSwitches.a11yTable), 
                this.sizeManager = new TableExSizeManager(this.hostServices), this.tooltipService = (0, 
                tooltipService.r)(options.host), this.supportsOnObject) {
                    ...
                    this.subSelectionHelper = htmlSubSelectionHelper.O5.createHtmlSubselectionHelper({
                        ...
                        renderer: new subSelectionCellOutlineRenderer.y(renderer),
                        targetSource: "format",
                        scale: function() {
                            return _this.currentViewport.scale;
                        },
                        selectorCallback: function(element) {
                            return _this.getSelectorsByColumnFromSubselectedElement(element);
                        }
                    });
                }
            }, Object.defineProperty(TableEx.prototype, "showTotalPlaceHolders", {
                get: function() {
                    return this.featureSwitches.onObject && 1 === this.viewMode && this.isSelected;
                },
                enumerable: !1,
                configurable: !0
            }), TableEx.prototype.onViewModeOrIsSelectedChanged = function(viewMode, isSelected, noRender) {
                var wasShowTotalPlaceHolders = this.showTotalPlaceHolders;
                this.viewMode = viewMode, this.isSelected = isSelected;
                var isShowTotalPlaceHolders = this.showTotalPlaceHolders;
                wasShowTotalPlaceHolders !== isShowTotalPlaceHolders && this.pivotTableControl instanceof tablixControl.d && (this.pivotTableControl.onShowTotalPlaceHoldersChanged(isShowTotalPlaceHolders), 
                noRender || this.pivotTableControl.renderAsync(pivotTableControlTypes.BM.ClearMeasurement));
            }, TableEx.prototype.onViewModeChanged = function(viewMode) {
                this.onViewModeOrIsSelectedChanged(viewMode, this.isSelected);
            }, TableEx.prototype.onSelectionStateChanged = function(isSelected) {
                this.onViewModeOrIsSelectedChanged(this.viewMode, isSelected);
                ...
                return (0, tslib_es6.__awaiter)(this, void 0, void 0, function() {
                    ...
                    return (0, tslib_es6.__generator)(this, function(_a) {
                        switch (_a.label) {
                          case 0:
                            return null != options.viewMode && this.onViewModeOrIsSelectedChanged(options.viewMode, this.isSelected, !0), 
                            this.currentViewport = options.viewport, [ 4, this.asyncSerializer.enqueue(function() {
                                return (0, tslib_es6.__awaiter)(_this, void 0, void 0, function() {
                                    var shouldUpdateSubSelection, shouldAlertScreenReader, labels, message;
                                    return (0, tslib_es6.__generator)(this, function(_a) {
                                        switch (_a.label) {
                                          case 0:
                                            return document.fonts && "loaded" !== document.fonts.status && this.numFontDelays < 2 ? [ 4, new Promise(function(resolve) {
                                          ...
                                          case 2:
                                            return options.type & enums.EP.Data || 2 === options.resizeMode ? [ 4, this.onDataViewChanged(options.dataViews, options.operationKind, options.viewport) ] : [ 3, 4 ];

                                          case 3:
                                            _a.sent(), _a.label = 4;

                                          case 4:
                                            return this.pivotTableControl && options.type & enums.EP.Resize ? (this.pivotTableControl.setWidth(options.viewport.width), 
                                            this.pivotTableControl.setHeight(options.viewport.height), [ 4, this.renderControl(pivotTableControlTypes.BM.Incremental, null, null) ]) : [ 3, 6 ];
                                          ...
                                          case 8:
                                            return shouldUpdateSubSelection = options.type & enums.EP.Data || options.type & enums.EP.Resize || options.type & enums.EP.FormattingSubSelectionChange, 
                ...
                if (!currentAutoSizeColumns && this.pivotTableControl) {
                    for (var columnsWidth = [], columnHeaders = this.columnHierarchyNavigator.getColumns(), columnIndex = 0, _i = 0, pages_1 = this.pivotTableControl.getColumnWidthMeasureManager().getPageColumns(); _i < pages_1.length; _i++) for (var _a = 0, widths_1 = pages_1[_i].getColumnWidths(); _a < widths_1.length; _a++) columnsWidth.push({
                        header: columnHeaders[columnIndex],
                        width: widths_1[_a]
                    }), columnIndex++;
                    this.sizeManager.setMissingWidths(columnsWidth);
                } else currentAutoSizeColumns && previousDataView && previousDataView.metadata && previousDataView.metadata.objects && !tablixProperties.FX.PropColumnPivotTableAutoSizeColumns.getValue(previousDataView.metadata.objects) && this.sizeManager.clearWidths(this.columnHierarchyNavigator.getColumns());
                    ...
                    return (0, tslib_es6.__generator)(this, function(_a) {
                        switch (_a.label) {
                          case 0:
                            ...
                            operationKind !== enums.su.Append ? [ 3, 2 ] : [ 4, this.onAppendDataView(previousDataView, isDataComplete) ]);
                    ...
                    return (0, tslib_es6.__generator)(this, function(_a) {
                        switch (_a.label) {
                          case 0:
                            ...
                            [ 4, this.renderControl(pivotTableControlTypes.BM.Incremental, null, null) ];
                ...
                return (0, tslib_es6.__awaiter)(this, void 0, void 0, function() {
                    var visibleRowItemStart, visibleColumnItemStart, hostTooltipService;
                    return (0, tslib_es6.__generator)(this, function(_a) {
                        switch (_a.label) {
                          case 0:
                            return visibleRowItemStart = this.getPreviousVisibleRowStart(), visibleColumnItemStart = this.getPreviousVisibleColumnStart(), 
                            ...
                            [ 4, this.renderControl(pivotTableControlTypes.BM.ClearMeasurement, this.getVisibleRowStart(visibleRowItemStart, TableExSortingManager.hasSortingChanged(previousDataView, this.dataView)), this.getVisibleColumnStart(visibleColumnItemStart)) ];
            ...
            }, TableEx.prototype.onRestoreSelection = function(options) {
                if (this.selectionManager) {
                    var result = this.selectionManager.restoreSelection(options.selection);
                ...
                return this.pivotTableControl.renderAsync(mode, visibleRowStart, visibleColumnStart);
            ...
            }, TableEx.prototype.getSelectorsByColumnFromSubselectedElement = function(e) {
                var _a, _this = this;
                if (debug.fF.assert(function() {
                    return _this.supportsOnObject;
                }, "Should not be calling getSelectorsByColumnFromSubSelectedElement if does not support onObject"), 
                this.pivotTableControl instanceof tablixControl.d) switch (d3.select(e).attr(htmlSubSelectionHelper.Ez)) {
                  case "values":
                  case "measure-values":
                    var midBodyCell = this.pivotTableControl.getMidRenderer().getItemByElement(e);
                    return (null === (_a = null == midBodyCell ? void 0 : midBodyCell.columnMetadata) || void 0 === _a ? void 0 : _a.queryName) ? {
                        metadata: [ midBodyCell.columnMetadata.queryName ]
                    } : {};
                ...
                var matchingRowStartItem = TableExSelectionManager.getMatchingRow(previousVisibleRowStart.item, this.rowHierarchyNavigator.getRows());
                ...
                var matchingColumnStartItem = TableExSelectionManager.getMatchingColumnHeader(previousVisibleColumnStart.item, this.columnHierarchyNavigator.getColumns());
                ...
                var _a;
                null === (_a = this.pivotTableControl) || void 0 === _a || _a.renderAsync(pivotTableControlTypes.BM.ClearRendering);
            }, TableEx.prototype.createOrUpdateControlAndNavigators = function(isDataComplete) {
                var _this = this;
                if (this.rowHierarchyNavigator || (this.rowHierarchyNavigator = new TableExRowHierarchyNavigator(this.tablixPropertyManager.tablixProperties, this.hostServices), 
                this.columnHierarchyNavigator = new TableExColumnHierarchyNavigator), this.updateHierarchyNavigators(isDataComplete), 
                !this.pivotTableControl) {
                    var binderOptions = {
                    ...
                    this.binder = new TableExBinder(binderOptions, this.selectionManager, tableExContainer, this.hostServices, this.featureSwitches.a11yMatrix);
                    var isA11yTable = this.featureSwitches.a11yTable, isA11yMatrix = this.featureSwitches.a11yMatrix, onObject = this.supportsOnObject;
                    this.pivotTableControl = new tablixControl.d(tableExContainer, this.sizeManager, this.createControlOptions(), isA11yTable, !1, onObject, this.featureSwitches.enableCalculationHighlighting, this.hostServices, this.style, this.onVerticalScrollButtonClick.bind(this), this.onHorizontalScrollButtonClick.bind(this), this.options.interactivityIndicatorEnabled, this.showTotalPlaceHolders, this.subSelectionHelper), 
                    this.binder.getViewport = isA11yMatrix ? function() {
                        return {
                            width: _this.pivotTableControl.getWidth(),
                            height: _this.pivotTableControl.getHeight()
                        };
                    } : function() {
                    ...
                    }.bind(this), this.binder.isBodyCellAutoWidth = function(bodyCell) {
                        var columnHeader = _this.columnHierarchyNavigator.getColumns()[bodyCell.position.column.index];
                        return void 0 === _this.sizeManager.getColumnWidth(columnHeader);
                ...
                this.options.tooltipsEnabled && (this.interactionManager = this.interactionManager = new TableExInteractionManager(this.tooltipService, this.selectionManager, this.hostServices.getLocalizedString(tablixConstants.qT)));
                ...
                return this.options.selection.enabled ? {
                    ...
                    columnHeaderClickHandler: function(columnHeader, mouseEvent) {
                        return _this.onColumnHeaderClickHandler(columnHeader, mouseEvent);
                    },
                    columnHeaderContextMenuHandler: null,
                    columnHeaderInteractionHandler: !this.formatMode && interactionManager ? interactionManager.getHeaderHandler() : null,
                    columnHeaderFocusHandler: function(columnHeader) {
                        return null;
                    },
                    bodyCellClickHandler: function(bodyCell, mouseEvent, rowIndex, section) {
                        return !_this.formatMode && _this.onBodyCellClick(bodyCell, mouseEvent, rowIndex, section);
                    },
                    bodyCellContextMenuHandler: function(bodyCell, mouseEvent) {
                        return !_this.formatMode && _this.onBodyCellContextMenu(bodyCell, mouseEvent);
                    },
                    bodyCellInteractionHandler: !this.formatMode && interactionManager ? interactionManager.getBodyHandler() : null,
                    ...
                    cellContentActivationHandler: function(element, mouseEvent) {
                        return !_this.formatMode && _this.onContentActivation(element, mouseEvent);
                    },
            ...
            }, TableEx.prototype.onColumnHeaderClickHandler = function(columnHeader, mouseEvent) {
                this.supportsOnObject && this.formatMode ? this.subSelectionHelper.isVisualObjectSubSelected({
                    objectName: "columnHeaders",
                    selectorsByColumn: {}
                }) && this.onColumnHeaderClick(columnHeader, mouseEvent) : this.onColumnHeaderClick(columnHeader, mouseEvent);
            }, TableEx.prototype.onBodyCellClick = function(bodyCell, mouseEvent, rowIndex, section) {
                if (section !== pivotTableControlTypes.p0.Footer || bodyCell) if (debug.fF.assert(function() {
                    return null != bodyCell && null != mouseEvent || null != rowIndex;
                }, "cell or row should be defined"), bodyCell) {
                    if (!this.selectionManager.isDrillingEnabled(bodyCell, mouseEvent)) {
                        var selectionMode = void 0;
                        if (1 == (selectionMode = browserUtils.M.isCtrlOrMeta(mouseEvent) || 1 === this.hostServices.dataMultiSelectMode() ? 3 : mouseEvent.shiftKey ? 1 : 0) && this.selectionManager.isItemSelected(this.selectionManager.getRowFromCell(bodyCell))) return;
                        if (1 === selectionMode && bodyCell.isRowGrandTotal) return;
                        this.selectionManager.onBodyCellClick(bodyCell, selectionMode), this.renderSelection(), 
                        this.announceSelectionState(bodyCell, void 0);
                    }
                } else {
                    if (1 == (selectionMode = (null == mouseEvent ? void 0 : mouseEvent.shiftKey) ? 1 : 3) && this.selectionManager.isItemSelected(this.selectionManager.getRowAtIndex(rowIndex))) return;
                    this.selectionManager.onBodyCellClick(void 0, selectionMode, rowIndex), this.renderSelection(), 
                    this.announceSelectionState(bodyCell, rowIndex);
                }
            ...
            }, TableEx.prototype.onVerticalScrollButtonClick = function(rowStart, rowEnd) {
            ...
            }, TableEx.prototype.onHorizontalScrollButtonClick = function(columnStart, columnEnd) {
                ...
                this.hostServices.alertScreenReader(message);
            }, TableEx.prototype.getScrollRowIndex = function(rowIndex) {
                return 0 === rowIndex ? 1 : (0, tablixUtils1.Hd)(rowIndex);
            }, TableEx.prototype.getScrollColumnIndex = function(columnIndex) {
                return 0 === columnIndex ? 1 : (0, tablixUtils1.jT)(columnIndex);
            }, TableEx.prototype.announceSelectionState = function(bodyCell, rowIndex) {
                var _a;
                debug.fF.assert(function() {
                    return null != bodyCell || null != rowIndex;
                }, "cell or row should be defined");
                var row = this.rowHierarchyNavigator.getHierarchyLeafAt(null !== (_a = null == bodyCell ? void 0 : bodyCell.position.row.index) && void 0 !== _a ? _a : rowIndex), isSelected = this.selectionManager.isItemSelected(row), message = this.hostServices.getLocalizedString(isSelected ? tablixConstants.b : tablixConstants.TV);
                this.hostServices.alertScreenReader(message);
            }, TableEx.prototype.onColumnHeaderClick = function(columnHeader, mouseEvent) {
                columnHeader && this.dataView && this.options.sorting.enabled && this.sortingManager.sort(columnHeader, this.dataView.table.columns, mouseEvent.shiftKey);
            }, TableEx.prototype.onContentActivation = function(cellElement, event) {
            ...
            }, TableEx.prototype.onWhitespaceClick = function(shouldAlertScreenReader) {
                ...
                this.needsMoreData(item) && (this.featureSwitches.a11yMatrix ? setTimeout(this.hostServices.loadMoreData) : this.hostServices.loadMoreData(), 
                this.waitingForData = !0, this.hostServices.alertScreenReader(this.hostServices.getLocalizedString("Table_Loading_More_Data")));
                ...
                var loadMoreThreshold = this.rowHierarchyNavigator.getHierarchyLeafCount() * tablixConstants.sR;
                return this.rowHierarchyNavigator.getLeafIndex(item) >= loadMoreThreshold;
            }, TableEx.prototype.getFormattingModel = function() {
                if (this.dataView) return this.tablixPropertyManager.getFormattingModel(this.hostServices, this.formattingProperties, this.dataView, ITablixFormatting.Y.TableEx, void 0, this.featureSwitches, this.style);
            }, TableEx.prototype.enumerateObjectInstances = function(options) {
                var _this = this, enumeration = new objectEnumerationBuilder.G;
                return this.dataView && this.tablixPropertyManager.enumerateObjectInstances(options, enumeration, this.dataView, ITablixFormatting.Y.TableEx, function(key) {
                    for (var _a, args = [], _i = 1; _i < arguments.length; _i++) args[_i - 1] = arguments[_i];
                    return (_a = _this.hostServices).getLocalizedString.apply(_a, (0, tslib_es6.__spreadArray)([ key ], args || [], !1));
                }, this.featureSwitches, void 0, this.style), enumeration.complete();
            }, TableEx.prototype.enumerateObjectRepetition = function() {
                var enumeration = [];
                return this.dataView && this.tablixPropertyManager.enumerateObjectRepetition(enumeration, this.dataView, ITablixFormatting.Y.TableEx, this.featureSwitches), 
                enumeration;
            }, TableEx.prototype.getSubSelectablesAsync = function(filter) {
                var _a;
                return (0, tslib_es6.__awaiter)(this, void 0, void 0, function() {
                    return (0, tslib_es6.__generator)(this, function(_b) {
                        switch (_b.label) {
                          case 0:
                            return [ 4, null === (_a = this.pivotTableControl) || void 0 === _a ? void 0 : _a.renderAsync(pivotTableControlTypes.BM.Incremental) ];

                          case 1:
                            return _b.sent(), [ 2, this.subSelectionHelper.getAllSubSelectables(filter) ];
                        }
                    });
                });
            }, TableEx.prototype.getSubSelectionStyles = function(subSelections) {
                    ...
                    contracts_selector.tV)(visualObject.selectorsByColumn)), visualObject.objectName) {
                      case "columnHeaders":
                        var textSubSelectionStylesColumnHeaders = (0, onObjectUtil.RM)(this.hostServices, {
                            boldReference: tableEx_capabilities.Z.columnHeaders.bold,
                            italicReference: tableEx_capabilities.Z.columnHeaders.italic,
                            underlineReference: tableEx_capabilities.Z.columnHeaders.underline,
                            fontColorReference: tableEx_capabilities.Z.columnHeaders.fontColor,
                            fontFamilyReference: tableEx_capabilities.Z.columnHeaders.fontFamily,
                            fontSizeReference: tableEx_capabilities.Z.columnHeaders.fontSize,
                            backgroundReference: tableEx_capabilities.Z.columnHeaders.backColor,
                            horizontalAlignmentReference: tableEx_capabilities.Z.columnHeaders.alignment,
                            wordWrapReference: tableEx_capabilities.Z.columnHeaders.wordWrap
                        });
                        return textSubSelectionStylesColumnHeaders.grid = {
                            type: "contextmenu"
                        }, textSubSelectionStylesColumnHeaders.border = {
                            type: "contextmenu"
                      ...
                      case "totals":
                        var textSubSelectionStylesTotals = (0, onObjectUtil.RM)(this.hostServices, {
                            boldReference: tableEx_capabilities.Z.total.bold,
                            italicReference: tableEx_capabilities.Z.total.italic,
                            underlineReference: tableEx_capabilities.Z.total.underline,
                            fontColorReference: tableEx_capabilities.Z.total.fontColor,
                            fontFamilyReference: tableEx_capabilities.Z.total.fontFamily,
                            fontSizeReference: tableEx_capabilities.Z.total.fontSize,
                            backgroundReference: tableEx_capabilities.Z.total.backColor
                        });
                        return textSubSelectionStylesTotals.grid = {
                            type: "contextmenu"
                        }, textSubSelectionStylesTotals.border = {
                            type: "contextmenu"
                        }, (0, tslib_es6.__assign)({
                            type: 1
                        }, textSubSelectionStylesTotals);

                      case "values":
                      case "measure-values":
                        if (!selector) return;
                        var columnHeader = this.columnHierarchyNavigator.getColumnIndexFromQueryName(selector.metadata);
                        return (0, onObjectUtil.xs)(this.hostServices, {
                            fontFamilyReference: tableEx_capabilities.Z.values.fontFamily,
                            fontSizeReference: tableEx_capabilities.Z.values.fontSize,
                            boldReference: tableEx_capabilities.Z.values.bold,
                            italicReference: tableEx_capabilities.Z.values.italic,
                            underlineReference: tableEx_capabilities.Z.values.underline,
                            fontColorReference: (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, tableEx_capabilities.Z.columnFormatting.fontColor), {
                                selector
                            }),
                            precisionReference: (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, tableEx_capabilities.Z.columnFormatting.labelPrecision), {
                                selector
                            }),
                            displayUnitsReference: (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, tableEx_capabilities.Z.columnFormatting.labelDisplayUnits), {
                                selector
                            }),
                            backgroundReference: (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, tableEx_capabilities.Z.columnFormatting.backColor), {
                                selector
                            }),
                            horizontalAlignmentReference: (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, tableEx_capabilities.Z.columnFormatting.alignment), {
                                selector
                            }),
                            wordWrapReference: tableEx_capabilities.Z.values.wordWrap
                        }, {
                            precision: {
                                defaultPrecision: (0, valueFormatter.h1)(void 0, (0, valueFormatter.v1)(columnHeader.metadata.type))
                            },
                            grid: {
                                type: "contextmenu"
                            },
            ...
            }, TableEx.prototype.getBorderShortcuts = function(objectName) {
                var borderFormattingId;
                switch (objectName) {
                  case "columnHeaders":
                    borderFormattingId = tableEx_capabilities.Z.columnHeaders.outlineStyle;
                    break;

                  case "totals":
                    borderFormattingId = tableEx_capabilities.Z.total.outlineStyle;
                    break;

                  case "values":
                  case "measure-values":
                    borderFormattingId = tableEx_capabilities.Z.values.outlineStyle;
                    break;
                ...
                return [ {
                    type: 9,
                    referencesAndValues: [ (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, borderFormattingId), {
                        value: outline.$m.Nil
                    }) ],
                    label: this.hostServices.getLocalizedString("Format_Border_NoBorder"),
                    icon: "NoBorder_16"
                }, {
                    type: 9,
                    referencesAndValues: [ (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, borderFormattingId), {
                        value: outline.$m.Top | outline.$m.Bottom | outline.$m.Left | outline.$m.Right
                    }) ],
                    label: this.hostServices.getLocalizedString("Format_Border_AllBorders"),
                    icon: "BoxBorder_16"
                }, {
                    type: 9,
                    referencesAndValues: [ (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, borderFormattingId), {
                    ...
                    label: this.hostServices.getLocalizedString("Format_Border_TopBorder"),
                    icon: "TopBorder_16"
                }, {
                    type: 9,
                    referencesAndValues: [ (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, borderFormattingId), {
                        value: outline.$m.Bottom
                    }) ],
                    label: this.hostServices.getLocalizedString("Format_Border_BottomBorder"),
                    icon: "BottomBorder_16"
                }, {
                    type: 9,
                    referencesAndValues: [ (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, borderFormattingId), {
                        value: outline.$m.Bottom | outline.$m.Top
                    }) ],
                    label: this.hostServices.getLocalizedString("Format_Border_TopAndBottomBorder"),
                    icon: "TopAndThickBottomBorder_16"
                }, {
                    type: 7
                }, {
                    type: 1,
                    destinationInfo: {
                        cardUid: "".concat("Visual", "-").concat("grid"),
                        groupUid: "".concat("grid", "-").concat("border")
                    },
                    label: this.hostServices.getLocalizedString("Format_Border")
                } ];
            }, TableEx.prototype.getGridShortcuts = function() {
                return [ {
                    type: 9,
                    referencesAndValues: [ (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, tableEx_capabilities.Z.grid.gridVertical), {
                        value: !0,
                        isTopLevelToggle: !0
                    }), (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, tableEx_capabilities.Z.grid.gridHorizontal), {
                        value: !0,
                        isTopLevelToggle: !0
                    }) ],
                    label: this.hostServices.getLocalizedString("Small_Multiples_Layout_Grid_Line_Type_Inner"),
                    icon: "AccessGridlinesBoth_16"
                }, {
                    type: 9,
                    referencesAndValues: [ (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, tableEx_capabilities.Z.grid.gridVertical), {
                        value: !1,
                    ...
                    label: this.hostServices.getLocalizedString("Visual_Gridline_Horizontal"),
                    icon: "AccessGridlinesHorizontal_16"
                }, {
                    type: 9,
                    referencesAndValues: [ (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, tableEx_capabilities.Z.grid.gridVertical), {
                        value: !0,
                    ...
                    label: this.hostServices.getLocalizedString("Visual_Gridline_Vertical"),
                    icon: "AccessGridlinesVertical_16"
                }, {
                    type: 9,
                    referencesAndValues: [ (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, tableEx_capabilities.Z.grid.gridVertical), {
                        value: !1,
                    ...
                    label: this.hostServices.getLocalizedString("Visual_Gridline_None"),
                    icon: "AccessGridlinesNone_16"
                }, {
                    type: 7
                }, {
                    type: 1,
                    destinationInfo: {
                        cardUid: "".concat("Visual", "-").concat("grid"),
                        groupUid: "".concat("grid", "-").concat("gridHorizontal")
                    },
                    label: this.hostServices.getLocalizedString("Format_Grid")
                } ];
            }, TableEx.prototype.getSubSelectionShortcuts = function(subSelections, filter) {
                if (this.supportsOnObject) {
                    var visualObject, visualObjects = _.first(subSelections).visualObjects;
                    if (visualObjects.length > 0) {
                        if (visualObject = visualObjects[0], filter) switch (filter) {
                          case "grid":
                            return this.getGridShortcuts();

                          case "border":
                            return this.getBorderShortcuts(visualObject.objectName);
                        }
                        var selector;
                        switch (_.isEmpty(visualObject.selectorsByColumn) || (selector = (0, contracts_selector.tV)(visualObject.selectorsByColumn)), 
                        visualObject.objectName) {
                          ...
                          case "totals":
                          case "total-labels":
                            var totalGroupUid = "".concat("totals", "-").concat("values");
                            return [ {
                                type: 0
                            }, {
                                type: 1,
                                destinationInfo: {
                                    ...
                                    groupUid: totalGroupUid
                                },
                                label: this.hostServices.getLocalizedString("total-labels" === visualObject.objectName ? "Format_Total_Label" : "Format_Totals")
                            } ];

                          case "values":
                          case "measure-values":
                            var valuesGroupUid = "".concat("values", "-").concat("values"), shortcuts = [ {
                                type: 1,
                                destinationInfo: {
                                    cardUid: "".concat("Visual", "-").concat("values"),
                                    groupUid: valuesGroupUid
                                },
                                label: this.hostServices.getLocalizedString("Format_Values")
                            } ];
                            if ("measure-values" === visualObject.objectName) {
                                var selectorWithWildcardData = selector ? this.tablixPropertyManager.getConditionalFormattingSelector(ITablixFormatting.Y.TableEx, selector.metadata) : void 0;
                                shortcuts.unshift({
                                    type: 8,
                                    shortcuts: [ (0, tslib_es6.__assign)((0, tslib_es6.__assign)({
                                        type: 6,
                                        label: this.hostServices.getLocalizedString("Background_Color")
                                    }, pivotTable_capabilities.t.values.backColor), {
                                        selector: selectorWithWildcardData
                                    }), (0, tslib_es6.__assign)((0, tslib_es6.__assign)({
                                        type: 6,
                                        label: this.hostServices.getLocalizedString("Visual_FontColor")
                                    }, pivotTable_capabilities.t.values.fontColor), {
                                        selector: selectorWithWildcardData
                                    }), (0, tslib_es6.__assign)((0, tslib_es6.__assign)({
                                        type: 6,
                                        label: this.hostServices.getLocalizedString("Visual_ConditionalFormatting_DataBars")
                                    }, pivotTable_capabilities.t.columnFormatting.dataBars), {
                                        selector: selector ? this.tablixPropertyManager.getConditionalFormattingSelector(ITablixFormatting.Y.TableEx, selector.metadata, !1) : void 0
                                    }), (0, tslib_es6.__assign)((0, tslib_es6.__assign)({
                                        type: 6,
                                        label: this.hostServices.getLocalizedString("Visual_Tablix_Icons")
                                    }, pivotTable_capabilities.t.values.icon), {
                                        selector: selectorWithWildcardData
                                    }), {
                                        type: 7
                                    }, {
                                        type: 1,
                                        destinationInfo: (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, pivotTable_capabilities.t.values.backColor), {
                                            selector: selectorWithWildcardData
                                        }),
                                        label: this.hostServices.getLocalizedString("Format_Cell_Elements")
                                    } ],
                                    label: this.hostServices.getLocalizedString("Format_AddCellElements")
                                });
                            }
                            return shortcuts.unshift({
                                type: 0
                            }), shortcuts;
                        }
                    }
                }
            }, TableEx.prototype.onDataViewObjectChanged = function(propertySaveObjects, sourceType) {
                if (!this.supportsOnObject || !this.formatMode || 1 !== sourceType) return propertySaveObjects;
                for (var applyToValuesIdentifier = {
                    objectName: "columnFormatting",
                    propertyName: "styleValues"
                }, backColorSeriesIdentifier = {
                    objectName: "columnFormatting",
                    propertyName: "backColor"
                }, fontColorSeriesIdentifier = {
                    objectName: "columnFormatting",
                    propertyName: "fontColor"
                }, alignmentSeriesIdentifier = {
                    objectName: "columnFormatting",
                    propertyName: "alignment"
                }, behaviorChangeObjects = [], _i = 0, propertySaveObjects_1 = propertySaveObjects; _i < propertySaveObjects_1.length; _i++) {
                    var selector = propertySaveObjects_1[_i].selector;
                    if (selector && selector.metadata) {
                        var columnProperties = this.formattingProperties.columnFormatting[selector.metadata], currentCondition = columnProperties.styleValues || columnProperties.styleHeader || columnProperties.styleTotal;
                        behaviorChangeObjects.push(seriesLevelToggleBehavior.v.create(backColorSeriesIdentifier, currentCondition).onToggleEnabled(addDataViewObjectChange.W.createBooleanDataViewObjectChange(applyToValuesIdentifier, !0, {
                            selector
                        })), seriesLevelToggleBehavior.v.create(fontColorSeriesIdentifier, currentCondition).onToggleEnabled(addDataViewObjectChange.W.createBooleanDataViewObjectChange(applyToValuesIdentifier, !0, {
                            selector
                        })), seriesLevelToggleBehavior.v.create(alignmentSeriesIdentifier, currentCondition).onToggleEnabled(addDataViewObjectChange.W.createBooleanDataViewObjectChange(applyToValuesIdentifier, !0, {
                            selector
                        })));
                    }
                }
                return dataViewObjectChangeHelper.o.applyDataViewObjectsBehaviorChanges(propertySaveObjects, dataViewObjectChangeHelper.o.getDataViewObjectsBehaviorChanges(propertySaveObjects, behaviorChangeObjects));
            }, TableEx;
        }();
    },
