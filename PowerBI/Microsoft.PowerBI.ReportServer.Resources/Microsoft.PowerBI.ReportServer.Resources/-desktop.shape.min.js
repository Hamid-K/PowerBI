...
(self.webpackChunkdesktop = self.webpackChunkdesktop || []).push([ [ "shape" ], {
    6537: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        ...
        var tslib_es6 = __webpack_require__(81337), tileLibraryContent = __webpack_require__(74868), tileLibraryConverter = __webpack_require__(78558), tileLibraryEnumerationHelper = __webpack_require__(89088), tileLibraryTile = __webpack_require__(49366), shape_capabilities = __webpack_require__(86998), common_colorHelper = __webpack_require__(90120), interactivityUtils = __webpack_require__(30237), objectEnumerationBuilder = __webpack_require__(28579), visualLocKeys = __webpack_require__(33024), shapeType = __webpack_require__(67741), CssConstants = __webpack_require__(79154), debug = __webpack_require__(62458), browserUtils = __webpack_require__(59107), build_control_util = __webpack_require__(56578), enums = __webpack_require__(46135), displayNameGetter = __webpack_require__(21571), fontProperties = __webpack_require__(18664), units = __webpack_require__(32105), verticalPosition = __webpack_require__(18765), linecapType = __webpack_require__(39107), speechBubbleTailPosition = __webpack_require__(18989), horizontalPosition = __webpack_require__(92374), color = __webpack_require__(64067), colorHelper = __webpack_require__(44783), fontUtils = __webpack_require__(38265), strokePattern = __webpack_require__(47316), fillProps = {
            props: {
                fillTransparency: shape_capabilities.W$.fill.transparency
            },
            colorProps: {
                fillColor: shape_capabilities.W$.fill.fillColor
            }
        }, getFillDefaults = function(style) {
            return {
                default: {
                    show: !0,
        ...
        }, getOutlineDefaults = function(style) {
            return {
                default: {
                    strokeShow: !0,
                    strokeColor: (0, color.HO)(common_colorHelper.v.getDataColorByIndex(style, 0, colorHelper.fA), -.25),
                    strokeWidth: 1,
            ...
            props: {
                tileShape: shape_capabilities.W$.shape.tileShape,
                shapeRounding: shape_capabilities.W$.shape.roundEdge,
                linecapType: shape_capabilities.W$.shape.linecapType,
                arrowheadSize: shape_capabilities.W$.shape.arrowheadSize,
                arrowStemWidth: shape_capabilities.W$.shape.arrowStemWidth,
                chevronAngle: shape_capabilities.W$.shape.chevronAngle,
                isocelesTriangleTipPosition: shape_capabilities.W$.shape.isocelesTriangleTipPosition,
                parallelogramSlant: shape_capabilities.W$.shape.parallelogramSlant,
                trapezoidSlant: shape_capabilities.W$.shape.trapezoidSlant,
                hexagonSlant: shape_capabilities.W$.shape.hexagonSlant,
                octagonSnipSize: shape_capabilities.W$.shape.octagonSnipSize,
                speechBubbleHeight: shape_capabilities.W$.shape.speechBubbleHeight,
                speechBubbleTailPosition: shape_capabilities.W$.shape.speechBubbleTailPosition,
                speechBubbleTailAngle: shape_capabilities.W$.shape.speechBubbleTailAngle,
                rectangleRoundedCurve: shape_capabilities.W$.shape.rectangleRoundedCurve,
                tabCutCornerSnipSizeTopRight: shape_capabilities.W$.shape.tabCutCornerSnipSizeTopRight,
                tabCutCornerSnipSizeTop: shape_capabilities.W$.shape.tabCutCornerSnipSizeTop,
                tabCutCornerSnipSizeBottom: shape_capabilities.W$.shape.tabCutCornerSnipSizeBottom,
                tabRoundCornerTopRight: shape_capabilities.W$.shape.tabRoundCornerTopRight,
                tabRoundCornerTop: shape_capabilities.W$.shape.tabRoundCornerTop,
                tabRoundCornerBottom: shape_capabilities.W$.shape.tabRoundCornerBottom
            }
        }, getGlowDefaults = function(style) {
            return {
                default: {
                    show: !1,
            ...
            props: {
                text: shape_capabilities.W$.text.text,
                verticalAlignment: shape_capabilities.W$.text.verticalAlignment,
                horizontalAlignment: shape_capabilities.W$.text.horizontalAlignment,
                rightMargin: shape_capabilities.W$.text.rightMargin,
                leftMargin: shape_capabilities.W$.text.leftMargin,
                topMargin: shape_capabilities.W$.text.topMargin,
                bottomMargin: shape_capabilities.W$.text.bottomMargin
            },
            fontProps: {
                fontProperties: {
                    objectName: "text",
                    propertyNames: {
                        color: shape_capabilities.B3.fontColor,
                        family: shape_capabilities.B3.fontFamily,
                        size: shape_capabilities.B3.fontSize,
                        italic: shape_capabilities.B3.italic,
                        bold: shape_capabilities.B3.bold,
                        underline: shape_capabilities.B3.underline
                    }
                }
            }
        }, convertRotation = function(dataViewObject) {
            return (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, rotationDefaults), (0, 
            tileLibraryConverter.Yb)(dataViewObject, rotationProps.props));
        }, rotationProps = {
            props: {
                rotation: shape_capabilities.W$.rotation.angle,
                shapeRotation: shape_capabilities.W$.rotation.shapeAngle,
                textRotation: shape_capabilities.W$.rotation.textAngle
            }
        }, rotationDefaults = {
            rotation: 0,
            shapeRotation: 0,
            textRotation: 0
        }, ShapeSelector = (0, CssConstants.CH)("shapeVisual"), shapeInstanceIds = [ shape_capabilities.W6.default ], Shape = function() {
            function Shape() {}
            return Shape.prototype.init = function(options) {
                this.currentViewport = options.viewport, this.hostServices = options.host, this.elementSelection = d3.select(options.element.get(0)), 
                this.style = options.style, this.shapeTile = new ShapeTile(this.hostServices), this.featureSwitches = options.featureSwitches;
                ...
                if (this.currentViewport = options.viewport, options.dataViews && options.dataViews.length > 0 && options.operationKind !== enums.su.None) {
                    ...
                    debug.fF.assertValue(dataView.metadata, "dataView.metadata"), this.data = Shape.convert(dataView, this.style), 
                    function(tileShape, visualHostServices) {
                        var displayNameGetter, shapeInfo = shapeType.d.members().filter(function(x) {
                            return x.value === tileShape;
                        });
                        shapeInfo.length > 0 && (displayNameGetter = shapeInfo[0].displayName), visualHostServices.setAriaMetadata({
                            subtitleDisplayNameGetter: displayNameGetter
                        });
                    }(this.data.tileProps.shape.default.tileShape, this.hostServices), this.render();
                }
            }, Shape.convert = function(dataView, style) {
                var dataViewObject = dataView.metadata.objects, colorHelper = common_colorHelper.v.create(style), textDefaults = function(style, colorHelper) {
                    return {
                        default: {
                            show: !1,
                            text: "",
                            ...
                            bottomMargin: 0,
                            rotation: 0,
                            fontProperties: (0, fontProperties.Zi)(void 0, {
                                color: shape_capabilities.B3.fontColor,
                                size: shape_capabilities.B3.fontSize,
                                family: shape_capabilities.B3.fontFamily
                            }, colorHelper, style, "background", void 0, {
                                color: common_colorHelper.v.getThemeColor(style, "background"),
                                size: units.B.createFromPt(10),
                                family: fontUtils.Wn.regular.css
                            }, !0)
                        }
                    };
                }(style, colorHelper), rotationProps = convertRotation(dataViewObject), convertedText = (0, 
                tileLibraryConverter.s8)(dataView, colorHelper, shapeInstanceIds, textDefaults, textProps, {
                    default: {
                ...
                return {
                    tileProps: {
                        fill: (0, tileLibraryConverter.P_)(dataView, colorHelper, shapeInstanceIds, getFillDefaults(style), fillProps),
                        outline: (0, tileLibraryConverter.P8)(dataView, colorHelper, shapeInstanceIds, getOutlineDefaults(style)),
                        shape: {
                            default: (0, tileLibraryConverter.E4)(dataViewObject, {
                        ...
                        shadow: (0, tileLibraryConverter.t9)(dataView, colorHelper, shapeInstanceIds, {
                            default: {
                                show: !1,
                                shadowColor: "#000",
                        ...
                        glow: (0, tileLibraryConverter.EI)(dataView, colorHelper, shapeInstanceIds, getGlowDefaults(style))
                    },
                    contentProps: {
                        text: convertedText
                    },
            ...
            }, Shape.prototype.enumerateObjectInstances = function(options) {
                var data = this.data;
                if (!data) return [];
                var enumeration = new objectEnumerationBuilder.G;
                switch (options.objectName) {
                  case shape_capabilities.MI.fill:
                    data.tileProps.shape.default.tileShape !== shapeType.m.Line && (0, tileLibraryEnumerationHelper.JO)(enumeration, data.tileProps.fill, shapeInstanceIds, this.getInstanceDisplayName);
                    break;

                  case shape_capabilities.MI.outline:
                    (0, tileLibraryEnumerationHelper.nT)(enumeration, data.tileProps.outline, shapeInstanceIds, this.getInstanceDisplayName);
                    break;

                  case shape_capabilities.MI.text:
                    (0, tileLibraryEnumerationHelper.DD)(enumeration, data.contentProps.text, shapeInstanceIds, this.getInstanceDisplayName);
                    break;

                  case shape_capabilities.MI.shape:
                    (0, tileLibraryEnumerationHelper.br)(enumeration, data.tileProps.shape.default, this.featureSwitches);
                    break;

                  case shape_capabilities.MI.shadow:
                    (0, tileLibraryEnumerationHelper.UW)(enumeration, data.tileProps.shadow, shapeInstanceIds, this.getInstanceDisplayName);
                    break;

                  case shape_capabilities.MI.glow:
                    (0, tileLibraryEnumerationHelper.gQ)(enumeration, data.tileProps.glow, shapeInstanceIds, this.getInstanceDisplayName);
                    break;

                  case shape_capabilities.MI.rotation:
                    this.enumerateRotationProperties(enumeration, data.rotationProps);
                }
                return enumeration.complete();
            }, Shape.prototype.enumerateRotationProperties = function(enumeration, properties) {
                ...
                }, enumerationProperties = ((_a = {})[shape_capabilities.B3.rotation] = properties.rotation, 
                _a[shape_capabilities.B3.shapeRotation] = properties.shapeRotation, _a[shape_capabilities.B3.textRotation] = properties.textRotation, 
                _a);
                enumeration.pushInstance({
                    objectName: shape_capabilities.B3.rotation,
                    selector: null,
                    properties: enumerationProperties,
                    validValues: (_b = {}, _b[shape_capabilities.B3.shapeRotation] = validValuesForRotation, 
                    _b[shape_capabilities.B3.textRotation] = validValuesForRotation, _b)
                });
            }, Shape.prototype.getFormattingModel = function() {
                var _a, _this = this;
                if (!this.data) return {
                    cards: []
                };
                var isOnObject = null === (_a = this.featureSwitches) || void 0 === _a ? void 0 : _a.onObject;
                return new build_control_util.Nq(function() {
                    return !isOnObject && _this.getShapeCard();
                }, function() {
                    return isOnObject && _this.getShapeStyleCard();
                }, function() {
                    return _this.getRotationCard();
                }, function() {
                    return !isOnObject && _this.getStyleCard();
                }, function() {
                    return _this.getVisualLinkPlaceholder();
                }).build();
            }, Shape.prototype.getShapeCard = function() {
                var _this = this, shapeProps = shape_capabilities.WO.shape, cardUidBuilder = new build_control_util.lg("shape"), groups = [], shapeGroup = (0, 
                tileLibraryEnumerationHelper.YC)(this.data.tileProps.shape.default, this.hostServices, this.featureSwitches, void 0, cardUidBuilder);
                return groups.push(shapeGroup), new build_control_util.CQ(cardUidBuilder, "Visual_Shape", [ shapeProps.tileShape, shapeProps.roundEdge, shape_capabilities.WO.shape.linecapType, shapeProps.arrowheadSize, shapeProps.arrowStemWidth, shapeProps.chevronAngle, shapeProps.isocelesTriangleTipPosition, shapeProps.parallelogramSlant, shapeProps.trapezoidSlant, shapeProps.hexagonSlant, shapeProps.octagonSnipSize, shapeProps.speechBubbleHeight, shapeProps.speechBubbleTailPosition, shapeProps.speechBubbleTailAngle, shapeProps.rectangleRoundedCurve, shapeProps.tabCutCornerSnipSizeTopRight, shapeProps.tabCutCornerSnipSizeTop, shapeProps.tabCutCornerSnipSizeBottom, shapeProps.tabRoundCornerTopRight, shapeProps.tabRoundCornerTop, shapeProps.tabRoundCornerBottom ], function(key) {
                    return _this.hostServices.getLocalizedString(key);
                }).withGroups(groups).build();
            }, Shape.prototype.getShapeStyleCard = function() {
                var _this = this, fillProps = shape_capabilities.WO.fill, glowProps = shape_capabilities.WO.glow, outlineProps = shape_capabilities.WO.outline, shadowProps = shape_capabilities.WO.shadow, shapeProps = shape_capabilities.WO.shape, textProps = shape_capabilities.WO.text, cardUidBuilder = new build_control_util.lg("shapeStyle"), cardBuilder = new build_control_util.CQ(cardUidBuilder, "Visual_ShapeStyle", [ shapeProps.tileShape, shapeProps.roundEdge, shape_capabilities.WO.shape.linecapType, shapeProps.arrowheadSize, shapeProps.arrowStemWidth, shapeProps.chevronAngle, shapeProps.isocelesTriangleTipPosition, shapeProps.parallelogramSlant, shapeProps.trapezoidSlant, shapeProps.hexagonSlant, shapeProps.octagonSnipSize, shapeProps.speechBubbleHeight, shapeProps.speechBubbleTailPosition, shapeProps.speechBubbleTailAngle, shapeProps.rectangleRoundedCurve, shapeProps.tabCutCornerSnipSizeTopRight, shapeProps.tabCutCornerSnipSizeTop, shapeProps.tabCutCornerSnipSizeBottom, shapeProps.tabRoundCornerTopRight, shapeProps.tabRoundCornerTop, shapeProps.tabRoundCornerBottom, fillProps.show, fillProps.fillColor, fillProps.transparency, outlineProps.show, outlineProps.lineColor, outlineProps.weight, outlineProps.transparency, textProps.show, textProps.fontColor, textProps.fontSize, textProps.bold, textProps.italic, textProps.underline, textProps.fontFamily, textProps.text, textProps.verticalAlignment, textProps.horizontalAlignment, textProps.leftMargin, textProps.rightMargin, textProps.topMargin, textProps.bottomMargin, shadowProps.show, shadowProps.color, shadowProps.transparency, shadowProps.shadowBlur, shadowProps.shadowPositionPreset, glowProps.show, glowProps.color, glowProps.transparency, glowProps.shadowBlur ], function(key) {
                    return _this.hostServices.getLocalizedString(key);
                }), instanceId = shapeInstanceIds[0], groups = (0, tslib_es6.__spreadArray)([ (0, 
                tileLibraryEnumerationHelper.YC)(this.data.tileProps.shape.default, this.hostServices, this.featureSwitches, void 0, cardUidBuilder) ], this.getStyleGroups(instanceId, cardUidBuilder), !0);
                return cardBuilder.withGroups(groups), cardBuilder.build();
            }, Shape.prototype.getRotationCard = function() {
                var _this = this, rotationProps = shape_capabilities.WO.rotation, rotationPropValues = this.data.rotationProps, localize = function(key) {
                    return _this.hostServices.getLocalizedString(key);
                };
            ...
            }, Shape.prototype.getStyleCard = function() {
                var _this = this, fillProps = shape_capabilities.WO.fill, outlineProps = shape_capabilities.WO.outline, textProps = shape_capabilities.WO.text, shadowProps = shape_capabilities.WO.shadow, glowProps = shape_capabilities.WO.glow, instanceId = shapeInstanceIds[0], cardUidBuilder = new build_control_util.lg("style");
                return new build_control_util.CQ(cardUidBuilder, "Style", [ fillProps.show, fillProps.fillColor, fillProps.transparency, outlineProps.show, outlineProps.lineColor, outlineProps.weight, outlineProps.transparency, textProps.show, textProps.fontColor, textProps.fontSize, textProps.bold, textProps.italic, textProps.underline, textProps.fontFamily, textProps.text, textProps.verticalAlignment, textProps.horizontalAlignment, textProps.leftMargin, textProps.rightMargin, textProps.topMargin, textProps.bottomMargin, shadowProps.show, shadowProps.color, shadowProps.transparency, shadowProps.shadowBlur, shadowProps.shadowPositionPreset, glowProps.show, glowProps.color, glowProps.transparency, glowProps.shadowBlur ], function(key) {
                    return _this.hostServices.getLocalizedString(key);
                }).withGroups(this.getStyleGroups(instanceId, cardUidBuilder)).build();
            }, Shape.prototype.getVisualLinkPlaceholder = function() {
                return (0, build_control_util.UH)("actions");
            }, Shape.prototype.getStyleGroups = function(instanceId, cardUidBuilder) {
                var groups = [], fillGroup = (0, tileLibraryEnumerationHelper.wH)(!1, this.data.tileProps.fill, this.hostServices, instanceId, cardUidBuilder);
                groups.push(fillGroup);
                var borderGroup = (0, tileLibraryEnumerationHelper.sZ)(this.data.tileProps.outline, this.hostServices, instanceId, cardUidBuilder);
                groups.push(borderGroup);
                var textGroup = (0, tileLibraryEnumerationHelper.oy)(this.data.contentProps.text, this.hostServices, instanceId, cardUidBuilder);
                groups.push(textGroup);
                var shadowGroup = (0, tileLibraryEnumerationHelper.D9)(this.data.tileProps.shadow, this.hostServices, instanceId, cardUidBuilder);
                groups.push(shadowGroup);
                var glowGroup = (0, tileLibraryEnumerationHelper.i7)(this.data.tileProps.glow, this.hostServices, instanceId, cardUidBuilder);
                return groups.push(glowGroup), groups;
            }, Shape.prototype.getInstanceDisplayName = function(tileInstanceId) {
                if (tileInstanceId === shape_capabilities.W6.default) return (0, displayNameGetter.V)("DefaultState");
                debug.fF.assertNever(tileInstanceId);
            }, Shape.prototype.render = function() {
                this.shapeTile.contentProperties = this.data.contentProps, this.shapeTile.update({
        ...
        var ShapeTile = function(_super) {
            function ShapeTile(hostServices) {
                var _this = _super.call(this) || this;
                return _this.hostServices = hostServices, _this;
            }
            return (0, tslib_es6.__extends)(ShapeTile, _super), Object.defineProperty(ShapeTile.prototype, "cursor", {
                get: function() {
                    return this.hasVisualLink ? "pointer" : "inherit";
                },
                enumerable: !1,
                configurable: !0
            }), ShapeTile.prototype.beforeRender = function() {
                var _a;
            ...
            }, ShapeTile.prototype.afterRender = function() {
                return (0, tslib_es6.__awaiter)(this, void 0, void 0, function() {
                    var textProps, textDimensions;
                    return (0, tslib_es6.__generator)(this, function(_a) {
                        return textDimensions = this.getContentInscribedRectangle((textProps = this.contentProperties.text[this.state]).rotation), 
                        this.element.classed(ShapeSelector.class, !0), tileLibraryContent.b.renderText(this.element, (0, 
                        tslib_es6.__assign)((0, tslib_es6.__assign)({}, textProps), {
                            dimensions: textDimensions
                        }), !0), [ 2 ];
                    });
                });
            }, ShapeTile.prototype.onTileClick = function() {
