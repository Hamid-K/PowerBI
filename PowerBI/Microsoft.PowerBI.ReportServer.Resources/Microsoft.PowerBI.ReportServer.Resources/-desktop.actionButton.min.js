...
(self.webpackChunkdesktop = self.webpackChunkdesktop || []).push([ [ "actionButton" ], {
    90033: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, {
            ...
            DarkAndGrayDisabledActionButtonBackgroundColor: function() {
                return DarkAndGrayDisabledActionButtonBackgroundColor;
            },
            DefaultActionButtonForegroundColor: function() {
                return DefaultActionButtonForegroundColor;
            },
            DefaultButtonTextFontSizeInPt: function() {
                return DefaultButtonTextFontSizeInPt;
            },
            DisabledActionButtonForegroundColor: function() {
                return DisabledActionButtonForegroundColor;
            },
            LightDisabledActionButtonBackgroundColor: function() {
                return LightDisabledActionButtonBackgroundColor;
            }
        });
        var tslib_es6 = __webpack_require__(81337), tileLibraryContent = __webpack_require__(74868), tileLibraryConverter = __webpack_require__(78558), tileLibraryEnumerationHelper = __webpack_require__(89088), tileLibraryTile = __webpack_require__(49366), actionButton_capabilities = __webpack_require__(71602), shape_capabilities = __webpack_require__(86998), common_colorHelper = __webpack_require__(90120), fontProperties = __webpack_require__(18664), interactivityUtils = __webpack_require__(30237), objectEnumerationBuilder = __webpack_require__(28579), units = __webpack_require__(32105), visualLocKeys = __webpack_require__(33024), actionButtonType = __webpack_require__(2764), verticalPosition = __webpack_require__(18765), horizontalPosition = __webpack_require__(92374), iconPlacementType = __webpack_require__(67922), linecapType = __webpack_require__(39107), shapeType = __webpack_require__(67741), speechBubbleTailPosition = __webpack_require__(18989), VisualsCommon_colorHelper = __webpack_require__(44783), debug = __webpack_require__(62458), fontUtils = __webpack_require__(38265), browserUtils = __webpack_require__(59107), build_control_util = __webpack_require__(56578), enums = __webpack_require__(46135), dataViewObject2 = __webpack_require__(82755), displayNameGetter = __webpack_require__(21571), visualBackgroundHelper = __webpack_require__(45545), CssConstants = __webpack_require__(79154), svgUtil = __webpack_require__(10389), VisualsCommon_color = __webpack_require__(64067), textMeasurementService = __webpack_require__(32041);
        function styleVisualLink(selection, host) {
            var visualLinkProps = host.getVisualLinkProperties();
            selection && visualLinkProps && selection.style("cursor", visualLinkProps.hasVisualLink ? "pointer" : "inherit");
        }
        var ButtonTextSelector = (0, CssConstants.CH)("button-text"), ButtonIconSelector = (0, 
        CssConstants.CH)("button-icon"), ButtonOutlineSelector = (0, CssConstants.CH)("button-outline");
        function styleButton(data, stateId, viewport, selection, element) {
            selection.styles({
                ...
                position: "relative",
                display: "block",
                "background-color": data.fill[stateId].show ? getRgbaColor(data.fill[stateId].fillColor, data.fill[stateId].fillTransparency) : "transparent",
                "border-radius": data.outline[stateId].roundEdge ? data.outline[stateId].roundEdge + "px" : null
            });
            var buttonElement = element.children("button");
            return (0, visualBackgroundHelper.Re)({
                image: data.fill[stateId].show ? data.fill[stateId].image : void 0,
                transparency: data.fill[stateId].fillTransparency
            }, buttonElement, {
                left: 0,
                top: 0,
                width: viewport.width,
                height: viewport.height
            }), buttonElement.children(".background-image").css({
                left: 0,
                top: 0,
                "pointer-events": "none"
            }), function(data, viewport, selection) {
                var lineWeight, lineColor, lineTransparency, outlineWeight = data.show ? data.outlineWeight : 0;
                selection.select(ButtonOutlineSelector.selector).styles({
                    "pointer-events": "none",
                    top: 0,
                    left: 0,
                    position: "absolute",
                    width: Math.max(viewport.width - 2 * outlineWeight, 0) + "px",
                    height: Math.max(viewport.height - 2 * outlineWeight, 0) + "px",
                    border: data.show ? (lineWeight = data.outlineWeight, lineColor = data.outlineColor, 
                    lineTransparency = data.outlineTransparency, "".concat(lineWeight, "px solid ").concat(getRgbaColor(lineColor, lineTransparency))) : "none",
                    "border-radius": data.roundEdge ? data.roundEdge + "px" : null
                });
            }(data.outline[stateId], viewport, selection), function(data, viewport, selection) {
                var maxWidth = Math.max(viewport.width - 2 * data.padding, 0), text = selection.select(ButtonTextSelector.selector);
                text.text(data.show ? data.text : void 0).styles({
                    "text-align": data.horizontalAlignment,
                    "max-width": maxWidth + "px",
                    "pointer-events": "none"
                }).styles((0, fontProperties.wB)(data.fontProperties));
                var textBox = textMeasurementService.b.measureSvgTextRect((0, fontProperties.qk)(data.fontProperties, data.text));
                alignElement(text, data, viewport, textBox.width > maxWidth ? maxWidth : textBox.width, textBox.height);
            }(data.text[stateId], viewport, selection), function(data, viewport, selection) {
                var svgString = function(shapeType) {
                    switch (shapeType) {
                      case actionButtonType.W.leftArrow:
                        return '<svg viewBox="0 0 32 32"><line x1="30" y1="15" x2="2" y2="15"></line><polyline points="15,2 2,15 15,30"></polyline></svg>';

                      case actionButtonType.W.rightArrow:
                        return '<svg viewBox="0 0 32 32"><line x1="2" y1="15" x2="30" y2="15"></line><polyline points="17,2 30,15 17,30"></polyline></svg>';

                      case actionButtonType.W.back:
                        return '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="13.5"></circle><line x1="25" y1="16" x2="8" y2="16"></line><polyline points="16,8 8,16 16,24"></polyline></svg>';

                      case actionButtonType.W.reset:
                        return '<svg viewBox="0 0 28.3 32"><line x1="17.2" y1="9.9" x2="2.5" y2="9.9"></line><polyline points="10.2,2.3 2.5,9.9 10.2,17.5"></polyline><g><defs><rect id="SVGID_1_" x="16.1" y="0" width="18" height="32"></rect></defs><clipPath id="SVGID_2_"><use xlink:href="#SVGID_1_" style="overflow:visible;"></use></clipPath><path d="M13.1,9.9h4c4.8,0,8.7,3.8,8.7,9.4s-3.7,9.9-8.3,10.2h-2.4"></path></g></svg>';

                      case actionButtonType.W.information:
                        return '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="13.5"></circle><rect x="16" y="10.24" width="0.01" height="0.01"></rect><line x1="16" y1="13.1" x2="16" y2="22.9"></line></svg>';

                      case actionButtonType.W.help:
                        return '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="13.5"></circle><path d="M12.12,13.72a3.75,3.75,0,0,1,3.63-3.78,3.63,3.63,0,0,1,3.64,3.63c0,1.48-.5,1.93-2.35,3.63A4.48,4.48,0,0,0,15.8,19a3.45,3.45,0,0,0-.11.4A8.59,8.59,0,0,0,15.5,21"></path><rect x="15.51" y="23.54" width="0.01" height="0.01"></rect></svg>';

                      case actionButtonType.W.qna:
                        return '<svg viewBox="0 0 24 22.75"><polygon points="22.5 15.5 10.5 15.5 5.5 20.55 5.43 15.5 1.5 15.5 1.5 1.5 22.5 1.5 22.5 15.5"></polygon></svg>';

                      case actionButtonType.W.insights:
                        return '<svg viewBox="0 0 23.5 32"><path d="M11.76,29.5c-1.95,0-4-.65-4-1.95v-5s0-1.09,0-1.45c-.08-1-1.52-2.48-2.59-3.89a12,12,0,0,1-1.62-2.6,9.45,9.45,0,0,1-.62-3.63c0-4.66,4.23-8.44,8.89-8.44s8.89,3.78,8.89,8.44a9.41,9.41,0,0,1-.58,3.55,12.34,12.34,0,0,1-1.67,2.68c-1.06,1.4-2.47,2.86-2.55,3.89,0,.36-.07,1.45-.07,1.45v5C15.78,28.85,13.71,29.5,11.76,29.5Z"></path><line x1="7.75" y1="23.92" x2="15.8" y2="23.92"></line></svg>';

                      case actionButtonType.W.bookmarks:
                        return '<svg viewBox="0 0 22.59 32"><polygon points="20.04 29.25 11.21 25.43 2.37 29.25 2.37 2.5 20.04 2.5 20.04 29.25"></polygon></svg>';

                      case actionButtonType.W.blank:
                      case actionButtonType.W.custom:
                        return;

                      case actionButtonType.W.applyAllSlicers:
                        return '<svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M12.002 19.0039H0.996094V0.996094H19.0039V9.00391H17.998V5H2.00195V17.998H12.002V19.0039ZM2.00195 4.00391H17.998V2.00195H2.00195V4.00391Z" fill="#424242"/> <path d="M7.99805 7.00195V10.9961H4.00391V7.00195H7.99805ZM7.00195 7.99805H5V10H7.00195V7.99805ZM7.99805 12.002V15.9961H4.00391V12.002H7.99805ZM7.00195 12.998H5V15H7.00195V12.998Z" fill="#424242"/> <path d="M20 10V12.5L17.002 15V20H12.998V15L10 12.5V10H20ZM19.0039 10.9961H10.9961V12.0312L14.0039 14.5312V19.0039H15.9961V14.5312L19.0039 12.0312V10.9961Z" /></svg>';

                      case actionButtonType.W.clearAllSlicers:
                        return '<svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M1.44531 12.5781L5.05859 9.0625L10.9863 14.7363L7.30469 18.3789L1.44531 12.5781Z" fill="#999999"/> <path d="M19.0723 7.25586L7.24609 19.0039L0.800781 12.6758L12.8125 0.664062L19.0723 7.25586ZM12.8125 1.8457L5.5957 9.07227L10.9375 14.1895L17.8906 7.25586L12.8125 1.8457ZM10.3516 14.7754L5 9.6582L1.98242 12.6758L7.23633 17.8809L10.3516 14.7754Z" fill="#424242"/></svg>';

                      default:
                        debug.fF.assertNever(shapeType);
                    }
                }(data.shapeType), icon = selection.select(ButtonIconSelector.selector), dimension = Math.max(Math.min(viewport.width, viewport.height) - 2 * data.padding, 0), iconContent = data.show && svgString ? svgString : null;
                if (icon.html(iconContent), iconContent) {
                    var svg = icon.select("svg").attrs({
                        width: dimension,
                        height: dimension
                    }).styles({
                        fill: "none",
                        "pointer-events": "none"
                    }), strokeWidth = (0, svgUtil.Pu)(svg.attr("viewBox"), dimension, data.lineWeight);
                    svg.selectAll("*").styles({
                        "vector-effect": "non-scaling-stroke",
                        "stroke-width": strokeWidth + "px",
                        stroke: data.lineColor,
                        "stroke-opacity": (100 - data.lineTransparency) / 100
                    }), alignElement(svg, data, viewport, dimension, dimension);
                }
            }(data.icon[stateId], viewport, selection), selection;
        }
        function alignElement(element, data, viewport, elementWidth, elementHeight) {
            element.style("position", "absolute");
            var horizontalAlign = data.horizontalAlignment;
            switch (data.padding + elementWidth / 2 > viewport.width / 2 && (horizontalAlign = horizontalPosition.D.center), 
            horizontalAlign) {
              case horizontalPosition.D.left:
                element.styles({
                    left: data.padding + "px",
                    right: null
                });
                break;
              ...
              case horizontalPosition.D.center:
                element.styles({
                    left: viewport.width / 2 - elementWidth / 2 + "px",
                    right: null
                });
            }
            var verticalAlign = data.verticalAlignment;
            switch (data.padding + elementHeight / 2 > viewport.height / 2 && (verticalAlign = verticalPosition.Q4.middle), 
            verticalAlign) {
              ...
              case verticalPosition.Q4.middle:
                element.styles({
                    top: viewport.height / 2 - elementHeight / 2 + "px",
                    bottom: null
                });
            }
        }
        function getRgbaColor(color, transparency) {
            var rgbColor = (0, VisualsCommon_color.WV)(color);
            return (0, VisualsCommon_color.U8)((0, VisualsCommon_color.b9)(rgbColor, (100 - transparency) / 100));
        }
        var strokePattern = __webpack_require__(47316), DefaultActionButtonForegroundColor = "foregroundButton", DisabledActionButtonForegroundColor = "foregroundNeutralTertiary", LightDisabledActionButtonBackgroundColor = "backgroundLight", DarkAndGrayDisabledActionButtonBackgroundColor = "backgroundNeutral", BackgroundColor = "background", DefaultButtonTextFontSizeInPt = 10, DefaultVerticalAlignment = verticalPosition.Q4.middle, InstanceIds = [ actionButton_capabilities.kx.default, actionButton_capabilities.kx.hover, actionButton_capabilities.kx.selected, actionButton_capabilities.kx.disabled ], EnumeratedInstanceIds = [ actionButton_capabilities.kx.default, actionButton_capabilities.kx.hover, actionButton_capabilities.kx.selected ], LegacyInstanceIds = [ "default", "hover", "selected", "disabled" ], LegacyEnumeratedInstanceIds = [ "default", "hover", "selected" ], ActionButton = function() {
            function ActionButton() {}
            return ActionButton.prototype.init = function(options) {
                this.currentViewport = options.viewport, this.style = options.style, this.hostServices = options.host, 
                this.element = options.element, this.featureSwitches = options.featureSwitches, 
                this.featureSwitches.buttonTileFormatting ? (this.currentViewport = options.viewport, 
                this.elementSelection = d3.select(options.element.get(0)), this.style = options.style, 
                this.buttonTile = new ButtonTile(this.hostServices)) : (this.buttonSelection = d3.select(options.element.get(0)).append("button").attr("type", "button").classed("themableBackgroundColor", !0), 
                this.buttonSelection.append("span").classed(ButtonTextSelector.class, !0), this.buttonSelection.append("div").classed(ButtonIconSelector.class, !0), 
                this.buttonSelection.append("div").classed(ButtonOutlineSelector.class, !0));
            }, ActionButton.prototype.update = function(options) {
                var _a;
                if (this.currentViewport = options.viewport, options.dataViews && options.dataViews.length > 0 && options.operationKind !== enums.su.None) {
                    var dataView = options.dataViews[0];
                    debug.fF.assertValue(dataView.metadata, "dataView.metadata");
                    var dataViewObject = dataView.metadata.objects, linkType = null === (_a = this.hostServices.getVisualLinkProperties()) || void 0 === _a ? void 0 : _a.type;
                    this.featureSwitches.buttonTileFormatting ? (this.data = ActionButton.convert(dataView, this.style, linkType, this.hostServices), 
                    this.render()) : (this.legacyData = this.legacyConverter(dataViewObject), this.legacyRender());
                }
            }, ActionButton.prototype.onViewModeChanged = function(viewMode) {
                this.featureSwitches.buttonTileFormatting || styleVisualLink(this.buttonSelection, this.hostServices);
            }, ActionButton.convert = function(dataView, style, linkType, hostServices) {
                var dataViewObject = dataView.metadata.objects, colorHelper = common_colorHelper.v.create(style), iconDefaults = this.getIconDefaults(style, linkType), iconProps = (0, 
                tileLibraryConverter.AG)(dataViewObject, colorHelper, InstanceIds, iconDefaults), outlineDefaults = this.getOutlineDefaults(style, iconProps.default.shapeType, linkType), textDefaults = this.getTextDefaults(style, colorHelper, iconProps.default.shapeType, linkType, hostServices), rotationProps = this.convertRotation(dataViewObject), convertedText = (0, 
                tileLibraryConverter.s8)(dataView, colorHelper, InstanceIds, textDefaults, this.textProps, {
                    default: {
                        rotation: rotationProps.rotation + rotationProps.textRotation
                    }
                });
                return {
                    tileProps: {
                        fill: (0, tileLibraryConverter.P_)(dataView, colorHelper, InstanceIds, this.getFillDefaults(style)),
                        outline: (0, tileLibraryConverter.P8)(dataView, colorHelper, InstanceIds, outlineDefaults),
                        shape: (0, tileLibraryConverter.nD)(dataView, InstanceIds, this.getShapeDefaults(), void 0, {
                            rotation: rotationProps.rotation + rotationProps.shapeRotation
                        }),
                        shadow: (0, tileLibraryConverter.t9)(dataView, colorHelper, InstanceIds, this.getShadowDefaults(style)),
                        glow: (0, tileLibraryConverter.EI)(dataView, colorHelper, InstanceIds, this.getGlowDefaults(style))
                    },
                    contentProps: {
                        text: convertedText,
                        icon: iconProps
            ...
            }, ActionButton.convertRotation = function(dataViewObject) {
                return (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, this.getRotationDefaults()), (0, 
                tileLibraryConverter.Yb)(dataViewObject, this.rotationProps.props));
            }, ActionButton.getRotationDefaults = function() {
                return {
                    rotation: 0,
                    shapeRotation: 0,
                    textRotation: 0
                };
            }, ActionButton.prototype.legacyConverter = function(dataViewObject) {
                var colorHelper = common_colorHelper.v.create(this.style), iconSettings = this.convertButtonIcon(dataViewObject, colorHelper);
                return {
                    icon: iconSettings,
                    text: this.convertButtonText(dataViewObject, colorHelper, iconSettings.default.shapeType),
                    outline: this.convertButtonOutline(dataViewObject, colorHelper, iconSettings.default.shapeType),
                    fill: this.convertButtonFill(dataViewObject, colorHelper)
                };
            }, ActionButton.prototype.convertButtonText = function(dataViewObject, colorHelper, iconType) {
                for (var defaultButtonText = this.getLegacyDefaultButtonTextData(iconType, this.style), buttonText = {
                    default: null,
                    hover: null,
                    active: null,
                    disabled: null
                }, show = (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.text.show, defaultButtonText.show), userDefinedObjects = (0, 
                dataViewObject2.AO)(dataViewObject, "text"), defaultFontProperties = (0, fontProperties.Zi)((0, 
                dataViewObject2.RK)(userDefinedObjects, "default"), {
                    color: "fontColor",
                    family: "fontFamily",
                    size: "fontSize"
                }, colorHelper, this.style, void 0, "lightLabel", defaultButtonText.fontProperties), _i = 0, LegacyInstanceIds_1 = LegacyInstanceIds; _i < LegacyInstanceIds_1.length; _i++) {
                    var instanceId = LegacyInstanceIds_1[_i], textFontProperties = defaultFontProperties;
                    "default" !== instanceId && (textFontProperties = (0, fontProperties.XH)((0, dataViewObject2.RK)(userDefinedObjects, instanceId), {
                        color: "fontColor",
                        family: "fontFamily",
                        size: "fontSize"
                    }, colorHelper, void 0, defaultFontProperties)), buttonText[instanceId] = {
                        show,
                        text: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.text.text, this.getDefaultStateValue(buttonText, function(x) {
                            return x.text;
                        }, defaultButtonText), instanceId),
                        padding: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.text.padding, this.getDefaultStateValue(buttonText, function(x) {
                            return x.padding;
                        }, defaultButtonText), instanceId),
                        verticalAlignment: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.text.verticalAlignment, this.getDefaultStateValue(buttonText, function(x) {
                            return x.verticalAlignment;
                        }, defaultButtonText), instanceId),
                        horizontalAlignment: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.text.horizontalAlignment, this.getDefaultStateValue(buttonText, function(x) {
                            return x.horizontalAlignment;
                        }, defaultButtonText), instanceId),
                        fontProperties: {
                            color: "disabled" !== instanceId || colorHelper.getColorForProperty(dataViewObject, actionButton_capabilities.B9.text.fontColor, void 0, instanceId) ? textFontProperties.color : common_colorHelper.v.getThemeColor(this.style, DisabledActionButtonForegroundColor),
                            size: textFontProperties.size,
                            family: textFontProperties.family
                        }
                    };
                }
                return buttonText;
            }, ActionButton.prototype.convertButtonIcon = function(dataViewObject, colorHelper) {
                for (var _this = this, defaultButtonIcon = this.getLegacyDefaultButtonIconData(this.style), buttonIcon = {
                    default: null,
                    hover: null,
                    active: null,
                    disabled: null
                }, show = (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.icon.show, defaultButtonIcon.show), _i = 0, LegacyInstanceIds_2 = LegacyInstanceIds; _i < LegacyInstanceIds_2.length; _i++) {
                    var instanceId = LegacyInstanceIds_2[_i];
                    buttonIcon[instanceId] = {
                        show,
                        shapeType: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.icon.shapeType, this.getDefaultStateValue(buttonIcon, function(x) {
                            return x.shapeType;
                        }, defaultButtonIcon), instanceId),
                        padding: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.icon.padding, this.getDefaultStateValue(buttonIcon, function(x) {
                            return x.padding;
                        }, defaultButtonIcon), instanceId),
                        verticalAlignment: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.icon.verticalAlignment, this.getDefaultStateValue(buttonIcon, function(x) {
                            return x.verticalAlignment;
                        }, defaultButtonIcon), instanceId),
                        horizontalAlignment: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.icon.horizontalAlignment, this.getDefaultStateValue(buttonIcon, function(x) {
                            return x.horizontalAlignment;
                        }, defaultButtonIcon), instanceId),
                        lineColor: this.getDefaultStateColorIfValueIsNull(colorHelper.getColorForProperty(dataViewObject, actionButton_capabilities.B9.icon.lineColor, void 0, instanceId), buttonIcon, function(x) {
                            return x.lineColor;
                        }, function() {
                            return common_colorHelper.v.getThemeColor(_this.style, DefaultActionButtonForegroundColor);
                        }, "disabled" !== instanceId ? void 0 : common_colorHelper.v.getThemeColor(this.style, DisabledActionButtonForegroundColor)),
                        lineTransparency: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.icon.lineTransparency, this.getDefaultStateValue(buttonIcon, function(x) {
                            return x.lineTransparency;
                        }, defaultButtonIcon), instanceId),
                        lineWeight: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.icon.lineWeight, this.getDefaultStateValue(buttonIcon, function(x) {
                            return x.lineWeight;
                        }, defaultButtonIcon), instanceId)
                    };
                }
                return buttonIcon;
            }, ActionButton.prototype.convertButtonOutline = function(dataViewObject, colorHelper, iconType) {
                for (var _this = this, defaultButtonOutline = this.getLegacyDefaultButtonOutlineData(iconType, this.style), buttonOutline = {
                    default: null,
                    hover: null,
                    active: null,
                    disabled: null
                }, show = (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.outline.show, defaultButtonOutline.show), _i = 0, LegacyInstanceIds_3 = LegacyInstanceIds; _i < LegacyInstanceIds_3.length; _i++) {
                    var instanceId = LegacyInstanceIds_3[_i];
                    buttonOutline[instanceId] = {
                        show,
                        outlineColor: this.getDefaultStateColorIfValueIsNull(colorHelper.getColorForProperty(dataViewObject, actionButton_capabilities.B9.outline.lineColor, void 0, instanceId), buttonOutline, function(x) {
                            return x.outlineColor;
                        }, function() {
                            return common_colorHelper.v.getThemeColor(_this.style, DefaultActionButtonForegroundColor);
                        }, "disabled" !== instanceId ? void 0 : ActionButton.getBackgroundDisabledColor(this.style)),
                        outlineTransparency: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.outline.transparency, this.getDefaultStateValue(buttonOutline, function(x) {
                            return x.outlineTransparency;
                        }, defaultButtonOutline), instanceId),
                        outlineWeight: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.outline.weight, this.getDefaultStateValue(buttonOutline, function(x) {
                            return x.outlineWeight;
                        }, defaultButtonOutline), instanceId),
                        roundEdge: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.outline.roundEdge, this.getDefaultStateValue(buttonOutline, function(x) {
                            return x.roundEdge;
                        }, defaultButtonOutline), instanceId)
                    };
                }
                return buttonOutline;
            }, ActionButton.prototype.convertButtonFill = function(dataViewObject, colorHelper) {
                for (var _this = this, defaultButtonFill = this.getLegacyDefaultButtonFillData(this.style), buttonFill = {
                    default: null,
                    hover: null,
                    active: null,
                    disabled: null
                }, show = (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.fill.show, defaultButtonFill.show), _i = 0, LegacyInstanceIds_4 = LegacyInstanceIds; _i < LegacyInstanceIds_4.length; _i++) {
                    var instanceId = LegacyInstanceIds_4[_i];
                    buttonFill[instanceId] = {
                        show: "disabled" === instanceId || show,
                        fillColor: this.getDefaultStateColorIfValueIsNull(colorHelper.getColorForProperty(dataViewObject, actionButton_capabilities.B9.fill.fillColor, void 0, instanceId), buttonFill, function(x) {
                            return x.fillColor;
                        }, function() {
                            return common_colorHelper.v.getThemeColor(_this.style, VisualsCommon_colorHelper.U);
                        }, "disabled" !== instanceId ? void 0 : ActionButton.getBackgroundDisabledColor(this.style)),
                        fillTransparency: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.fill.transparency, this.getDefaultStateValue(buttonFill, function(x) {
                            return x.fillTransparency;
                        }, defaultButtonFill, "disabled" !== instanceId ? void 0 : 0), instanceId),
                        image: (0, dataViewObject2.NA)(dataViewObject, actionButton_capabilities.B9.fill.image, this.getDefaultStateValue(buttonFill, function(x) {
                            return x.image;
                        }, defaultButtonFill), instanceId)
                    };
                }
                return buttonFill;
            }, ActionButton.prototype.getDefaultStateValue = function(states, fn, defaultState, defaultOverride) {
                return void 0 !== defaultOverride ? defaultOverride : fn(states.default ? states.default : defaultState);
            }, ActionButton.prototype.getDefaultStateColorIfValueIsNull = function(value, states, fn, defaultFn, defaultOverride) {
                return value || (void 0 !== defaultOverride ? defaultOverride : states.default ? fn(states.default) : defaultFn());
            }, ActionButton.getFillDefaults = function(style) {
                return {
                    default: {
                        show: !1,
                        fillColor: common_colorHelper.v.getThemeColor(style, VisualsCommon_colorHelper.U),
                        fillTransparency: 50,
                        fillImage: void 0,
                        fillImageTransparency: 0,
                        fillImageSplitTransparency: !1
                    },
                    disabled: {
                        show: !0,
                        fillColor: ActionButton.getBackgroundDisabledColor(style),
                        fillTransparency: 0
                    }
                };
            }, ActionButton.getOutlineDefaults = function(style, iconType, linkType) {
                var isApplyOrClearAllSlicerButton = "ApplyAllSlicers" === linkType || "ClearAllSlicers" === linkType, defaultOutline = {
                    default: {
                        strokeShow: !(iconType !== actionButtonType.W.blank && !isApplyOrClearAllSlicerButton),
                        strokeColor: common_colorHelper.v.getThemeColor(style, DefaultActionButtonForegroundColor),
                        strokeWidth: 3,
                        strokeTransparency: 0,
                        strokePattern: strokePattern.kY.solid
                    },
                    disabled: {
                        strokeColor: ActionButton.getBackgroundDisabledColor(style)
                    }
                };
                return isApplyOrClearAllSlicerButton ? (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, defaultOutline), {
                    hover: {
                        strokeShow: !0
                    },
                    selected: {
            ...
            }, ActionButton.getShapeDefaults = function() {
                return {
                    default: {
                        tileShape: shapeType.m.Rectangle,
                        rotation: 0,
                        shapeRounding: 0,
                        linecapType: linecapType.C.Flat,
                        arrowheadSize: 50,
                        arrowStemWidth: 25,
                        chevronAngle: 90,
            ...
            }, ActionButton.getShadowDefaults = function(style) {
                return {
                    default: {
                        show: !1,
                        shadowColor: style ? style.colorPalette.foreground.value : "#000",
            ...
            }, ActionButton.getGlowDefaults = function(style) {
                return {
                    default: {
                        show: !1,
                        glowColor: common_colorHelper.v.getDataColorByIndex(style, 0, VisualsCommon_colorHelper.fA),
                        glowTransparency: 0,
                        glowBlur: 40,
            ...
            }, ActionButton.getTextValue = function(linkType, services) {
                return "ApplyAllSlicers" === linkType ? services.getLocalizedString("ReportAppBar_ApplyAllSlicers") : "ClearAllSlicers" === linkType ? services.getLocalizedString("ReportAppBar_ClearAllSlicers") : "";
            }, ActionButton.getTextDefaults = function(style, colorHelper, iconType, linkType, services) {
                return {
                    default: {
                        show: !("ApplyAllSlicers" !== linkType && "ClearAllSlicers" !== linkType),
                        text: this.getTextValue(linkType, services),
                        verticalAlignment: DefaultVerticalAlignment,
                        horizontalAlignment: iconType === actionButtonType.W.blank ? horizontalPosition.D.center : horizontalPosition.D.right,
                        rightMargin: 4,
                        leftMargin: 4,
                        topMargin: 4,
                        bottomMargin: 4,
                        rotation: 0,
                        fontProperties: (0, fontProperties.Zi)(null, {
                            color: actionButton_capabilities.aH.fontColor,
                            size: actionButton_capabilities.aH.fontSize,
                            family: actionButton_capabilities.aH.fontFamily
                        }, colorHelper, style, void 0, "lightLabel", {
                            color: common_colorHelper.v.getThemeColor(style, DefaultActionButtonForegroundColor),
                            size: units.B.createFromPt(DefaultButtonTextFontSizeInPt),
                            family: fontUtils.Wn.regular.css
                        })
                    },
                    disabled: {
                        fontProperties: {
                            color: common_colorHelper.v.getThemeColor(style, DisabledActionButtonForegroundColor)
                        }
                    }
                };
            }, ActionButton.getIconDefaults = function(style, linkType) {
                return {
                    default: {
                        show: !("ApplyAllSlicers" === linkType || "ClearAllSlicers" === linkType),
                        shapeType: actionButtonType.W.blank,
                        iconImage: void 0,
                        lineColor: common_colorHelper.v.getThemeColor(style, DefaultActionButtonForegroundColor),
                        lineTransparency: 0,
                        lineWeight: 3,
                        placement: iconPlacementType.PG,
                        verticalAlignment: DefaultVerticalAlignment,
                    ...
                    disabled: {
                        lineColor: common_colorHelper.v.getThemeColor(style, DisabledActionButtonForegroundColor)
                    }
                };
            }, ActionButton.prototype.getLegacyDefaultButtonTextData = function(iconType, style) {
                return {
                    show: !1,
                    text: "",
                    padding: 4,
            ...
            }, ActionButton.prototype.getLegacyDefaultButtonIconData = function(style) {
                return {
                    show: !0,
                    shapeType: actionButtonType.W.blank,
                    padding: 4,
            ...
            }, ActionButton.prototype.getLegacyDefaultButtonOutlineData = function(iconType, style) {
                return {
                    show: iconType === actionButtonType.W.blank,
                    outlineColor: common_colorHelper.v.getThemeColor(style, DefaultActionButtonForegroundColor),
                    outlineTransparency: 0,
                    outlineWeight: 3,
                    roundEdge: 0
                };
            }, ActionButton.prototype.getLegacyDefaultButtonFillData = function(style) {
                return {
                    show: !1,
                    fillColor: common_colorHelper.v.getThemeColor(style, VisualsCommon_colorHelper.U),
                    fillTransparency: 50,
            ...
            }, ActionButton.getBackgroundDisabledColor = function(style) {
                var backgroundColor = common_colorHelper.v.getThemeColor(style, BackgroundColor);
                return common_colorHelper.v.getThemeColor(style, "#FFF" === backgroundColor || "#FFFFFF" === backgroundColor ? LightDisabledActionButtonBackgroundColor : DarkAndGrayDisabledActionButtonBackgroundColor);
            }, ActionButton.prototype.enumerateObjectInstances = function(options) {
                return this.featureSwitches.buttonTileFormatting ? this.enumerator(options) : this.legacyEnumerator(options);
            }, ActionButton.prototype.getFormattingModel = function() {
                var _a, _this = this, onObject = null === (_a = this.featureSwitches) || void 0 === _a ? void 0 : _a.onObject;
                return new build_control_util.Nq(function() {
                    return !onObject && _this.getShapeCard();
                }, function() {
                    return onObject && _this.getButtonStyleCard();
                }, function() {
                    return _this.getRotationCard();
                }, function() {
                    return !onObject && _this.getStyleCard();
                }, function() {
                    return _this.getVisualLinkPlaceholder();
                }).build();
            }, ActionButton.prototype.getContainerName = function(instance) {
                switch (instance) {
                  case actionButton_capabilities.kx.default:
                    instance = "Default";
                    break;

                  case actionButton_capabilities.kx.hover:
                    instance = "Hover";
                    break;

                  case actionButton_capabilities.kx.selected:
                    instance = "Press";
                    break;

                  case actionButton_capabilities.kx.disabled:
                    instance = "Disabled";
                }
                return this.hostServices.getLocalizedString(instance);
            }, ActionButton.prototype.getDisplayedInstanceIds = function() {
                var _a;
                return "ClearAllSlicers" === (null === (_a = this.hostServices.getVisualLinkProperties()) || void 0 === _a ? void 0 : _a.type) ? EnumeratedInstanceIds : this.featureSwitches.drillthroughButtonGA ? InstanceIds : EnumeratedInstanceIds;
            }, ActionButton.prototype.getShapeCard = function() {
                var _this = this, shapeProps = actionButton_capabilities.k6.shape, cardUidBuilder = new build_control_util.lg("shape"), displayedInstanceIds = this.getDisplayedInstanceIds();
                return new build_control_util.CQ(cardUidBuilder, "Visual_Shape", [ shapeProps.tileShape, shapeProps.roundEdge, shape_capabilities.WO.shape.linecapType, shapeProps.arrowheadSize, shapeProps.arrowStemWidth, shapeProps.chevronAngle, shapeProps.isocelesTriangleTipPosition, shapeProps.parallelogramSlant, shapeProps.trapezoidSlant, shapeProps.hexagonSlant, shapeProps.octagonSnipSize, shapeProps.speechBubbleHeight, shapeProps.speechBubbleTailPosition, shapeProps.speechBubbleTailAngle, shapeProps.rectangleRoundedCurve, shapeProps.tabCutCornerSnipSizeTopRight, shapeProps.tabCutCornerSnipSizeTop, shapeProps.tabCutCornerSnipSizeBottom, shapeProps.tabRoundCornerTopRight, shapeProps.tabRoundCornerTop, shapeProps.tabRoundCornerBottom ], function(key) {
                    ...
                    groupBuilder.withDisplayName("Apply_Settings_To").withCollapsible(!1).addContainer("state", function(containerBuilder) {
                        containerBuilder.withDisplayName("State"), displayedInstanceIds.forEach(function(instanceId) {
                            var _a, groups = [], shapeGroupByInstance = (0, tileLibraryEnumerationHelper.jf)(_this.data.tileProps.shape, _this.hostServices, _this.featureSwitches, instanceId, cardUidBuilder, ((_a = {})[shapeType.m.Line] = !0, 
                            _a[shapeType.m.RectangleRoundedByPixel] = !0, _a[shapeType.m.TabCutTopCornersByPixel] = !0, 
                            _a));
                            groups.push(shapeGroupByInstance), containerBuilder.addContainerItem(instanceId, _this.getContainerName(instanceId), function(containerItemBuilder) {
                                return containerItemBuilder.withGroups(groups);
                            });
                        });
                    });
                }).build();
            }, ActionButton.prototype.getButtonStyleCard = function() {
                var _this = this, shapeProps = actionButton_capabilities.k6.shape, fillProps = actionButton_capabilities.k6.fill, outlineProps = actionButton_capabilities.k6.outline, textProps = actionButton_capabilities.k6.text, iconProps = actionButton_capabilities.k6.icon, shadowProps = actionButton_capabilities.k6.shadow, glowProps = actionButton_capabilities.k6.glow, cardUidBuilder = new build_control_util.lg("buttonStyle"), displayedInstanceIds = this.getDisplayedInstanceIds();
                return new build_control_util.CQ(cardUidBuilder, "Visual_ButtonStyle", [ shapeProps.tileShape, shapeProps.roundEdge, shape_capabilities.WO.shape.linecapType, shapeProps.arrowheadSize, shapeProps.arrowStemWidth, shapeProps.chevronAngle, shapeProps.isocelesTriangleTipPosition, shapeProps.parallelogramSlant, shapeProps.trapezoidSlant, shapeProps.hexagonSlant, shapeProps.octagonSnipSize, shapeProps.speechBubbleHeight, shapeProps.speechBubbleTailPosition, shapeProps.speechBubbleTailAngle, shapeProps.rectangleRoundedCurve, shapeProps.tabCutCornerSnipSizeTopRight, shapeProps.tabCutCornerSnipSizeTop, shapeProps.tabCutCornerSnipSizeBottom, shapeProps.tabRoundCornerTopRight, shapeProps.tabRoundCornerTop, shapeProps.tabRoundCornerBottom, fillProps.show, fillProps.fillColor, fillProps.transparency, fillProps.image, outlineProps.show, outlineProps.lineColor, outlineProps.weight, outlineProps.transparency, textProps.show, textProps.fontColor, textProps.fontSize, textProps.fontFamily, textProps.italic, textProps.bold, textProps.underline, textProps.text, textProps.verticalAlignment, textProps.horizontalAlignment, textProps.leftMargin, textProps.rightMargin, textProps.topMargin, textProps.bottomMargin, textProps.angle, iconProps.show, iconProps.shapeType, iconProps.image, iconProps.lineColor, iconProps.lineTransparency, iconProps.lineWeight, iconProps.placement, iconProps.verticalAlignment, iconProps.horizontalAlignment, iconProps.leftMargin, iconProps.rightMargin, iconProps.topMargin, iconProps.bottomMargin, iconProps.spacing, iconProps.iconSize, shadowProps.show, shadowProps.color, shadowProps.transparency, shadowProps.shadowBlur, shadowProps.shadowPositionPreset, glowProps.show, glowProps.color, glowProps.transparency, glowProps.shadowBlur ], function(key) {
                    return _this.hostServices.getLocalizedString(key);
                }).addGroup("applySettingsTo", function(groupBuilder) {
                    groupBuilder.withDisplayName("Apply_Settings_To").withCollapsible(!1).addContainer("state", function(containerBuilder) {
                        containerBuilder.withDisplayName("State"), displayedInstanceIds.forEach(function(instanceId) {
                            var _a, groups = [], shapeGroupByInstance = (0, tileLibraryEnumerationHelper.jf)(_this.data.tileProps.shape, _this.hostServices, _this.featureSwitches, instanceId, cardUidBuilder, ((_a = {})[shapeType.m.Line] = !0, 
                            _a[shapeType.m.RectangleRoundedByPixel] = !1, _a[shapeType.m.TabCutTopCornersByPixel] = !1, 
                            _a));
                            groups.push(shapeGroupByInstance);
                            var styleGroupsByInstnace = _this.getStyleGroupsByInstance(instanceId, cardUidBuilder);
                            groups.push.apply(groups, styleGroupsByInstnace), containerBuilder.addContainerItem(instanceId, _this.getContainerName(instanceId), function(containerItemBuilder) {
                                return containerItemBuilder.withGroups(groups);
                            });
                        });
                    });
                }).build();
            }, ActionButton.prototype.getStyleCard = function() {
                var _this = this, fillProps = actionButton_capabilities.k6.fill, outlineProps = actionButton_capabilities.k6.outline, textProps = actionButton_capabilities.k6.text, iconProps = actionButton_capabilities.k6.icon, shadowProps = actionButton_capabilities.k6.shadow, glowProps = actionButton_capabilities.k6.glow, cardUidBuilder = new build_control_util.lg("style"), displayedInstanceIds = this.getDisplayedInstanceIds();
                return new build_control_util.CQ(cardUidBuilder, "Style", [ fillProps.show, fillProps.fillColor, fillProps.transparency, fillProps.image, outlineProps.show, outlineProps.lineColor, outlineProps.weight, outlineProps.transparency, textProps.show, textProps.fontColor, textProps.fontSize, textProps.fontFamily, textProps.italic, textProps.bold, textProps.underline, textProps.text, textProps.verticalAlignment, textProps.horizontalAlignment, textProps.leftMargin, textProps.rightMargin, textProps.topMargin, textProps.bottomMargin, textProps.angle, iconProps.show, iconProps.shapeType, iconProps.image, iconProps.lineColor, iconProps.lineTransparency, iconProps.lineWeight, iconProps.placement, iconProps.verticalAlignment, iconProps.horizontalAlignment, iconProps.leftMargin, iconProps.rightMargin, iconProps.topMargin, iconProps.bottomMargin, iconProps.spacing, iconProps.iconSize, shadowProps.show, shadowProps.color, shadowProps.transparency, shadowProps.shadowBlur, shadowProps.shadowPositionPreset, glowProps.show, glowProps.color, glowProps.transparency, glowProps.shadowBlur ], function(key) {
                    return _this.hostServices.getLocalizedString(key);
                }).addGroup("applySettingsTo", function(groupBuilder) {
                    groupBuilder.withDisplayName("Apply_Settings_To").withCollapsible(!1).addContainer("state", function(containerBuilder) {
                        containerBuilder.withDisplayName("State"), displayedInstanceIds.forEach(function(instanceId) {
                            containerBuilder.addContainerItem(instanceId, _this.getContainerName(instanceId), function(containerItemBuilder) {
                                return containerItemBuilder.withGroups(_this.getStyleGroupsByInstance(instanceId, cardUidBuilder));
                            });
                        });
                    });
                }).build();
            }, ActionButton.prototype.getVisualLinkPlaceholder = function() {
                return (0, build_control_util.UH)("actions");
            }, ActionButton.prototype.getStyleGroupsByInstance = function(instanceId, cardUidBuilder) {
                var groups = [];
                return groups.push((0, tileLibraryEnumerationHelper.oy)(this.data.contentProps.text, this.hostServices, instanceId, cardUidBuilder)), 
                groups.push((0, tileLibraryEnumerationHelper.Oj)(this.data.contentProps.icon, this.hostServices, instanceId, cardUidBuilder, this.featureSwitches)), 
                groups.push((0, tileLibraryEnumerationHelper.wH)(!0, this.data.tileProps.fill, this.hostServices, instanceId, cardUidBuilder)), 
                groups.push((0, tileLibraryEnumerationHelper.sZ)(this.data.tileProps.outline, this.hostServices, instanceId, cardUidBuilder)), 
                groups.push((0, tileLibraryEnumerationHelper.D9)(this.data.tileProps.shadow, this.hostServices, instanceId, cardUidBuilder)), 
                groups.push((0, tileLibraryEnumerationHelper.i7)(this.data.tileProps.glow, this.hostServices, instanceId, cardUidBuilder)), 
                groups;
            }, ActionButton.prototype.enumerator = function(options) {
                var _a, data = this.data;
                if (!data) return [];
                var enumeration = new objectEnumerationBuilder.G, displayedInstanceIds = this.featureSwitches.drillthroughButtonGA ? InstanceIds : EnumeratedInstanceIds;
                switch (options.objectName) {
                  case actionButton_capabilities.EK.fill:
                    (0, tileLibraryEnumerationHelper.JO)(enumeration, data.tileProps.fill, displayedInstanceIds, ActionButton.getInstanceDisplayName);
                    break;

                  case actionButton_capabilities.EK.outline:
                    (0, tileLibraryEnumerationHelper.nT)(enumeration, data.tileProps.outline, displayedInstanceIds, ActionButton.getInstanceDisplayName);
                    break;

                  case actionButton_capabilities.EK.text:
                    (0, tileLibraryEnumerationHelper.DD)(enumeration, data.contentProps.text, displayedInstanceIds, ActionButton.getInstanceDisplayName);
                    break;

                  case actionButton_capabilities.EK.icon:
                    (0, tileLibraryEnumerationHelper._u)(enumeration, data.contentProps.icon, displayedInstanceIds, ActionButton.getInstanceDisplayName);
                    break;

                  case actionButton_capabilities.EK.shape:
                    (0, tileLibraryEnumerationHelper.LY)(enumeration, data.tileProps.shape, displayedInstanceIds, ActionButton.getInstanceDisplayName, this.featureSwitches, ((_a = {})[shapeType.m.Line] = !0, 
                    _a));
                    break;

                  case actionButton_capabilities.EK.shadow:
                    (0, tileLibraryEnumerationHelper.UW)(enumeration, data.tileProps.shadow, displayedInstanceIds, ActionButton.getInstanceDisplayName);
                    break;

                  case actionButton_capabilities.EK.glow:
                    (0, tileLibraryEnumerationHelper.gQ)(enumeration, data.tileProps.glow, displayedInstanceIds, ActionButton.getInstanceDisplayName);
                    break;

                  case actionButton_capabilities.EK.rotation:
                    this.enumerateRotationProperties(enumeration, data.rotationProps);
                }
                return enumeration.complete();
            }, ActionButton.prototype.enumerateRotationProperties = function(enumeration, properties) {
                var _a, _b, validValuesForRotation = {
                    unitSymbol: visualLocKeys.g,
                    numberRange: {
                        min: 0,
                        max: 360
                    }
                }, enumerationProperties = ((_a = {})[actionButton_capabilities.aH.rotation] = properties.rotation, 
                _a[actionButton_capabilities.aH.shapeRotation] = properties.shapeRotation, _a[actionButton_capabilities.aH.textRotation] = properties.textRotation, 
                _a);
                enumeration.pushInstance({
                    objectName: actionButton_capabilities.aH.rotation,
                    selector: null,
                    properties: enumerationProperties,
                    validValues: (_b = {}, _b[actionButton_capabilities.aH.shapeRotation] = validValuesForRotation, 
                    _b[actionButton_capabilities.aH.textRotation] = validValuesForRotation, _b)
                });
            }, ActionButton.prototype.getRotationCard = function() {
                var _this = this, rotationProps = actionButton_capabilities.k6.rotation, rotationPropValues = this.data.rotationProps, localize = function(key) {
                    return _this.hostServices.getLocalizedString(key);
                };
                return new build_control_util.CQ(new build_control_util.lg("rotation"), "Visual_BasicShape_Rotate", [ rotationProps.angle, rotationProps.shapeAngle, rotationProps.textAngle ], localize).addGroup("default", function(groupBuilder) {
                    groupBuilder.addSimpleSlice("all", build_control_util.JN.getRotationSliderBuilder({
                        descriptor: (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, rotationProps.angle), {
                            selector: null
                        }),
                        value: rotationPropValues.rotation,
                        localize
                    }).build(), function(sliceBuilder) {
                        return sliceBuilder.withCustomDisplayName("All");
                    }).addSimpleSlice("shape", build_control_util.JN.getRotationSliderBuilder({
                        descriptor: (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, rotationProps.shapeAngle), {
                            selector: null
                        }),
                        value: rotationPropValues.shapeRotation,
                        localize
                    }).build(), function(sliceBuilder) {
                        return sliceBuilder.withCustomDisplayName("Visual_Shape");
                    }).addSimpleSlice("text", build_control_util.JN.getRotationSliderBuilder({
                        descriptor: (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, rotationProps.textAngle), {
                            selector: null
                        }),
                        value: rotationPropValues.textRotation,
                        localize
                    }).build(), function(sliceBuilder) {
                        return sliceBuilder.withCustomDisplayName("Text");
                    });
                }).build();
            }, ActionButton.getInstanceDisplayName = function(tileInstanceId) {
                return tileInstanceId === actionButton_capabilities.kx.default ? (0, displayNameGetter.V)("DefaultState") : tileInstanceId === actionButton_capabilities.kx.hover ? (0, 
                displayNameGetter.V)("Hover") : tileInstanceId === actionButton_capabilities.kx.selected ? (0, 
                displayNameGetter.V)("Press") : tileInstanceId === actionButton_capabilities.kx.disabled ? (0, 
                displayNameGetter.V)("Disabled") : void debug.fF.assertNever(tileInstanceId);
            }, ActionButton.prototype.legacyEnumerator = function(options) {
                var data = this.legacyData;
                if (!data) return [];
                var buttonStateId, validNumberRangeForPadding = {
                    unitSymbol: visualLocKeys.e_,
                    numberRange: {
                        min: 0,
                        max: 999
                    }
                }, enumeration = new objectEnumerationBuilder.G;
                switch (options.objectName) {
                  case "text":
                    enumeration.pushInstance({
                        objectName: "text",
                  ...
                  case "outline":
                    enumeration.pushInstance({
                        ...
                        selector: null,
                        properties: {
                            show: data.outline.default.show
                        }
                    });
                    break;
                  ...
                  case "fill":
                    enumeration.pushInstance({
                        ...
                        selector: null,
                        properties: {
                            show: data.fill.default.show
                        }
                    });
                }
                for (var _i = 0, displayedInstanceIds_1 = this.featureSwitches.drillthroughButtonGA ? LegacyInstanceIds : LegacyEnumeratedInstanceIds; _i < displayedInstanceIds_1.length; _i++) {
                    var instanceId = displayedInstanceIds_1[_i];
                    switch (enumeration.pushContainer({
                        displayName: (buttonStateId = instanceId, "default" === buttonStateId ? (0, displayNameGetter.V)("DefaultState") : "hover" === buttonStateId ? (0, 
                        displayNameGetter.V)("Hover") : "selected" === buttonStateId ? (0, displayNameGetter.V)("Press") : "disabled" === buttonStateId ? (0, 
                        displayNameGetter.V)("Disabled") : void debug.fF.assertNever(buttonStateId))
                    }), options.objectName) {
                      case "text":
                        var textState = data.text[instanceId];
                        enumeration.pushInstance({
                            objectName: "text",
                            selector: {
                                id: instanceId
                            ...
                            properties: {
                                text: textState.text,
                                fontColor: textState.fontProperties.color,
                                padding: textState.padding,
                                verticalAlignment: textState.verticalAlignment,
                                horizontalAlignment: textState.horizontalAlignment,
                                fontSize: textState.fontProperties.size.pt,
                                fontFamily: textState.fontProperties.family
                            },
                            validValues: {
                                padding: validNumberRangeForPadding
                            },
                      ...
                      case "icon":
                        var iconState = data.icon[instanceId];
                        enumeration.pushInstance({
                            objectName: "icon",
                            selector: {
                                id: instanceId
                            ...
                            properties: {
                                shapeType: iconState.shapeType,
                                padding: iconState.padding,
                                verticalAlignment: iconState.verticalAlignment,
                                horizontalAlignment: iconState.horizontalAlignment,
                                lineColor: iconState.lineColor,
                                lineTransparency: iconState.lineTransparency,
                                lineWeight: iconState.lineWeight
                            },
                            validValues: {
                                padding: validNumberRangeForPadding,
                                lineWeight: {
                                    unitSymbol: visualLocKeys.tQ,
                                    numberRange: {
                                        min: 0,
                                        max: 50
                                    }
                      ...
                      case "outline":
                        var outlineState = data.outline[instanceId];
                        enumeration.pushInstance({
                            objectName: "outline",
                            selector: {
                                id: instanceId
                            ...
                            properties: {
                                lineColor: outlineState.outlineColor,
                                transparency: outlineState.outlineTransparency,
                                weight: outlineState.outlineWeight,
                                roundEdge: outlineState.roundEdge
                            },
                            validValues: {
                                roundEdge: {
                                    unitSymbol: visualLocKeys.e_,
                      ...
                      case "fill":
                        var fillState = data.fill[instanceId], visualObjectInstance = {
                            objectName: "fill",
                            selector: {
                                id: instanceId
                            },
                            properties: {
                                fillColor: fillState.fillColor,
                                transparency: fillState.fillTransparency
                            },
                            propertyInstanceKind: {
                                fillColor: 3
                            }
                        };
                        this.featureSwitches.drillthroughButtonGA && (visualObjectInstance.properties.image = fillState.image), 
                ...
                this.buttonTile.contentProperties = this.data.contentProps, this.buttonTile.update({
                    element: this.elementSelection,
                    properties: this.data.tileProps,
                    width: this.currentViewport.width,
                    height: this.currentViewport.height
                });
            }, ActionButton.prototype.legacyRender = function() {
                !function(data, viewport, selection, host, element) {
                    (0, tslib_es6.__awaiter)(this, void 0, void 0, function() {
                        var isEnabled;
                        return (0, tslib_es6.__generator)(this, function(_a) {
                            switch (_a.label) {
                              case 0:
                                return [ 4, host.isVisualEnabled() ];

                              case 1:
                                return isEnabled = _a.sent(), selection.on("click", function() {
                                    var selectingArgs = {
                                        type: 0,
                                        visualObjects: [ {
                                            objectName: "button",
                                        ...
                                        isCtrlOrMetaKey: browserUtils.M.isCtrlOrMeta(d3.event),
                                        position: (0, interactivityUtils.bt)()
                                    };
                                    host.onSelecting(selectingArgs), 1 === selectingArgs.action && d3.event.stopPropagation();
                                }), isEnabled ? (selection.on("pointerover", function() {
                                    styleButton(data, "hover", viewport, selection, element);
                                }).on("pointerdown", function() {
                                    styleButton(data, "selected", viewport, selection, element);
                                }).on("pointerup", function() {
                                    styleButton(data, "hover", viewport, selection, element);
                                }).on("pointerleave", function() {
                                    styleButton(data, "default", viewport, selection, element);
                                }), styleButton(data, "default", viewport, selection, element)) : (selection.on("pointerover", null).on("pointerdown", null).on("pointerup", null).on("pointerleave", null), 
                                styleButton(data, "disabled", viewport, selection, element)), styleVisualLink(selection, host), 
                                [ 2 ];
                            }
                        });
                    });
                }(this.legacyData, this.currentViewport, this.buttonSelection, this.hostServices, this.element);
            }, ActionButton.rotationProps = {
                props: {
                    rotation: actionButton_capabilities.k6.rotation.angle,
                    shapeRotation: actionButton_capabilities.k6.rotation.shapeAngle,
                    textRotation: actionButton_capabilities.k6.rotation.textAngle
                }
            }, ActionButton.textProps = {
                props: {
                    text: actionButton_capabilities.k6.text.text,
                    verticalAlignment: actionButton_capabilities.k6.text.verticalAlignment,
                    horizontalAlignment: actionButton_capabilities.k6.text.horizontalAlignment,
                    rightMargin: actionButton_capabilities.k6.text.rightMargin,
                    leftMargin: actionButton_capabilities.k6.text.leftMargin,
                    topMargin: actionButton_capabilities.k6.text.topMargin,
                    bottomMargin: actionButton_capabilities.k6.text.bottomMargin
                },
                fontProps: {
                    fontProperties: {
                        objectName: "text",
                        propertyNames: {
                            ...
                            family: actionButton_capabilities.aH.fontFamily,
                            size: actionButton_capabilities.aH.fontSize,
                            italic: actionButton_capabilities.aH.italic,
                            bold: actionButton_capabilities.aH.bold,
                            underline: actionButton_capabilities.aH.underline
                        }
                    }
                }
            }, ActionButton;
        }(), ButtonTile = function(_super) {
            function ButtonTile(hostServices) {
                var _this = _super.call(this) || this;
                return _this.hostServices = hostServices, _this;
            }
            return (0, tslib_es6.__extends)(ButtonTile, _super), Object.defineProperty(ButtonTile.prototype, "cursor", {
                get: function() {
                    return this.hasVisualLink ? "pointer" : "inherit";
                },
                enumerable: !1,
                configurable: !0
            }), ButtonTile.prototype.beforeRender = function() {
                var _a;
                return (0, tslib_es6.__awaiter)(this, void 0, void 0, function() {
                    ...
                    return (0, tslib_es6.__generator)(this, function(_c) {
                        switch (_c.label) {
                          case 0:
                            return this.hasVisualLink = null === (_a = this.hostServices.getVisualLinkProperties()) || void 0 === _a ? void 0 : _a.hasVisualLink, 
                            _b = this, [ 4, this.hostServices.isVisualEnabled() ];

                          case 1:
                            return _b.isEnabled = _c.sent(), this.state = this.isEnabled ? actionButton_capabilities.kx.default : actionButton_capabilities.kx.disabled, 
                            [ 2 ];
                        }
                    });
                });
            }, ButtonTile.prototype.afterRender = function() {
                return (0, tslib_es6.__awaiter)(this, void 0, void 0, function() {
                    return (0, tslib_es6.__generator)(this, function(_a) {
                        return this.renderContent(), [ 2 ];
                    });
                });
            }, ButtonTile.prototype.renderContent = function() {
                var state = this.state, textProps = this.contentProperties.text[state], iconProps = this.contentProperties.icon[state], textDims = this.getContentInscribedRectangle(textProps.rotation), iconDims = this.getContentInscribedRectangle(iconProps.rotation);
                tileLibraryContent.b.renderTextIcon(this.element, (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, textProps), {
                    dimensions: textDims
                }), (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, iconProps), {
                    dimensions: iconDims
                }));
            }, ButtonTile.prototype.onTileClick = function() {
                ...
                this.hostServices.onSelecting(selectingArgs), 1 === selectingArgs.action && event.stopPropagation();
            }, ButtonTile.prototype.onTilePointerover = function() {
                this.renderWithState(actionButton_capabilities.kx.hover);
            }, ButtonTile.prototype.onTilePointerleave = function() {
                this.renderWithState(actionButton_capabilities.kx.default);
            }, ButtonTile.prototype.onTilePointerdown = function() {
                this.renderWithState(actionButton_capabilities.kx.selected);
            }, ButtonTile.prototype.onTilePointerup = function() {
                this.renderWithState(actionButton_capabilities.kx.hover);
            }, ButtonTile.prototype.renderWithState = function(state) {
                this.isEnabled && (this.state = state, this.updateShape(), this.renderWithoutLifecycleEvents(), 
                this.renderContent());
            }, ButtonTile;
        }(tileLibraryTile.n);
    },
    74868: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        __webpack_require__.d(__webpack_exports__, {
            b: function() {
                return TileLibraryContent;
            }
        });
        var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(81337), _powerbi_legacy_PowerBIVisuals_Visuals_common_fontProperties__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(18664), _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(2764), _powerbi_legacy_PowerBIVisuals_Visuals_types_horizontalPosition__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(92374), _powerbi_legacy_PowerBIVisuals_Visuals_types_iconPlacementType__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(67922), _powerbi_legacy_PowerBIVisuals_VisualsCommon_CssConstants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(79154), _powerbi_legacy_PowerBIVisuals_VisualsCommon_debug__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(62458), _powerbi_legacy_PowerBIVisuals_VisualsCommon_services_textMeasurementService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(32041), _powerbi_legacy_PowerBIVisuals_VisualsCommon_Utility_Utility__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(38078), _powerbi_legacy_PowerBIVisuals_VisualsCommon_Utility_wordBreaker__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(66001), ContentOuterContainerSelector = (0, 
        _powerbi_legacy_PowerBIVisuals_VisualsCommon_CssConstants__WEBPACK_IMPORTED_MODULE_0__.CH)("contentOuterContainer"), ContentTableSelector = (0, 
        _powerbi_legacy_PowerBIVisuals_VisualsCommon_CssConstants__WEBPACK_IMPORTED_MODULE_0__.CH)("contentTable"), ContentTableCellSelector = (0, 
        _powerbi_legacy_PowerBIVisuals_VisualsCommon_CssConstants__WEBPACK_IMPORTED_MODULE_0__.CH)("contentTableCell"), ContentContainerSelector = (0, 
        _powerbi_legacy_PowerBIVisuals_VisualsCommon_CssConstants__WEBPACK_IMPORTED_MODULE_0__.CH)("contentContainer"), ContentSelector = (0, 
        _powerbi_legacy_PowerBIVisuals_VisualsCommon_CssConstants__WEBPACK_IMPORTED_MODULE_0__.CH)("content"), TextSelector = (0, 
        _powerbi_legacy_PowerBIVisuals_VisualsCommon_CssConstants__WEBPACK_IMPORTED_MODULE_0__.CH)("text"), ButtonTextSelector = (0, 
        _powerbi_legacy_PowerBIVisuals_VisualsCommon_CssConstants__WEBPACK_IMPORTED_MODULE_0__.CH)("ui-role-button-text"), IconSelector = (0, 
        _powerbi_legacy_PowerBIVisuals_VisualsCommon_CssConstants__WEBPACK_IMPORTED_MODULE_0__.CH)("icon"), IconImageGroupSelector = (0, 
        _powerbi_legacy_PowerBIVisuals_VisualsCommon_CssConstants__WEBPACK_IMPORTED_MODULE_0__.CH)("iconImageGroup"), IconPathGroupSelector = (0, 
        _powerbi_legacy_PowerBIVisuals_VisualsCommon_CssConstants__WEBPACK_IMPORTED_MODULE_0__.CH)("iconPathGroup"), SelectedSelector = (0, 
        _powerbi_legacy_PowerBIVisuals_VisualsCommon_CssConstants__WEBPACK_IMPORTED_MODULE_0__.CH)("selected"), TileLibraryContent = function() {
            function TileLibraryContent() {}
            return TileLibraryContent.renderText = function(element, textProps, isSelected) {
                void 0 === isSelected && (isSelected = !1), renderContent(element, textProps.show ? [ {
                    main: {
                        type: "text",
                        props: textProps
                    }
                } ] : [], isSelected);
            }, TileLibraryContent.renderTextIcon = function(element, textProps, iconProps) {
                var textContent = {
                    type: "text",
                    props: textProps
                }, iconContent = {
                ...
                renderContent(element, textProps.show || iconProps.show ? textProps.show && !iconProps.show ? [ {
                    main: textContent
                } ] : iconProps.show && !textProps.show ? [ {
                    main: iconContent
                } ] : iconProps.placement === _powerbi_legacy_PowerBIVisuals_Visuals_types_iconPlacementType__WEBPACK_IMPORTED_MODULE_1__.PG ? [ {
                    main: textContent
                }, {
                    main: iconContent
                } ] : [ {
                    main: textContent,
                    follower: iconContent
                } ] : [], !1);
            }, TileLibraryContent;
        }();
        function renderContent(element, contents, isSelected) {
            element.selectAll(ContentOuterContainerSelector.selector).data(contents).join(function(enter) {
                return function(element, isSelected) {
                    var contentOuterContainer = element.append("xhtml:div").classed(ContentOuterContainerSelector.class, !0).styles({
                        "pointer-events": "none",
                        position: "absolute",
                        height: "100%",
                        width: "100%",
                    ...
                    return contentOuterContainer.append("xhtml:div").classed(ContentTableSelector.class, !0).styles({
                        height: "100%",
                        width: "100%",
                        display: "table",
                        "table-layout": "fixed"
                    }).append("xhtml:div").classed(ContentTableCellSelector.class, !0).style("display", "table-cell").append("xhtml:div").classed(ContentContainerSelector.class, !0).styles({
                        position: "relative",
                        display: "flex",
                        "align-items": "center",
                        fill: "none",
                    ...
                    }), updateContents(contentOuterContainer, isSelected), contentOuterContainer;
                }(enter, isSelected);
            }, function(update) {
                return updateContents(update, isSelected);
            });
        }
        function updateContents(contentOuterContainers, isSelected) {
            return contentOuterContainers.each(function(contents) {
                var contentOuterContainer = d3.select(this), main = contents.main;
                contentOuterContainer.styles({
                    left: "".concat(main.props.dimensions.left, "px"),
                    top: "".concat(main.props.dimensions.top, "px"),
                    width: "".concat(main.props.dimensions.width, "px"),
                    height: "".concat(main.props.dimensions.height, "px"),
                    transform: "rotate(".concat(main.props.rotation, "deg)")
                });
                var contentContainer = contentOuterContainer.select(ContentTableCellSelector.selector).styles({
                    "vertical-align": main.props.verticalAlignment
                }).select(ContentContainerSelector.selector).styles({
                    "justify-content": main.props.horizontalAlignment === _powerbi_legacy_PowerBIVisuals_Visuals_types_horizontalPosition__WEBPACK_IMPORTED_MODULE_2__.D.center ? "center" : null,
                    padding: "".concat(main.props.topMargin, "px ").concat(main.props.rightMargin, "px ").concat(main.props.bottomMargin, "px ").concat(main.props.leftMargin, "px"),
                    "flex-direction": getFollowerFlexDirection(contents.follower ? contents.follower.props : null),
                    float: main.props.horizontalAlignment === _powerbi_legacy_PowerBIVisuals_Visuals_types_horizontalPosition__WEBPACK_IMPORTED_MODULE_2__.D.center ? null : main.props.horizontalAlignment
                }), _a = _.reduce(contents, function(obj, props) {
                    switch (props.type) {
                      case "text":
                        obj.textContents.push(props);
                        break;

                      case "icon":
                        obj.iconContents.push(props);
                        break;

                      default:
                        _powerbi_legacy_PowerBIVisuals_VisualsCommon_debug__WEBPACK_IMPORTED_MODULE_3__.fF.assertNever(props.type);
                    }
                    return obj;
                }, {
                    textContents: [],
                    iconContents: []
                }), textContents = _a.textContents, iconContents = _a.iconContents;
                contentContainer.selectAll(TextSelector.selector).data(textContents, function(d) {
                    return d.props.text;
                }).join(function(enter) {
                    return function(element, isSelected, width, height) {
                        var text = element.append("div").classed(ContentSelector.class, !0).classed(TextSelector.class, !0).classed(ButtonTextSelector.class, !0).styles({
                            width: "100%"
                        });
                        return updateText(text, isSelected, width, height), text;
                    }(enter, isSelected, main.props.dimensions.width - (main.props.leftMargin + main.props.rightMargin), main.props.dimensions.height - (main.props.topMargin + main.props.bottomMargin));
                }, function(update) {
                    return updateText(update, isSelected, main.props.dimensions.width - (main.props.leftMargin + main.props.rightMargin), main.props.dimensions.height - (main.props.topMargin + main.props.bottomMargin));
                }), contentContainer.selectAll(IconSelector.selector).data(iconContents, function(d) {
                    return d.props.shapeType;
                }).join(function(enter) {
                    return updateIcon(svg = enter.append("svg").classed(ContentSelector.class, !0).classed(IconSelector.class, !0)), 
                    svg;
                    var svg;
                }, function(update) {
                    return updateIcon(update);
                }), contentContainer.selectAll(ContentSelector.selector).sort(function(a, b) {
                    return "text" === a.type ? -1 : "text" === b.type ? 1 : 0;
                });
            }), contentOuterContainers;
        }
        function updateText(text, isSelected, width, height) {
            return text.attr("style", null), text.styles(function(d) {
                var titleFontProperties = {
                    fontFamily: d.props.fontProperties.family,
                    fontSize: "".concat(d.props.fontProperties.size.px, "px"),
                    fontStyle: d.props.fontProperties.style,
                    fontVariant: d.props.fontProperties.variant,
                    fontWeight: d.props.fontProperties.weight,
                    textDecoration: d.props.fontProperties.textDecoration,
                    whiteSpace: d.props.fontProperties.whiteSpace
                }, textHeight = _powerbi_legacy_PowerBIVisuals_VisualsCommon_services_textMeasurementService__WEBPACK_IMPORTED_MODULE_4__.b.estimateSvgTextHeight(titleFontProperties), maxNumLines = Math.trunc(height / textHeight), linesBroken = (0, 
                _powerbi_legacy_PowerBIVisuals_VisualsCommon_Utility_wordBreaker__WEBPACK_IMPORTED_MODULE_5__.ql)(d.props.text, titleFontProperties, _powerbi_legacy_PowerBIVisuals_VisualsCommon_services_textMeasurementService__WEBPACK_IMPORTED_MODULE_4__.b.measureSvgTextWidth, width, maxNumLines || 1, null, !0);
                return (0, tslib__WEBPACK_IMPORTED_MODULE_6__.__assign)((0, tslib__WEBPACK_IMPORTED_MODULE_6__.__assign)({}, (0, 
                _powerbi_legacy_PowerBIVisuals_Visuals_common_fontProperties__WEBPACK_IMPORTED_MODULE_7__.wB)(d.props.fontProperties)), {
                    display: "-webkit-box",
                    "-webkit-line-clamp": linesBroken.length,
                    "-webkit-box-orient": "vertical",
                    overflow: "hidden"
                });
            }).style("text-align", function(d) {
                return d.props.horizontalAlignment;
            }).classed(SelectedSelector.class, isSelected).text(function(d) {
                return d.props.text;
            }), text;
        }
        function updateIcon(icons) {
            return icons.each(function(content) {
                var icon = d3.select(this), props = content.props, iconSize = function(props) {
                    if (props.iconSize) return props.iconSize;
                    var dimension = Math.max(Math.min(props.dimensions.width - props.leftMargin - props.rightMargin, props.dimensions.height - props.topMargin - props.bottomMargin), 0);
                    return props.placement === _powerbi_legacy_PowerBIVisuals_Visuals_types_iconPlacementType__WEBPACK_IMPORTED_MODULE_1__.PG ? dimension : dimension / 2;
                }(props);
                icon.attrs({
                    width: iconSize,
                    height: iconSize,
                    viewBox: getSvgViewbox(props.shapeType)
                }), icon.selectAll(IconImageGroupSelector.selector).data(props.shapeType === _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.custom ? [ props ] : []).join(function(enter) {
                    return function(enter) {
                        var id = _powerbi_legacy_PowerBIVisuals_VisualsCommon_Utility_Utility__WEBPACK_IMPORTED_MODULE_9__.b$.generateGuid(), group = enter.append("g").classed(IconImageGroupSelector.class, !0);
                        return group.append("rect").attrs({
                            width: 1,
                            height: 1,
                            fill: "url(#".concat(id, ")")
                        }), group.append("pattern").attrs({
                            id,
                            width: 1,
                            height: 1,
                            ...
                            width: 1,
                            height: 1
                        }), updateIconImageGroup(group), group;
                    }(enter);
                }, function(update) {
                    return updateIconImageGroup(update);
                }), icon.selectAll(IconPathGroupSelector.selector).data(props.shapeType !== _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.custom ? [ props ] : []).join(function(enter) {
                    return function(enter) {
                        var group = enter.append("g").classed(IconPathGroupSelector.class, !0);
                        return updateIconPathGroup(group), group;
                    }(enter);
                }, function(update) {
                    return updateIconPathGroup(update);
                });
            }), icons;
        }
        function updateIconImageGroup(groups) {
            return groups.each(function(props) {
                d3.select(this).selectAll("image").attrs({
                    href: props.iconImage && props.iconImage.url,
                    preserveAspectRatio: getImageAspectRatio(props.iconImage && props.iconImage.scaling)
                });
            }), groups;
        }
        function updateIconPathGroup(groups) {
            return groups.each(function(props) {
                var group = d3.select(this);
                if (props.shapeType === _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.custom) return _powerbi_legacy_PowerBIVisuals_VisualsCommon_debug__WEBPACK_IMPORTED_MODULE_3__.fF.assertFail("Custom icon should not create path group"), 
                group;
                var path = function(shapeType) {
                    switch (shapeType) {
                      case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.leftArrow:
                        return LeftArrowSvg.path;

                      case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.rightArrow:
                        return RightArrowSvg.path;

                      case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.back:
                        return BackSvg.path;

                      case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.reset:
                        return ResetSvg.path;

                      case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.information:
                        return InformationSvg.path;

                      case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.help:
                        return HelpSvg.path;

                      case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.qna:
                        return QnaSvg.path;

                      case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.insights:
                        return InsightsSvg.path;

                      case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.bookmarks:
                        return BookmarksSvg.path;

                      case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.blank:
                        return;

                      case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.applyAllSlicers:
                        return ApplyAllSlicersSvg.path;

                      case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.clearAllSlicers:
                        return ClearAllSlicersSvg.path;

                      default:
                        _powerbi_legacy_PowerBIVisuals_VisualsCommon_debug__WEBPACK_IMPORTED_MODULE_3__.fF.assertNever(shapeType);
                    }
                }(props.shapeType);
                group.html(path), group.selectAll("*").styles({
                    "vector-effect": "non-scaling-stroke",
                    "stroke-width": "".concat(props.lineWeight, "px"),
                    stroke: props.lineColor,
                    "stroke-opacity": 1 - props.lineTransparency / 100
                });
            }), groups;
        }
        function getImageAspectRatio(scaling) {
            switch (scaling) {
              case "Fill":
        ...
        function getFollowerFlexDirection(followerContents) {
            if (!followerContents) return "row";
            switch (followerContents.placement) {
              case _powerbi_legacy_PowerBIVisuals_Visuals_types_iconPlacementType__WEBPACK_IMPORTED_MODULE_1__.t$:
                return "row-reverse";

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_iconPlacementType__WEBPACK_IMPORTED_MODULE_1__.F2:
                return "row";

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_iconPlacementType__WEBPACK_IMPORTED_MODULE_1__.aE:
                return "column-reverse";

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_iconPlacementType__WEBPACK_IMPORTED_MODULE_1__.B2:
                return "column";

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_iconPlacementType__WEBPACK_IMPORTED_MODULE_1__.PG:
                return "row";

              default:
                _powerbi_legacy_PowerBIVisuals_VisualsCommon_debug__WEBPACK_IMPORTED_MODULE_3__.fF.assertNever(followerContents.placement);
            }
        }
        function getSvgViewbox(shapeType) {
            switch (shapeType) {
              case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.leftArrow:
                return LeftArrowSvg.viewBox;

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.rightArrow:
                return RightArrowSvg.viewBox;

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.back:
                return BackSvg.viewBox;

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.reset:
                return ResetSvg.viewBox;

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.information:
                return InformationSvg.viewBox;

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.help:
                return HelpSvg.viewBox;

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.qna:
                return QnaSvg.viewBox;

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.insights:
                return InsightsSvg.viewBox;

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.bookmarks:
                return BookmarksSvg.viewBox;

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.blank:
                return null;

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.custom:
                return "0 0 1 1";

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.applyAllSlicers:
                return ApplyAllSlicersSvg.viewBox;

              case _powerbi_legacy_PowerBIVisuals_Visuals_types_actionButtonType__WEBPACK_IMPORTED_MODULE_8__.W.clearAllSlicers:
                return ClearAllSlicersSvg.viewBox;
        ...
        var LeftArrowSvg = {
            viewBox: "0 0 32 32",
            path: '<line x1="30" y1="15" x2="2" y2="15"></line><polyline points="15,2 2,15 15,30"></polyline>'
        }, RightArrowSvg = {
            viewBox: "0 0 32 32",
            path: '<line x1="2" y1="15" x2="30" y2="15"></line><polyline points="17,2 30,15 17,30"></polyline>'
        }, QnaSvg = {
            viewBox: "0 0 24 22.75",
            path: '<polygon points="22.5 15.5 10.5 15.5 5.5 20.55 5.43 15.5 1.5 15.5 1.5 1.5 22.5 1.5 22.5 15.5"></polygon>'
        }, HelpSvg = {
            viewBox: "0 0 32 32",
            path: '<circle cx="16" cy="16" r="13.5"></circle><path d="M12.12,13.72a3.75,3.75,0,0,1,3.63-3.78,3.63,3.63,0,0,1,3.64,3.63c0,1.48-.5,    1.93-2.35,3.63A4.48,4.48,0,0,0,15.8,19a3.45,3.45,0,0,0-.11.4A8.59,8.59,0,0,0,15.5,21"></path><rect x="15.51" y="23.54" width="0.01" height="0.01"></rect>'
        }, InsightsSvg = {
            viewBox: "0 0 23.5 32",
            path: '<path d="M11.76,29.5c-1.95,0-4-.65-4-1.95v-5s0-1.09,0-1.45c-.08-1-1.52-2.48-2.59-3.89a12,12,0,0,1-1.62-2.6,9.45,    9.45,0,0,1-.62-3.63c0-4.66,4.23-8.44,8.89-8.44s8.89,3.78,8.89,8.44a9.41,9.41,0,0,1-.58,3.55,12.34,12.34,0,0,1-1.67,2.68c-1.06,1.4-2.47,2.86-2.55,3.89,0,.36-.07,    1.45-.07,1.45v5C15.78,28.85,13.71,29.5,11.76,29.5Z"></path><line x1="7.75" y1="23.92" x2="15.8" y2="23.92"></line>'
        }, BackSvg = {
            viewBox: "0 0 32 32",
            path: '<circle cx="16" cy="16" r="13.5"></circle><line x1="25" y1="16" x2="8" y2="16"></line><polyline points="16,8 8,16 16,24"></polyline>'
        }, BookmarksSvg = {
            viewBox: "0 0 22.59 32",
            path: '<polygon points="20.04 29.25 11.21 25.43 2.37 29.25 2.37 2.5 20.04 2.5 20.04 29.25"></polygon>'
        }, InformationSvg = {
            viewBox: "0 0 32 32",
            path: '<circle cx="16" cy="16" r="13.5"></circle><rect x="16" y="10.24" width="0.01" height="0.01"></rect><line x1="16" y1="13.1" x2="16"     y2="22.9"></line>'
        }, ResetSvg = {
            viewBox: "0 0 28.3 32",
            path: '<line x1="17.2" y1="9.9" x2="2.5" y2="9.9"></line><polyline points="10.2,2.3 2.5,9.9 10.2,17.5"></polyline><g><defs><rect id="SVGID_1_"     x="16.1" y="0" width="18" height="32"></rect></defs><clipPath id="SVGID_2_"><use xlink:href="#SVGID_1_" style="overflow:visible;"></use></clipPath><path d="M13.1,9.9h4c4.8,0,8.7,    3.8,8.7,9.4s-3.7,9.9-8.3,10.2h-2.4"></path></g>'
        }, ApplyAllSlicersSvg = {
            viewBox: "0 0 20 20",
            path: '<path d="M12.002 19.0039H0.996094V0.996094H19.0039V9.00391H17.998V5H2.00195V17.998H12.002V19.0039ZM2.00195 4.00391H17.998V2.00195H2.00195V4.00391Z" />     <path d="M7.99805 7.00195V10.9961H4.00391V7.00195H7.99805ZM7.00195 7.99805H5V10H7.00195V7.99805ZM7.99805 12.002V15.9961H4.00391V12.002H7.99805ZM7.00195 12.998H5V15H7.00195V12.998Z"/>     <path d="M20 10V12.5L17.002 15V20H12.998V15L10 12.5V10H20ZM19.0039 10.9961H10.9961V12.0312L14.0039 14.5312V19.0039H15.9961V14.5312L19.0039 12.0312V10.9961Z"/>'
        }, ClearAllSlicersSvg = {
            viewBox: "0 0 20 20",
            path: '<path d="M1.44531 12.5781L5.05859 9.0625L10.9863 14.7363L7.30469 18.3789L1.44531 12.5781Z"/>     <path d="M19.0723 7.25586L7.24609 19.0039L0.800781 12.6758L12.8125 0.664062L19.0723 7.25586ZM12.8125 1.8457L5.5957     9.07227L10.9375 14.1895L17.8906 7.25586L12.8125 1.8457ZM10.3516 14.7754L5 9.6582L1.98242 12.6758L7.23633 17.8809L10.3516 14.7754Z"/>'
        };
    },
