...
(self.webpackChunkdesktop = self.webpackChunkdesktop || []).push([ [ "matrix" ], {
    ...
    93023: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, {
            Matrix: function() {
                return Matrix;
            }
        });
        var _Visuals_common_converterHelper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(54522), _Visuals_common_objectEnumerationBuilder__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(28579), _VisualsCommon_debug__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(62458), _VisualsContracts_common_enums__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(46135), _VisualsData_dataView_utils_dataViewUtils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(99318), _controls_tablix_internal_tablixLayoutManager__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(16324), _controls_tablix_internal_tablixUtils1__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(93340), _controls_tablix_internal_tablixConstants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(71090), _controls_tablix_ITablixFormatting__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(73889), _controls_tablix_tablixColumnWidthManager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(81671), _controls_tablix_tablixControl__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(93414), _controls_tablix_tablixPropertyManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(74304), _matrixBinder__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(93568), _matrixHierarchyNavigator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(13375), Matrix = function() {
            ...
            return Matrix.prototype.init = function(options) {
                ...
                this.lastAllowHeaderResize = !0, this.waitingForSort = !1, this.tablixPropertyManager = new _controls_tablix_tablixPropertyManager__WEBPACK_IMPORTED_MODULE_0__.U(this.style);
            }, Matrix.getFormattingProperties = function(dataView, tablixPropertyManager) {
                return _VisualsCommon_debug__WEBPACK_IMPORTED_MODULE_1__.fF.assertValue(dataView, "dataView"), 
                tablixPropertyManager.getMatrixObjects(dataView);
                ...
                if (dataViews && dataViews.length > 0) {
                    ...
                    var formattingProperties = Matrix.getFormattingProperties(this.dataView, this.tablixPropertyManager);
                    this.formatters = formattingProperties.formatters;
                    var textSize = formattingProperties.general.textSize;
                    options.operationKind === _VisualsContracts_common_enums__WEBPACK_IMPORTED_MODULE_2__.su.Append ? (this.createOrUpdateHierarchyNavigator(previousDataView.matrix.rows.root !== this.dataView.matrix.rows.root), 
                    this.tablixControl.updateModels(!1, this.hierarchyNavigator.getRowHierarchy().root.children, this.hierarchyNavigator.getColumnHierarchy().root.children), 
                ...
                this.columnWidthManager ? this.persistingObjects || this.columnWidthManager.updateDataView(this.dataView, columnHierarchy.leafNodes) : this.columnWidthManager = new _controls_tablix_tablixColumnWidthManager__WEBPACK_IMPORTED_MODULE_3__.K(this.dataView, !0, function(objectInstances) {
                ...
                if (this.tablixControl) this.hierarchyNavigator.update(this.dataView.matrix, !1, !1, !1, isDataComplete, rootChanged, this.formatters); else {
                    var matrixNavigator = (0, _matrixHierarchyNavigator__WEBPACK_IMPORTED_MODULE_4__.aD)(this.dataView.matrix, isDataComplete, this.formatters, this.hostServices.getLocalizedString("ListJoin_Separator"), this.tablixPropertyManager.tablixProperties, this.hostServices);
                    this.hierarchyNavigator = matrixNavigator;
                }
            }, Matrix.prototype.createTablixControl = function(formattingProperties) {
                this.tablixControl || (this.tablixControl = this.createControl(this.hierarchyNavigator, formattingProperties.general.textSize)), 
                ...
                var _this = this, layoutKind = this.getLayoutKind(), matrixBinderOptions = {
                    ...
                    totalLabel: this.hostServices.getLocalizedString(_controls_tablix_internal_tablixConstants__WEBPACK_IMPORTED_MODULE_5__.qT),
                ...
                }, matrixBinder = new _matrixBinder__WEBPACK_IMPORTED_MODULE_6__.$H(this.hierarchyNavigator, matrixBinderOptions), layoutManager = 1 === layoutKind ? _controls_tablix_internal_tablixLayoutManager__WEBPACK_IMPORTED_MODULE_7__.dk.createLayoutManager(matrixBinder) : _controls_tablix_internal_tablixLayoutManager__WEBPACK_IMPORTED_MODULE_7__.Vz.createLayoutManager(matrixBinder, this.columnWidthManager), tablixContainer = document.createElement("div");
                this.element.append(tablixContainer);
                var tablixOptions = {
                    interactive: this.isInteractive,
                    enableTouchSupport: !this.isTouchDisabled,
                    layoutKind,
                    fontSize: _controls_tablix_tablixPropertyManager__WEBPACK_IMPORTED_MODULE_0__.U.getTextSizeInPx(textSize)
                };
                return new _controls_tablix_tablixControl__WEBPACK_IMPORTED_MODULE_8__.d(matrixNavigator, layoutManager, matrixBinder, tablixContainer, tablixOptions);
                ...
                _Visuals_common_converterHelper__WEBPACK_IMPORTED_MODULE_9__.Gr)(this.dataView)), 
                this.tablixControl.fontSize = _controls_tablix_tablixPropertyManager__WEBPACK_IMPORTED_MODULE_0__.U.getTextSizeInPx(textSize), 
                ...
                return !(this.waitingForSort && previousDataView && newDataView && (0, _VisualsData_dataView_utils_dataViewUtils__WEBPACK_IMPORTED_MODULE_10__.C0)(previousDataView.metadata, newDataView.metadata));
                ...
                this.waitingForSort = !0, this.hostServices.onCustomSort((0, _controls_tablix_internal_tablixUtils1__WEBPACK_IMPORTED_MODULE_11__.Av)(queryName, sortDirection));
                ...
                var loadMoreThreshold = this.tablixControl.rowDimension.getItemsCount() * _controls_tablix_internal_tablixConstants__WEBPACK_IMPORTED_MODULE_5__.sR;
                ...
                var enumeration = new _Visuals_common_objectEnumerationBuilder__WEBPACK_IMPORTED_MODULE_12__.G;
                return this.dataView && this.tablixPropertyManager.enumerateObjectInstances(options, enumeration, this.dataView, _controls_tablix_ITablixFormatting__WEBPACK_IMPORTED_MODULE_13__.Y.Matrix), 
                enumeration.complete();
            }, Matrix.prototype.enumerateObjectRepetition = function() {
                var enumeration = [];
                return this.dataView && this.tablixPropertyManager.enumerateObjectRepetition(enumeration, this.dataView, _controls_tablix_ITablixFormatting__WEBPACK_IMPORTED_MODULE_13__.Y.Matrix), 
                enumeration;
