...
var marker = this.parseTimeMarkers['angular-sanitize.js'] || (this.parseTimeMarkers['angular-sanitize.js'] = {});
...
if (window.perfTracking && window.perfTracking.startBundleEval) window.perfTracking.startBundleEval('angular-sanitize.js');/**
