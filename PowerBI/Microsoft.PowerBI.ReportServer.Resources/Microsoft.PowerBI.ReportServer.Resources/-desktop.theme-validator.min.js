(self.webpackChunkdesktop = self.webpackChunkdesktop || []).push([ [ "theme-validator" ], {
    ...
    2084: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, {
            ThemeValidatorModule: function() {
                return ThemeValidatorModule;
            }
        });
        var tslib_es6 = __webpack_require__(81337), explore_ui_authoring_dialog_identifiers = __webpack_require__(60690), promiseFactory = __webpack_require__(14463), currentExplorationVersion = __webpack_require__(26463), imageScalingType = __webpack_require__(48966), debug = __webpack_require__(62458), valueFormatter = __webpack_require__(72489), types_valueType = __webpack_require__(80777), localization_service = __webpack_require__(65181), dialog_service = __webpack_require__(58938), ajv = __webpack_require__(31984), ajv_default = __webpack_require__.n(ajv), core = __webpack_require__(50423), ThemeValidatorService = function() {
            function ThemeValidatorService(localizationService, dialogService) {
            ...
            return ThemeValidatorService.prototype.validate = function(theme, options) {
                var schema = this.generateThemeSchema(options);
                return this.validateAgainstSchema(theme, schema);
            }, ThemeValidatorService.prototype.validateAgainstSchema = function(theme, schema) {
                return null == this.validateSchema && (this.validateSchema = this.ajv.compile(schema)), 
                {
                    isValid: this.validateSchema(theme),
                    errors: _.map(this.validateSchema.errors, function(e) {
                        var hint = "enum" !== e.keyword ? e.keyword : "".concat(e.keyword, ": '").concat(e.schema.join("' ,'"), "'");
                        return "#".concat(e.instancePath || "/", " ").concat(e.message, " (").concat(hint, "; matching schema ").concat(e.schemaPath, ")");
                    })
                };
            }, ThemeValidatorService.prototype.validateAgainstBuiltInSchema = function(theme) {
                return (0, tslib_es6.__awaiter)(this, void 0, void 0, function() {
                    var ReportThemeSchema;
                    return (0, tslib_es6.__generator)(this, function(_a) {
                        switch (_a.label) {
                          case 0:
                            return [ 4, __webpack_require__.e("reportThemeSchema.json").then(__webpack_require__.t.bind(__webpack_require__, 33725, 19)) ];

                          case 1:
                            return ReportThemeSchema = _a.sent(), [ 2, this.validateAgainstSchema(theme, ReportThemeSchema) ];
                        }
                    });
                });
            }, ThemeValidatorService.prototype.getSchema = function(options) {
                return this.generateThemeSchema(options);
            }, ThemeValidatorService.prototype.showErrorDialog = function(themeName, errors) {
                debug.fF.assertNonEmpty(errors, "should only launch dialog if there are errors to show");
                var customBindings = {
                    title: this.localizationService.get("Report_Theme_ErrorDialogTitle"),
                    okButtonText: this.localizationService.get("Close"),
                    hideCancelButton: !0,
                    input: {
                        themeName,
                        errors
                ...
                this.dialogService.showTemplateDialog(explore_ui_authoring_dialog_identifiers.r, customBindings, {
                    width: "500px",
                    height: "450px"
                });
            }, ThemeValidatorService.prototype.showSuccessDialog = function() {
                this.dialogService.showSimpleDialog(this.localizationService.get("Report_Theme_SuccessDialogTitle"), this.localizationService.get("Report_Theme_SuccessDialogDescription"), void 0, void 0, this.localizationService.get("ModalDialogButtonText_GotIt"));
            }, ThemeValidatorService.prototype.generateThemeSchema = function(options) {
                return new ThemeSchemaBuilder(this.localizationService).withCommonCards(options.commonDescriptors).withAdditionalCapabilities(options.additionalDescriptors).withVisuals(options.visualCapabilities).build();
            }, ThemeValidatorService.\u0275fac = function(t) {
                return new (t || ThemeValidatorService)(core["\u0275\u0275inject"](localization_service.o), core["\u0275\u0275inject"](dialog_service.x));
            }, ThemeValidatorService.\u0275prov = core["\u0275\u0275defineInjectable"]({
                token: ThemeValidatorService,
                factory: ThemeValidatorService.\u0275fac,
                providedIn: "root"
            }), ThemeValidatorService;
        }(), ThemeValidatorServiceLazyProvider = {
            provide: "themeValidatorService",
            useFactory: function(promiseFactory, localizationService, dialogService) {
                var service = new ThemeValidatorService(localizationService, dialogService);
                return promiseFactory.resolve(service);
            },
            deps: [ promiseFactory.t, localization_service.o, dialog_service.x ]
        }, ThemeSchemaBuilder = function() {
            function ThemeSchemaBuilder(localizationService) {
                this.localizationService = localizationService, this.commonCardsName = "commonCards", 
                this.definitions = {}, this.visualSchemas = {};
                var visualStylesSchema = {
                    type: "object",
                    properties: this.visualSchemas
                };
                this.semanticColors = [ "foreground", "firstLevelElements", "secondLevelElements", "thirdLevelElements", "fourthLevelElements", "background", "secondaryBackground", "good", "neutral", "bad", "maximum", "center", "minimum", "null", "accent", "tableAccent", "foreground", "foregroundLight", "foregroundDark", "foregroundNeutralLight", "foregroundNeutralDark", "foregroundNeutralSecondary", "foregroundNeutralSecondaryAlt", "foregroundNeutralSecondaryAlt2", "foregroundNeutralTertiary", "foregroundNeutralTertiaryAlt", "foregroundSelected", "foregroundButton", "background", "backgroundLight", "backgroundNeutral", "backgroundDark", "hyperlink", "visitedHyperlink", "shapeStroke", "disabledText", "mapPushpin" ], 
                this.textClasses = [ "title", "label", "callout", "header", "largeTitle", "dataTitle", "boldLabel", "largeLabel", "largeLightLabel", "lightLabel", "semiboldLabel", "smallLabel", "smallLightLabel", "smallDataLabel" ], 
                this.themeSchema = (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, SchemaHelper.getObjectSchema()), {
                    required: [ "name" ],
                    description: "".concat(currentExplorationVersion.t),
                    properties: {
                        $schema: {
                            type: "string"
                        },
                        name: {
                            title: "Report theme name",
                            type: "string"
                        },
                        visualStyles: visualStylesSchema
                    },
                    definitions: this.definitions
                }), this.dataColorsSchema = {
                    type: "array",
                    items: this.getColorReferenceSchema()
                }, this.themeSchema.properties.dataColors = this.dataColorsSchema, this.iconsSchema = {
                    anyOf: [ {
                        type: "object",
                        patternProperties: {
                            ".*": this.getThemeIconSchema()
                        }
                    }, {
                        type: "array",
                        items: this.getThemeIconSchema()
                    } ]
                }, this.themeSchema.properties.icons = this.iconsSchema;
                for (var textClassProperties = {}, _i = 0, _a = this.textClasses; _i < _a.length; _i++) textClassProperties[_a[_i]] = this.getTextClassSchema();
                this.textClassesSchema = {
                    type: "object",
                    additionalProperties: !1,
                    properties: textClassProperties
                }, this.themeSchema.properties.textClasses = this.textClassesSchema;
                for (var semanticColorProperties = {}, _b = 0, _c = this.semanticColors; _b < _c.length; _b++) semanticColorProperties[_c[_b]] = this.getColorReferenceSchema();
                this.themeSchema.properties = (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, this.themeSchema.properties), semanticColorProperties);
            }
            return ThemeSchemaBuilder.prototype.build = function() {
                return this.themeSchema;
            }, ThemeSchemaBuilder.prototype.withCommonCards = function(commonCards) {
                for (var commonCardSchemas = {}, _i = 0, commonCards_1 = commonCards; _i < commonCards_1.length; _i++) commonCardSchemas = this.buildCardsSchema("", commonCards_1[_i], commonCardSchemas);
                return this.withDefinition(this.commonCardsName, {
                    type: "object",
                    properties: commonCardSchemas
                });
            }, ThemeSchemaBuilder.prototype.withAdditionalCapabilities = function(additionalCapabilities) {
                for (var formatType in additionalCapabilities) this.withTypedObjects(formatType, additionalCapabilities[formatType], !0);
                return this;
            }, ThemeSchemaBuilder.prototype.withVisuals = function(allVisualCapabilities) {
                for (var visualName in allVisualCapabilities) this.withVisual(visualName, allVisualCapabilities[visualName]);
                return this;
            }, ThemeSchemaBuilder.prototype.withVisual = function(name, capabilities) {
                return this.withTypedObjects(name, capabilities.objects || {});
            }, ThemeSchemaBuilder.prototype.withTypedObjects = function(formatType, objects, skipCommonCards) {
                var _this = this;
                void 0 === skipCommonCards && (skipCommonCards = !1), debug.fF.assert(function() {
                    return !_this.visualSchemas[formatType];
                }, "Already have schema for visual/type '".concat(formatType, "'"));
                var visualStylePresetSchema = {
                    type: "object",
                    allOf: [ {
                        properties: this.buildCardsSchema(formatType, objects)
                    } ]
                };
                if (!skipCommonCards) {
                    var commonCardsRef = this.getDefinitionReference(this.commonCardsName);
                    commonCardsRef && visualStylePresetSchema.allOf.unshift(commonCardsRef);
                }
                return this.visualSchemas[formatType] = {
                    type: "object",
                    additionalProperties: !1,
                    properties: {
            ...
            }, ThemeSchemaBuilder.prototype.buildCardsSchema = function(formatType, cards, cardSchemas) {
                void 0 === cardSchemas && (cardSchemas = {});
                var wildcardCardSchema = cardSchemas["*"];
                wildcardCardSchema || (wildcardCardSchema = cardSchemas["*"] = this.buildCardSchema());
                for (var wildcardCardPropertiesSchema = wildcardCardSchema.items.properties, _i = 0, cardNames_1 = _.keys(cards).sort(); _i < cardNames_1.length; _i++) {
                    var cardName = cardNames_1[_i], cardDescriptor = cards[cardName], propertyDescriptors = cardDescriptor.properties, cardSchema = cardSchemas[cardName];
                    cardSchema || (cardSchema = cardSchemas[cardName] = this.buildCardSchema({
                        cardDescriptor,
                        formatType,
                        cardName
                    }));
                    for (var cardPropertiesSchema = cardSchema.items.properties, _a = 0, propertyNames_1 = _.keys(propertyDescriptors).sort(); _a < propertyNames_1.length; _a++) {
                        var propertyName = propertyNames_1[_a], propertySchema = this.getPropertySchema(propertyDescriptors[propertyName], propertyName);
                        propertySchema && (cardPropertiesSchema[propertyName] = propertySchema, wildcardCardPropertiesSchema[propertyName] = propertySchema);
                    }
                }
                return cardSchemas;
            }, ThemeSchemaBuilder.prototype.buildCardSchema = function(options) {
                var cardSchema = {
                    type: "array",
                    items: {
                        type: "object",
                ...
                if (options) {
                    var cardDescriptor = options.cardDescriptor, cardName = options.cardName, formatType = options.formatType;
                    cardDescriptor.displayName && (cardSchema.title = this.getLocalizedString(cardDescriptor.displayName)), 
                    cardDescriptor.description && (cardSchema.description = this.getLocalizedString(cardDescriptor.description));
                    var knownInstances = this.getKnownInstances(formatType, cardName);
                    _.isEmpty(knownInstances) || (cardSchema.items.properties.$id = {
                        type: "string",
                        anyOf: [ {
                            enum: knownInstances
                        }, {
                ...
                return cardSchema;
            }, ThemeSchemaBuilder.prototype.getLocalizedString = function(displayNameGetter) {
                return "function" == typeof displayNameGetter ? displayNameGetter(this.localizationService) : displayNameGetter;
            }, ThemeSchemaBuilder.prototype.getKnownInstances = function(formatType, objectName) {
                switch (formatType) {
                  case "page":
                    if ("filterCard" === objectName) return [ "Available", "Applied" ];
                    break;

                  case "pageNavigator":
                  case "bookmarkNavigator":
                  case "actionButton":
                  case "advancedSlicerVisual":
                    return -1 !== [ "fill", "outline", "text", "icon", "shadow", "glow", "accentBar", "image", "value", "label", "background", "padding" ].indexOf(objectName) ? [ "default", "hover", "selected", "disabled" ] : void 0;

                  case "cardVisual":
                    return -1 !== [ "shape", "padding", "fillCustom", "outline", "shadowCustom", "glowCustom", "accentBar", "image", "value", "label", "layout", "spacing", "referenceLabelTitle", "referenceLabelValue", "referenceLabelDetail", "referenceLabelDetail", "divider" ].indexOf(objectName) ? [ "default" ] : void 0;

                  case "pivotTable":
                    if ("subTotals" === objectName) return [ "Row", "Column" ];
                }
            }, ThemeSchemaBuilder.prototype.withDefinition = function(name, schema) {
                var _this = this, definitions = this.definitions;
                return debug.fF.assert(function() {
                    return !_this.hasDefinition(name) || _.isEqual(_this.definitions[name], schema);
                }, "Definition '".concat(name, " already exists or given schema definition is different from existing")), 
                definitions[name] = schema, this;
            }, ThemeSchemaBuilder.prototype.hasDefinition = function(name) {
                return !!this.definitions[name];
            }, ThemeSchemaBuilder.prototype.getDefinitionReference = function(name) {
                var _this = this;
                return debug.fF.assert(function() {
                    return _this.hasDefinition(name);
                }, "Definition '".concat(name, "' does not exist")), {
                    $ref: "#/definitions/".concat(name)
                };
            }, ThemeSchemaBuilder.prototype.getPropertySchema = function(propertyDescriptor, propertyName) {
                var propertySchema, type = propertyDescriptor.type;
                if (types_valueType.Ge.isValueTypeDescriptor(type)) propertySchema = this.getValueTypeDescriptorSchema(type, propertyName); else {
                    if (this.isUIKind(type)) return;
                    if (!this.isStructuralTypeDescriptor(type)) return void debug.fF.assertNever(type);
                    propertySchema = this.getStructuralDescriptorSchema(type);
                }
                if (propertySchema) return propertyDescriptor.displayName && (propertySchema.title = this.getLocalizedString(propertyDescriptor.displayName)), 
                propertyDescriptor.description && (propertySchema.description = this.getLocalizedString(propertyDescriptor.description)), 
                propertySchema;
            }, ThemeSchemaBuilder.prototype.isStructuralTypeDescriptor = function(type) {
                return !0;
            }, ThemeSchemaBuilder.prototype.isUIKind = function(type) {
                return void 0 !== type.applyToAllPages || void 0 !== type.numericUnitSelection || void 0 !== type.revertToDefault || void 0 !== type.readOnlyText;
            }, ThemeSchemaBuilder.prototype.getValueTypeDescriptorSchema = function(type, propertyName) {
                var keys = Object.keys(type);
                _.remove(keys, function(val) {
                    return "variantDeleteEmpty" === val;
                }), debug.fF.assert(function() {
                    return 1 === keys.length;
                }, "Type descriptor should only have 1 type");
                var key = keys[0];
                switch (key) {
                  case "formatting":
                    return this.getFormattingDescriptorSchema(type.formatting, propertyName);

                  case "enumeration":
                    return SchemaHelper.getEnumTypeSchema(type.enumeration, this);
                  ...
                  case "extendedType":
                  case "json":
                  case "flagsEnumeration":
                  case "variantDeleteEmpty":
                    break;

                  default:
                    debug.fF.assertNever(key);
                }
                var primitiveType = types_valueType.Ge.fromDescriptor(type).primitiveType;
                if (13 === primitiveType) {
                    var variantTypes_2 = type.variant;
                    debug.fF.assert(function() {
                        return 0 !== variantTypes_2.length;
                    }, "variant definitions must have potential types specified");
                    for (var types = [], _i = 0, variantTypes_1 = variantTypes_2; _i < variantTypes_1.length; _i++) {
                        var schemaType = this.getSchemaTypeFromPrimitiveType(types_valueType.Ge.fromDescriptor(variantTypes_1[_i]).primitiveType);
                        types.push(schemaType);
                    }
                    var typeSchema = {
                        type: _.uniq(_.flatten(_.map(types, function(type) {
                            return type.type;
                        })))
                    }, format = _.first(_.compact(_.flatten(_.map(types, function(type) {
                        return type.format;
                    }))));
                    return format && (typeSchema.format = format), typeSchema;
                }
                return this.getSchemaTypeFromPrimitiveType(primitiveType);
            }, ThemeSchemaBuilder.prototype.getSchemaTypeFromPrimitiveType = function(primitiveType) {
                switch (primitiveType) {
                  ...
                  case 13:
                    debug.fF.assertFail("Don't call this function with a variant type; call with individual items from valueType.variationTypes");
                    break;

                  default:
                    debug.fF.assertNever(primitiveType);
                }
            }, ThemeSchemaBuilder.prototype.getFormattingDescriptorSchema = function(descriptor, propertyName) {
                var keys = Object.keys(descriptor);
                debug.fF.assert(function() {
                    return 1 === keys.length;
                }, "Unexpected number of formatting keys");
                var key = keys[0];
                switch (key) {
                  case "color":
                    return this.getColorReferenceSchema();
                  ...
                  case "alignment":
                    return "verticalAlignment" === propertyName ? this.getVerticalAlignmentReferenceSchema() : this.getHorizontalAlignmentReferenceSchema();

                  case "labelDisplayUnits":
                    return this.getLabelDisplayUnitsReferenceSchema();

                  case "displayUnitsWithoutAuto":
                    return this.getDisplayUnitsWithoutAutoReferenceSchema();

                  case "fontSize":
                    return this.getFontSizeReferenceSchema();

                  case "labelDensity":
                    return this.getLabelDensityReferenceSchema();

                  case "bubbleSize":
                    return this.getBubbleSizeReferenceSchema();
            ...
            }, ThemeSchemaBuilder.prototype.getStructuralDescriptorSchema = function(descriptor) {
                var keys = Object.keys(descriptor);
                if (debug.fF.assert(function() {
                    return keys.length <= 1;
                }, "Type descriptor should only have 1 type"), 0 !== keys.length) {
                    var key = keys[0];
                    if (!this.hasDefinition(key)) switch (key) {
                      case "dataBars":
                        this.withDefinition(key, this.getDataBarsSchema());
                        break;

                      case "fill":
                        this.getFillSchemaReference();
                        break;

                      case "fillRule":
                        this.withDefinition(key, this.getFillRuleSchema());
                        break;
                      ...
                      case "icon":
                        this.withDefinition(key, this.getIconSchema());
                        break;

                      case "image":
                        this.withDefinition(key, this.getImageSchema());
                        break;

                      case "paragraphs":
                        this.withDefinition(key, this.getParagraphsSchema());
                        break;

                      case "itemLocation":
                        this.withDefinition(key, this.getItemLocationSchema());
                        break;

                      default:
                        debug.fF.assertNever(key);
                    }
                    return this.getDefinitionReference(key);
                }
            }, ThemeSchemaBuilder.prototype.getFillSchemaReference = function() {
                if (!this.hasDefinition("fill")) {
                    var fillSchema = {
                        oneOf: [ (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, SchemaHelper.getObjectSchema([ "solid" ])), {
                            properties: {
                                solid: (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, SchemaHelper.getObjectSchema([ "color" ])), {
                                    properties: {
                                        color: {
                                            oneOf: [ this.getColorReferenceSchema(), this.getThemeDataColorExprSchema() ]
                                        }
                                    }
                                })
                            }
                        }), (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, SchemaHelper.getObjectSchema([ "gradient" ])), {
                            properties: {
                                gradient: (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, SchemaHelper.getObjectSchema([ "startColor", "endColor" ])), {
                                    properties: {
                                        startColor: this.getColorReferenceSchema(),
                                        endColor: this.getColorReferenceSchema()
                                    }
                                })
                            }
                        }), (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, SchemaHelper.getObjectSchema([ "pattern" ])), {
                            properties: {
                                pattern: (0, tslib_es6.__assign)((0, tslib_es6.__assign)({}, SchemaHelper.getObjectSchema([ "patternKind" ])), {
                                    properties: {
                                        patternKind: SchemaHelper.getStringSchema(),
                                        color: this.getColorReferenceSchema()
                                    }
                                })
                            }
                        }) ]
                    };
                    this.withDefinition("fill", fillSchema);
                }
                return this.getDefinitionReference("fill");
            }, ThemeSchemaBuilder.prototype.getThemeDataColorExprSchema = function() {
                return this.hasDefinition("themeDataColor") || this.withDefinition("themeDataColor", {
                    type: "object",
                    additionalProperties: !1,
                    required: [ "expr" ],
                    properties: {
                ...
                }), this.getDefinitionReference("themeDataColor");
            }, ThemeSchemaBuilder.prototype.getFillRuleSchema = function() {
                if (!this.hasDefinition("ruleColorStop")) {
                    var ruleColorStopSchema = {
                        type: "object",
                        additionalProperties: !1,
                    ...
                    this.withDefinition("ruleColorStop", ruleColorStopSchema);
                }
                if (!this.hasDefinition("nullColorStop")) {
                    var nullColorStopSchema = {
                        type: "object",
                        additionalProperties: !1,
                        required: [ "strategy" ],
                        properties: {
                    ...
                    this.withDefinition("nullColorStop", nullColorStopSchema);
                }
                var ruleColorStopReference = this.getDefinitionReference("ruleColorStop"), nullColorStopReference = this.getDefinitionReference("nullColorStop");
                return ruleColorStopReference && nullColorStopReference ? {
                    oneOf: [ {
                        type: "object",
                        additionalProperties: !1,
                        required: [ "linearGradient2" ],
                        properties: {
                            linearGradient2: {
                                type: "object",
                                additionalProperties: !1,
                                required: [ "max", "min" ],
                                properties: {
                                    max: ruleColorStopReference,
                                    min: ruleColorStopReference,
                                    nullColoringStrategy: nullColorStopReference
                                }
                            }
                        }
                    }, {
                        type: "object",
                        additionalProperties: !1,
                        required: [ "linearGradient3" ],
                        properties: {
                            linearGradient3: {
                                type: "object",
                                additionalProperties: !1,
                                required: [ "max", "mid", "min" ],
                                properties: {
                                    max: ruleColorStopReference,
                                    mid: ruleColorStopReference,
                                    min: ruleColorStopReference,
                                    nullColoringStrategy: nullColorStopReference
                                }
                            }
            ...
            }, ThemeSchemaBuilder.prototype.getImageSchema = function() {
                return {
                    type: "object",
                    additionalProperties: !1,
                    required: [ "name", "url" ],
                    properties: {
                        ...
                        scaling: SchemaHelper.getEnumTypeSchema(imageScalingType.H, this)
                    }
                };
            }, ThemeSchemaBuilder.prototype.getParagraphsSchema = function() {
                return {
                    type: "array",
                    items: {
                        type: "object",
                                ...
                                properties: {
                                    textRunStyle: {
                                        ...
                                        properties: {
                                            ...
                                            fontSize: this.getFontSizeReferenceSchema(),
                                            fontStyle: SchemaHelper.getEnumSchema([ {
                                                value: "normal",
                                                displayName: "normal"
                                            }, {
                                                value: "italic",
                                            ...
                                            fontWeight: {
                                                oneOf: [ SchemaHelper.getEnumSchema([ {
                                                    value: "normal",
                                                    displayName: "normal"
                                                }, {
                                                    value: "bold",
                                            ...
                                            color: this.getColorReferenceSchema(),
                                            textDecoration: SchemaHelper.getEnumSchema([ {
                                                value: "underline",
            ...
            }, ThemeSchemaBuilder.prototype.getThemeIconSchema = function() {
                return this.hasDefinition("themeIcon") || this.withDefinition("themeIcon", {
                    type: "object",
                    additionalProperties: !1,
                    required: [ "url" ],
                    properties: {
                ...
                }), this.getDefinitionReference("themeIcon");
            }, ThemeSchemaBuilder.prototype.getTextClassSchema = function() {
                if (!this.hasDefinition("textClass")) {
                    var textClassSchema = {
                        type: "object",
                        additionalProperties: !1,
                        properties: {
                    ...
                    this.withDefinition("textClass", textClassSchema);
                }
                return this.getDefinitionReference("textClass");
            }, ThemeSchemaBuilder.prototype.getIconSchema = function() {
                return {
                    type: "object",
                    additionalProperties: !1,
                    properties: {
                        layout: SchemaHelper.getEnumSchema([ {
                            value: "After",
                            displayName: "After"
                        }, {
                            value: "Before",
                        ...
                        verticalAlignment: SchemaHelper.getEnumSchema([ {
                            value: "Top",
                            displayName: "Top"
                        }, {
                            value: "Middle",
            ...
            }, ThemeSchemaBuilder.prototype.getDataBarsSchema = function() {
                var fillReference = this.getFillSchemaReference();
                return {
                    type: "object",
                    additionalProperties: !1,
                    required: [ "reverseDirection", "hideText" ],
                    properties: {
                        minValue: {
                            type: "number"
                        },
                        ...
                        positiveColor: fillReference,
                        negativeColor: fillReference,
                        axisColor: fillReference,
                        reverseDirection: {
                            type: "boolean"
                        },
                        hideText: {
            ...
            }, ThemeSchemaBuilder.prototype.getItemLocationSchema = function() {
                return {
                    type: "object",
                    additionalProperties: !1,
            ...
            }, ThemeSchemaBuilder.prototype.getHorizontalAlignmentReferenceSchema = function() {
                if (!this.hasDefinition("alignment")) {
                    var alignmentSchema = SchemaHelper.getEnumSchema([ {
                        value: "left",
                        displayName: "left"
                    }, {
                        value: "center",
                    ...
                    this.withDefinition("alignment", alignmentSchema);
                }
                return this.getDefinitionReference("alignment");
            }, ThemeSchemaBuilder.prototype.getVerticalAlignmentReferenceSchema = function() {
                if (!this.hasDefinition("verticalAlignment")) {
                    var verticalAlignmentSchema = SchemaHelper.getEnumSchema([ {
                        value: "top",
                        displayName: "top"
                    }, {
                        value: "middle",
                    ...
                    this.withDefinition("verticalAlignment", verticalAlignmentSchema);
                }
                return this.getDefinitionReference("verticalAlignment");
            }, ThemeSchemaBuilder.prototype.getFontSizeReferenceSchema = function() {
                return this.hasDefinition("fontSize") || this.withDefinition("fontSize", {
                    type: "number",
                    minimum: 6,
                    maximum: 45
                }), this.getDefinitionReference("fontSize");
            }, ThemeSchemaBuilder.prototype.getLabelDisplayUnitsReferenceSchema = function() {
                if (!this.hasDefinition("labelDisplayUnits")) {
                    var displayUnitValues = (0, valueFormatter.p$)().map(function(displayUnit) {
                        return {
                            value: displayUnit.value,
                            displayName: displayUnit.title
                        };
                    });
                    this.withDefinition("labelDisplayUnits", SchemaHelper.getEnumSchema(displayUnitValues, this));
                }
                return this.getDefinitionReference("labelDisplayUnits");
            }, ThemeSchemaBuilder.prototype.getDisplayUnitsWithoutAutoReferenceSchema = function() {
                if (!this.hasDefinition("displayUnitsWithoutAuto")) {
                    var displayUnitValues = (0, valueFormatter.p$)(!0).map(function(displayUnit) {
                        return {
                            value: displayUnit.value,
                            displayName: displayUnit.title
                        };
                    });
                    this.withDefinition("displayUnitsWithoutAuto", SchemaHelper.getEnumSchema(displayUnitValues, this));
                }
                return this.getDefinitionReference("displayUnitsWithoutAuto");
            }, ThemeSchemaBuilder.prototype.getColorReferenceSchema = function() {
                return this.hasDefinition("color") || this.withDefinition("color", {
                    type: "string",
                    pattern: "^#[0-9a-fA-F]{8}$|^#(?:[0-9a-fA-F]{3}){1,2}$"
                }), this.getDefinitionReference("color");
            }, ThemeSchemaBuilder.prototype.getLabelDensityReferenceSchema = function() {
                return this.hasDefinition("labelDensity") || this.withDefinition("labelDensity", {
                    type: "integer",
                    minimum: 0,
                    maximum: 100
                }), this.getDefinitionReference("labelDensity");
            }, ThemeSchemaBuilder.prototype.getBubbleSizeReferenceSchema = function() {
                return this.hasDefinition("bubbleSize") || this.withDefinition("bubbleSize", {
                    type: "integer",
                    minimum: -25,
                    maximum: 100
                }), this.getDefinitionReference("bubbleSize");
            }, ThemeSchemaBuilder;
        }(), SchemaHelper = function() {
            function SchemaHelper() {}
            return SchemaHelper.getObjectSchema = function(required) {
                return void 0 === required && (required = []), {
                    type: "object",
                    additionalProperties: !1,
                    required
                };
            }, SchemaHelper.getStringSchema = function() {
                return {
                    type: "string"
                };
            }, SchemaHelper.getEnumTypeSchema = function(enumType, builder) {
                var members = enumType.members();
                return debug.fF.assertNonEmpty(members, "Should have enum values"), SchemaHelper.getEnumSchema(members, builder);
            }, SchemaHelper.getEnumSchema = function(enumMembers, builder) {
                for (var firstValue = enumMembers[0].value, schemaEnumValues = [], _i = 0, enumMembers_1 = enumMembers; _i < enumMembers_1.length; _i++) {
                    var enumMember = enumMembers_1[_i];
                    schemaEnumValues.push({
                        const: enumMember.value,
                        title: builder.getLocalizedString(enumMember.displayName)
                    });
                }
                return _.isString(firstValue) ? (debug.fF.assert(function() {
                    return enumMembers.every(function(memberValue) {
                        return _.isString(memberValue.value);
                    });
                }), {
                    type: "string",
                    oneOf: schemaEnumValues
                }) : (debug.fF.assert(function() {
                    return enumMembers.every(function(memberValue) {
                        return _.isInteger(memberValue.value);
                    });
                }), {
                    type: "integer",
                    oneOf: schemaEnumValues
        ...
        }(), common = __webpack_require__(77476), lazy_load_module = __webpack_require__(82156), ThemeValidatorModule = function() {
            function ThemeValidatorModule() {}
            return ThemeValidatorModule.\u0275fac = function(t) {
                return new (t || ThemeValidatorModule);
            }, ThemeValidatorModule.\u0275mod = core["\u0275\u0275defineNgModule"]({
                type: ThemeValidatorModule
            }), ThemeValidatorModule.\u0275inj = core["\u0275\u0275defineInjector"]({
                providers: [ ThemeValidatorServiceLazyProvider ],
                imports: [ common.CommonModule, lazy_load_module.N ]
            }), ThemeValidatorModule;
        }();
    },
