...
namespace mshtml
{
	...
	public interface HTMLDocumentEvents2
	{
		...
		[DispId(1026)]
		[MethodImpl(4224, MethodCodeType = 3)]
		bool onstop([MarshalAs(28)] [In] IHTMLEventObj pEvtObj);
		...
		[DispId(1027)]
		[MethodImpl(4224, MethodCodeType = 3)]
		void onbeforeeditfocus([MarshalAs(28)] [In] IHTMLEventObj pEvtObj);

		// Token: 0x0600DA37 RID: 55863
		[DispId(1037)]
		[MethodImpl(4224, MethodCodeType = 3)]
		void onselectionchange([MarshalAs(28)] [In] IHTMLEventObj pEvtObj);
