...
namespace Microsoft.OData.Client
{
	...
	{
		// Token: 0x0600049A RID: 1178 RVA: 0x00010660 File Offset: 0x0000E860
		[SuppressMessage("Microsoft.Performance", "CA1810:InitializeReferenceTypeStaticFieldsInline")]
		[SuppressMessage("Microsoft.Maintainability", "CA1505:AvoidUnmaintainableCode", Justification = "lots of lines of code are necessary to initialize the map properly")]
		...
		// Token: 0x0600049B RID: 1179 RVA: 0x000116E4 File Offset: 0x0000F8E4
		...
		// Token: 0x0600049C RID: 1180 RVA: 0x00011708 File Offset: 0x0000F908
		...
		// Token: 0x0600049D RID: 1181 RVA: 0x0001172C File Offset: 0x0000F92C
		...
		// Token: 0x0600049E RID: 1182 RVA: 0x00011768 File Offset: 0x0000F968
		...
		internal static string GetCanonicalMethodDescription(MethodInfo method)
		{
			...
			foreach (ParameterInfo parameterInfo in method.GetParameters())
			{
				...
				ReflectionUtil.AppendCanonicalTypeDescription(parameterInfo.ParameterType, dictionary, stringBuilder);
			}
			stringBuilder.Append(")");
			if (null != method.ReturnType)
			{
				stringBuilder.Append("->");
				ReflectionUtil.AppendCanonicalTypeDescription(method.ReturnType, dictionary, stringBuilder);
			}
			return stringBuilder.ToString();
		}

		// Token: 0x060004A0 RID: 1184 RVA: 0x000118DC File Offset: 0x0000FADC
		...
		// Token: 0x060004A1 RID: 1185 RVA: 0x0001197A File Offset: 0x0000FB7A
