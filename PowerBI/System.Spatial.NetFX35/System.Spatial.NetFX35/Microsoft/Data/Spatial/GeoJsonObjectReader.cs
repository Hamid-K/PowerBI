	...
	internal class GeoJsonObjectReader : SpatialReader<IDictionary<string, object>>
	{
		...
		private class SendToTypeWashedPipeline
		{
			...
			private static SpatialType ReadTypeName(string typeName)
			{
				if (typeName != null)
				{
					if (<PrivateImplementationDetails>{01C72562-032F-41AC-AA49-E7E2BA5613D8}.$$method0x60000c0-1 == null)
					{
						...
						<PrivateImplementationDetails>{01C72562-032F-41AC-AA49-E7E2BA5613D8}.$$method0x60000c0-1 = dictionary;
					}
					int num;
					if (<PrivateImplementationDetails>{01C72562-032F-41AC-AA49-E7E2BA5613D8}.$$method0x60000c0-1.TryGetValue(typeName, ref num))
					{
						switch (num)
						{
						case 0:
