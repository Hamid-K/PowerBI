...
namespace Microsoft.ReportingServices.OnDemandReportRendering
{
	...
	{
		// Token: 0x06001326 RID: 4902 RVA: 0x0004E46C File Offset: 0x0004C66C
		...
		// Token: 0x06001327 RID: 4903 RVA: 0x0004FA45 File Offset: 0x0004DC45
		...
		// Token: 0x06001328 RID: 4904 RVA: 0x0004FA58 File Offset: 0x0004DC58
		internal static void ResolveEntities(StringBuilder sb)
		{
			for (int i = 0; i < sb.Length; i++)
			{
				...
				string text2;
				char c;
				if (sb[i] == '&' && HtmlEntityResolver.GetEntity(sb, i, out text, out text2) && HtmlEntityResolver.m_entityLookupTable.TryGetValue(text2, out c))
				{
		...
		// Token: 0x06001329 RID: 4905 RVA: 0x0004FAB8 File Offset: 0x0004DCB8
		...
		// Token: 0x0600132A RID: 4906 RVA: 0x0004FB30 File Offset: 0x0004DD30
		...
		private static Dictionary<string, char> m_entityLookupTable = new Dictionary<string, char>(StringEqualityComparer.Instance);
	}
}
