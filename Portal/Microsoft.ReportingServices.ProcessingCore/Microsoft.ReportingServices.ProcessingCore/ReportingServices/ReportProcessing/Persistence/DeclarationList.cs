...
namespace Microsoft.ReportingServices.ReportProcessing.Persistence
{
	...
	{
		// Token: 0x06006C78 RID: 27768 RVA: 0x001B7A13 File Offset: 0x001B5C13
		...
		// (get) Token: 0x06006C79 RID: 27769 RVA: 0x001B7A2B File Offset: 0x001B5C2B
		internal int Count
		{
			get
			{
				return this.m_declarations.Length;
			}
		}
		...
		private Declaration this[int index]
		{
			get
			{
				Global.Tracer.Assert(index >= 0 && index < this.m_declarations.Length);
				return this.m_declarations[index];
			}
			set
			{
				Global.Tracer.Assert(index >= 0 && index < this.m_declarations.Length);
				this.m_declarations[index] = value;
			}
		}

		// Token: 0x06006C7E RID: 27774 RVA: 0x001B7AB4 File Offset: 0x001B5CB4
		internal bool ContainsKey(ObjectType objectType)
		{
			return this[objectType] != null;
		}

		// Token: 0x06006C7F RID: 27775 RVA: 0x001B7AC0 File Offset: 0x001B5CC0
