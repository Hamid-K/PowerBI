...
namespace Microsoft.Identity.Client
{
	...
	{
		// Token: 0x06001206 RID: 4614 RVA: 0x0003DB4C File Offset: 0x0003BD4C
		...
		// Token: 0x06001207 RID: 4615 RVA: 0x0003DB59 File Offset: 0x0003BD59
		...
		// Token: 0x06001208 RID: 4616 RVA: 0x0003DB6B File Offset: 0x0003BD6B
		public static string RedirectUriMismatch(string expectedUri, string actualUri)
		{
			return string.Concat(new string[] { "Redirect Uri mismatch.  Expected (", expectedUri, ") Actual (", actualUri, "). " });
		}

		// Token: 0x06001209 RID: 4617 RVA: 0x0003DB98 File Offset: 0x0003BD98
		...
		// Token: 0x0600120A RID: 4618 RVA: 0x0003DBB5 File Offset: 0x0003BDB5
		...
		// Token: 0x0600120B RID: 4619 RVA: 0x0003DBC7 File Offset: 0x0003BDC7
		...
		// Token: 0x0600120C RID: 4620 RVA: 0x0003DBD9 File Offset: 0x0003BDD9
		public static string WABError(string status, string errorDetail, string responseData)
		{
			return string.Concat(new string[] { "WAB responded with: status = ", status, ", error detail = ", errorDetail, ", response data = ", responseData });
		}

		// Token: 0x0600120D RID: 4621 RVA: 0x0003DC0A File Offset: 0x0003BE0A
		public static string TokenTypeMismatch(string requestTokenType, string responseTokenType)
		{
			return string.Concat(new string[] { "You asked for token type ", requestTokenType, ", but receive ", responseTokenType, ". This occurs if the Identity Provider (AAD, B2C, ADFS etc.) does not support the requested token type. If using ADFS, consider upgrading to the latest version. " });
		}

		// Token: 0x0600120E RID: 4622 RVA: 0x0003DC37 File Offset: 0x0003BE37
		...
		// Token: 0x0600120F RID: 4623 RVA: 0x0003DC49 File Offset: 0x0003BE49
		...
		// Token: 0x06001210 RID: 4624 RVA: 0x0003DC5B File Offset: 0x0003BE5B
		...
		// Token: 0x06001211 RID: 4625 RVA: 0x0003DC6D File Offset: 0x0003BE6D
		...
		// Token: 0x06001212 RID: 4626 RVA: 0x0003DC7F File Offset: 0x0003BE7F
