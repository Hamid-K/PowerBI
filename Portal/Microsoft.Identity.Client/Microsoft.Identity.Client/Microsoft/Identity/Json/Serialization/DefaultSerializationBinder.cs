...
namespace Microsoft.Identity.Json.Serialization
{
	...
	{
		// Token: 0x0600065B RID: 1627 RVA: 0x0001B650 File Offset: 0x00019850
		...
		// Token: 0x0600065C RID: 1628 RVA: 0x0001B670 File Offset: 0x00019870
		private Type GetTypeFromTypeNameKey([Nullable(new byte[] { 0, 2, 0 })] StructMultiKey<string, string> typeNameKey)
		{
		...
		// Token: 0x0600065D RID: 1629 RVA: 0x0001B794 File Offset: 0x00019994
		[return: Nullable(2)]
		...
		// Token: 0x0600065E RID: 1630 RVA: 0x0001B860 File Offset: 0x00019A60
		private Type GetTypeByName([Nullable(new byte[] { 0, 2, 0 })] StructMultiKey<string, string> typeNameKey)
		{
			return this._typeCache.Get(typeNameKey);
		}

		// Token: 0x0600065F RID: 1631 RVA: 0x0001B86E File Offset: 0x00019A6E
		...
		// Token: 0x06000660 RID: 1632 RVA: 0x0001B87D File Offset: 0x00019A7D
		[NullableContext(2)]
		public override void BindToName([Nullable(0)] Type serializedType, out string assemblyName, out string typeName)
		{
