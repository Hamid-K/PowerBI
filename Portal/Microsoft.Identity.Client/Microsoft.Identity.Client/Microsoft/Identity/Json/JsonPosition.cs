...
namespace Microsoft.Identity.Json
{
	...
	{
		// Token: 0x060000AD RID: 173 RVA: 0x000030B2 File Offset: 0x000012B2
		...
		// Token: 0x060000AE RID: 174 RVA: 0x000030D8 File Offset: 0x000012D8
		...
		[NullableContext(2)]
		internal void WriteTo([Nullable(0)] StringBuilder sb, ref StringWriter writer, ref char[] buffer)
		{
			JsonContainerType type = this.Type;
			if (type != JsonContainerType.Object)
			{
		...
		// Token: 0x060000B0 RID: 176 RVA: 0x000031C6 File Offset: 0x000013C6
		...
		// Token: 0x060000B2 RID: 178 RVA: 0x000032A8 File Offset: 0x000014A8
