...
namespace dotless.Core.Parser.Infrastructure
{
	...
	{
		// Token: 0x060003DC RID: 988 RVA: 0x0000FA8C File Offset: 0x0000DC8C
		public string ByFilename(string filename)
		{
			string text = filename.Substring(filename.LastIndexOf('.'));
			string text2;
			if (!string.IsNullOrEmpty(text) && MimeTypeLookup._mappings.TryGetValue(text, out text2))
			{
				return text2;
			}
			return null;
