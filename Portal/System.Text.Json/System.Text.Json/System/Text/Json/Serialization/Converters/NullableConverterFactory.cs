...
namespace System.Text.Json.Serialization.Converters
{
	...
	{
		// Token: 0x06000CE3 RID: 3299 RVA: 0x00032CEC File Offset: 0x00030EEC
		public override bool CanConvert(Type typeToConvert)
		{
			return typeToConvert.IsNullableOfT();
		}

		// Token: 0x06000CE4 RID: 3300 RVA: 0x00032CF4 File Offset: 0x00030EF4
		public override JsonConverter CreateConverter(Type typeToConvert, JsonSerializerOptions options)
		{
			...
			return NullableConverterFactory.CreateValueConverter(type, converterInternal);
		}

		// Token: 0x06000CE5 RID: 3301 RVA: 0x00032D30 File Offset: 0x00030F30
		public static JsonConverter CreateValueConverter(Type valueTypeToConvert, JsonConverter valueConverter)
		{
			return (JsonConverter)Activator.CreateInstance(NullableConverterFactory.GetNullableConverterType(valueTypeToConvert), BindingFlags.Instance | BindingFlags.Public, null, new object[] { valueConverter }, null);
		}

		// Token: 0x06000CE6 RID: 3302 RVA: 0x00032D50 File Offset: 0x00030F50
		...
		{
			return typeof(NullableConverter<>).MakeGenericType(new Type[] { valueTypeToConvert });
		}
	}
}
