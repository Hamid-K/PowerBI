...
namespace Microsoft.OData.JsonLight
{
	...
	{
		// Token: 0x06001AB9 RID: 6841 RVA: 0x0004B1CC File Offset: 0x000493CC
		internal ODataJsonLightServiceDocumentDeserializer(ODataJsonLightInputContext jsonLightInputContext)
			: base(jsonLightInputContext)
		{
		}

		// Token: 0x06001ABA RID: 6842 RVA: 0x000511AC File Offset: 0x0004F3AC
		...
		// Token: 0x06001ABB RID: 6843 RVA: 0x000511DC File Offset: 0x0004F3DC
		internal Task<ODataServiceDocument> ReadServiceDocumentAsync()
		{
			PropertyAndAnnotationCollector propertyAndAnnotationCollector = base.CreatePropertyAndAnnotationCollector();
			return base.ReadPayloadStartAsync(ODataPayloadKind.ServiceDocument, propertyAndAnnotationCollector, false, false).FollowOnSuccessWith(delegate(Task t)
			{
				ODataServiceDocument odataServiceDocument = this.ReadServiceDocumentImplementation(propertyAndAnnotationCollector);
		...
		// Token: 0x06001ABC RID: 6844 RVA: 0x00051224 File Offset: 0x0004F424
		private ODataServiceDocument ReadServiceDocumentImplementation(PropertyAndAnnotationCollector propertyAndAnnotationCollector)
		{
			...
			{
				EntitySets = new ReadOnlyEnumerable<ODataEntitySetInfo>(serviceDocumentElements[0].OfType<ODataEntitySetInfo>().ToList<ODataEntitySetInfo>()),
				FunctionImports = new ReadOnlyEnumerable<ODataFunctionImportInfo>(serviceDocumentElements[0].OfType<ODataFunctionImportInfo>().ToList<ODataFunctionImportInfo>()),
				Singletons = new ReadOnlyEnumerable<ODataSingletonInfo>(serviceDocumentElements[0].OfType<ODataSingletonInfo>().ToList<ODataSingletonInfo>())
			};
		}

		// Token: 0x06001ABD RID: 6845 RVA: 0x00051324 File Offset: 0x0004F524
